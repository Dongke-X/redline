...
const DICT = {
  zh: {
    ...
    'panel.btn.exportHtml.title': '导出 single-file HTML（接收方双击就能继续标）· Shift+点击 = 只读模式',
    'singlefile.preparing': '正在打包 HTML…',
    'singlefile.done': '已导出 HTML',
    'singlefile.fail': '导出失败: {reason}',
    ...
    'shot.loading': '正在截屏…',
    'shot.loadFailed': '截屏库加载失败 · 离线或页面 CSP 拦截 · 用系统原生截屏粘到反馈框',
    'shot.failed': '截屏失败',
    // 恢复上次反馈
    ...
    'pdf.loading': '正在加载图片库...',
    'pdf.loadFailed': '图片库加载失败 · 离线或页面 CSP 拦截 · 改用矢量 PDF（Space+P）',
    ...
    'export.pdf.image.hint': '整页一张超长图',
    'export.html.editable': '编辑 HTML',
    'export.html.editable.hint': '接收方双击就能继续标',
    'export.html.readonly': '预览 HTML',
    'export.html.readonly.hint': '给客户演示 · 接收方不能编辑',
    'readonly.print': '打印 / 另存为 PDF',
    'welcome.editable': '双击元素继续标注 · ⌘Z 撤销',
    'overlay.pick': '取色器\n点页面任意位置取色 · hex 入剪贴板 + 反馈框',
    'overlay.undo': '撤销 (⌘Z)\n回滚最近一次操作',
    'overlay.redo': '重做 (⌘⇧Z)\n恢复被撤销的操作',
    'overlay.compare': '前后对比 (O)\n切换看原稿 / 看改后',
    'compare.on': '在看原稿 · {n} 处改动暂时还原',
    'compare.off': '回到改后视图',
    'compare.empty': '没有改动可比对',
    'help.shortcut.compare': '前后对比',
    ...
    'help.group.selection': '选区',
    'help.group.history': '反馈 / 历史',
    'help.group.view': '视图',
    'help.group.pointer': '鼠标手势',
    ...
    'help.shortcut.copyDescriptor': '复制描述符',
    'help.shortcut.multiSelect': '多选切换',
    'help.shortcut.rubberBand': '框选可编辑元素',
    'help.shortcut.audit': '审计模式',
    'help.shortcut.measure': '间距测量',
    'help.shortcut.pdfVector': '矢量 PDF',
    'help.shortcut.pdfImage': '长图 PDF',
    'help.shortcut.htmlEditable': '编辑 HTML',
    'help.shortcut.htmlReadonly': '预览 HTML',
  ...
  en: {
    ...
    'panel.btn.exportHtml.title': 'Export single-file HTML (receiver can double-click to keep annotating) · Shift+click = readonly',
    'singlefile.preparing': 'Packaging HTML…',
    'singlefile.done': 'HTML exported',
    'singlefile.fail': 'Export failed: {reason}',
    ...
    'shot.loadFailed': 'Screenshot library blocked · offline or page CSP · use OS screenshot + paste into feedback',
    ...
    'pdf.loadFailed': 'Image library blocked · offline or page CSP · use vector PDF (Space+P)',
    ...
    'overlay.edit': 'Edit mode (E)\nDouble-click any element to edit text / color / size',
    'overlay.feedback': 'Feedback panel (F)\nWrite feedback · screenshots · attachments',
    ...
    'export.pdf.image.hint': 'Whole page as one tall image',
    'export.html.editable': 'Editable HTML',
    'export.html.editable.hint': 'Receiver can keep annotating',
    'export.html.readonly': 'Read-only HTML',
    'export.html.readonly.hint': 'For client review · no editing',
    'readonly.print': 'Print / save as PDF',
    'welcome.editable': 'Double-click any element to annotate · ⌘Z to undo',
    'overlay.pick': 'Eyedropper\nClick anywhere to sample · hex to clipboard + feedback box',
    'overlay.undo': 'Undo (⌘Z)\nRoll back last action',
    'overlay.redo': 'Redo (⌘⇧Z)\nRestore an undone action',
    'overlay.compare': 'Before / after (O)\nToggle original vs edited',
    ...
    'help.shortcut.compare': 'Before / after',
    'overlay.save': 'Save edits\nPatch source HTML · auto-backup · right-click to reselect dir',
    'overlay.marquee': 'Marquee annotate (M)\nDrag a box → text / image',
    'overlay.help': 'Shortcuts / Help (?)\nView all shortcuts',
    'overlay.fold': 'Collapse toolbar\nClick edit FAB to expand',
    'help.title': 'Shortcuts',
    'help.group.modes': 'Modes',
    'help.group.actions': 'Actions',
    'help.group.selection': 'Selection',
    'help.group.history': 'Feedback / History',
    'help.group.view': 'View',
    'help.group.pointer': 'Pointer',
    ...
    'help.shortcut.copyDescriptor': 'Copy descriptor',
    'help.shortcut.multiSelect': 'Toggle multi-select',
    'help.shortcut.rubberBand': 'Rubber-band select',
    'help.shortcut.audit': 'Audit',
