...
const DICT = {
  zh: {
    ...
    'overlay.export': '导出 PDF / HTML',
    'export.pdf.vector': '矢量 PDF',
    'export.pdf.vector.hint': '可缩放 · 链接保留',
    'export.pdf.image': '长图 PDF',
    'export.pdf.image.hint': '整页一张超长图',
    'export.html.editable': '可编辑 HTML',
    'export.html.editable.hint': '接收方双击就能继续标',
    'export.html.readonly': '只读 HTML',
    'export.html.readonly.hint': '给客户演示 · 接收方不能编辑',
    'export.group.pptx': 'PPT',
    'export.pptx': 'PowerPoint (.pptx)',
    'export.pptx.hint': '每页一张 slide · 反馈进 speaker notes',
    'pptx.preparing': '正在加载 PPT 库…',
    'pptx.loadFailed': 'PPT 库加载失败 · 需联网',
    'pptx.progress': '截图中 {i} / {total}',
    'pptx.done': '已导出 {file}',
    'pptx.failed': '导出失败: {reason}',
  ...
  en: {
    ...
    'overlay.export': 'Export PDF / HTML',
    ...
    'export.group.pptx': 'PPT',
    'export.pptx': 'PowerPoint (.pptx)',
    'export.pptx.hint': 'One slide per page · feedback goes to speaker notes',
    'pptx.preparing': 'Loading PPT library…',
    'pptx.loadFailed': 'PPT library failed to load · network required',
    'pptx.progress': 'Capturing {i} / {total}',
    'pptx.done': 'Saved {file}',
    'pptx.failed': 'Export failed: {reason}',
