...
Direct source patching may break formatting or build artifacts. The skill workflow is recommended.`,"warn.complex.continue":"Continue anyway","clearAll.title":"Clear all feedback?","clearAll.desc":"All edits, per-page notes, global feedback, and screenshots will be removed. Local cache will also be cleared. This cannot be undone.","clearAll.confirm":"Clear all","common.cancel":"Cancel","pdf.vector.hint":'Vector PDF \xB7 Choose "Save as PDF" in the print dialog (Shift+P = long-image)',"pdf.loading":"Loading image library...","pdf.loadFailed":"Image library failed to load \xB7 Check your network","pdf.noSlides":"No slide elements found","pdf.progress":"Capturing {i} / {total}","pdf.saved":"Saved {file}","pdf.failed":"Export failed: {reason}","anno.action.note":"Feedback note (for agent only)","anno.action.image":"Add image","anno.action.delete":"Remove annotation","anno.placeholder.content":"Text to insert\u2026","anno.placeholder.note":"Note for agent\u2026","note.title":"Element feedback","note.placeholder":"Feedback for this element (delete / change / redraw / note for agent...)","tip.font":"Font (double-click element to edit text directly)","tip.tag":"Change tag (P / H1-H6)","tip.pick":"Eyedropper: sample any pixel on the page (hex to clipboard + feedback box)","tip.highlight":"Highlight (marker)","highlight.clear":"Clear highlight","op.highlight":"Highlighted","op.tag.done":"Tag changed to {tag}","op.tag.cleared":"Tag change cleared","toast.undo":"Undo","undo.done":"Undone","undo.empty":"Nothing to undo","undo.gone":"Element no longer in page","redo.done":"Redone","redo.empty":"Nothing to redo","redo.gone":"Element no longer in page","copy.descriptor.done":"Descriptor copied","copy.descriptor.empty":"No element selected","copy.descriptor.fail":"Copy failed","audit.on":"Audit \xB7 {n} change(s)","audit.empty":"Audit \xB7 nothing changed yet","audit.off":"Audit off","mode.chip.deck":"Deck","mode.chip.doc":"Doc","mode.chip.review":"Review","design.tag.spacing":"Spacing","design.tag.color":"Color","design.tag.typography":"Type","design.tag.layout":"Layout","design.tag.copy":"Copy","tip.replaceImg":"Replace image","tip.moveUp":"Move up 4px (Shift = 16px)","tip.moveDown":"Move down 4px (Shift = 16px)","tip.moveLeft":"Move left 4px (Shift = 16px)","tip.moveRight":"Move right 4px (Shift = 16px)","tip.zoomIn":"Zoom in 10%","tip.zoomOut":"Zoom out 10%","tip.note":"Write feedback for this element (no source change)","tip.link":"Edit hyperlink (href)","tip.hide":"Hide (placeholder kept)","tip.delete":"Delete (no placeholder)","tip.restore":"Restore all transforms","tip.close":"Deselect","tip.rotate":"Drag to rotate \xB7 Hold Shift to snap 15\xB0","tip.scale":"Drag to scale","overlay.edit":"Edit mode (E)","overlay.feedback":"Feedback panel (F)","overlay.export":"Export PDF \xB7 Shift+click = long-image","overlay.pick":"Eyedropper: click anywhere to sample a color \xB7 hex to clipboard + feedback box","overlay.undo":"Undo last action (\u2318Z)","overlay.redo":"Redo (\u2318\u21E7Z)","overlay.save":"Patch source HTML with all edits (auto-backup) \xB7 Right-click to reselect dir","overlay.marquee":"Marquee annotate: drag a box \u2192 text / image","overlay.help":"Shortcuts / Help","overlay.fold":"Collapse toolbar (click edit to expand + enter edit)","help.title":"Shortcuts","help.group.modes":"Modes","help.group.actions":"Actions","help.group.export":"Export","help.group.misc":"More","help.shortcut.edit":"Edit mode","help.shortcut.feedback":"Feedback panel","help.shortcut.marquee":"Marquee annotate","help.shortcut.cancel":"Cancel selection","help.shortcut.delete":"Delete selected element","help.shortcut.save":"Save feedback","help.shortcut.copy":"Copy feedback","help.shortcut.undo":"Undo","help.shortcut.redo":"Redo","help.shortcut.copyDescriptor":"Copy selected descriptor","help.shortcut.multiSelect":"Toggle add to / remove from multi-select","help.shortcut.audit":"Audit \xB7 show all changes","help.shortcut.measure":"Measure \xB7 select + Alt + hover target","help.shortcut.pdfVector":"Vector PDF","help.shortcut.pdfImage":"Long-image PDF","help.shortcut.help":"Toggle help"}},so="fbw-locale",ut=null;function ea(){try{let e=localStorage.getItem(so);return e&&fe[e]?e:null}catch{return null}}function ta(){if(typeof window<"u"&&window.__fbwLocale&&fe[window.__fbwLocale])return window.__fbwLocale;let e=ea();return e||((typeof navigator<"u"&&navigator.language||"en").toLowerCase().startsWith("zh")?"zh":"en")}function We(){return ut||(ut=ta()),ut}function lo(){let o=We()==="zh"?"en":"zh";try{localStorage.setItem(so,o)}catch{}typeof location<"u"&&location.reload()}function l(e,o){let t=We(),r=(fe[t]||fe.en)[e];return r===void 0&&(r=fe.en&&fe.en[e]||e),o&&Object.keys(o).forEach(i=>{r=r.replace(new RegExp("\\{"+i+"\\}","g"),o[i])}),r}var oa={scroll:"window",resize:"window",mousemove:"document",mouseup:"document"},co=new Map;function na(e){let o=co.get(e);if(o||(o={subs:new Set,attached:!1},co.set(e,o)),!o.attached){let t=oa[e]==="window"?window:document,r=e==="mousemove"||e==="mouseup"?{passive:!1,capture:!1}:{passive:!0,capture:!0};t.addEventListener(e,i=>{o.subs.forEach(s=>{try{s(i)}catch(c){console.warn("[fbw] event bus subscriber failed:",e,c)}})},r),o.attached=!0}return o}function Ke(e,o){let t=na(e);return t.subs.add(o),()=>t.subs.delete(o)}var ie=e=>Ke("scroll",e),te=e=>Ke("resize",e),se=e=>Ke("mousemove",e),le=e=>Ke("mouseup",e);var oe=null;function b(e,o){oe&&oe.parentNode&&oe.remove();let t=document.createElement("div");if(t.className="fbw-toast",o?.action){let n=document.createElement("span");n.textContent=e,t.appendChild(n);let r=document.createElement("button");r.className="fbw-toast-action",r.type="button",r.textContent=o.action.label,r.addEventListener("click",i=>{i.stopPropagation();try{o.action.onClick()}catch{}t.parentNode&&t.remove(),oe===t&&(oe=null)}),t.appendChild(r)}else t.textContent=e;oe=t,document.body.appendChild(t),setTimeout(()=>{t.parentNode&&t.remove(),oe===t&&(oe=null)},o?.duration??2400)}function Ce(e,o){if(!e)return;e.textContent=o;let t=e.closest(".fbw-pill");t&&t.classList.toggle("fbw-has-count",Number(o)>0)}function M(e){if(!a.panel)return;let o=e?e().length:0;Ce(a.panel.querySelector('[data-fbw-counter="edit"]'),o),Ce(a.panel.querySelector('[data-fbw-counter="sec"]'),a.sectionFeedback.size),Ce(a.panel.querySelector('[data-fbw-counter="att"]'),a.attachments.length);let t=a.panel.querySelector('[data-fbw-counter="ops"]');if(t&&Ce(t,a.elementOps.size),a.saveEditBtn){let n=o+a.elementOps.size,r=a.saveEditBtn.querySelector(".fbw-edit-count");r&&(r.textContent=n),a.saveEditBtn.classList.toggle("fbw-has-changes",n>0)}if(a.panel){let n=a.panel.querySelector('[data-fbw-counter="sec"]');n&&Ce(n,a.sectionFeedback.size+a.annotations.length)}if(typeof a.onChangeHook=="function")try{a.onChangeHook()}catch{}}function po(e){return(e?e().length:0)+a.elementOps.size}function mt({title:e,desc:o,choices:t}){return new Promise(n=>{let r=document.createElement("div");r.className="fbw-confirm fbw-on",r.innerHTML=`
    ...
    `,r.querySelector("[data-fbw-c-title]").textContent=e,r.querySelector("[data-fbw-c-desc]").textContent=o;let i=r.querySelector("[data-fbw-c-actions]");t.forEach((d,f)=>{let m=document.createElement("button"),y="fbw-btn";d.primary&&(y+=" fbw-primary"),d.danger&&(y+=" fbw-danger"),(d.cancel||d.value==="cancel")&&(y+=" fbw-btn-cancel"),m.className=y,m.dataset.fbwChoiceIdx=String(f),m.textContent=d.label,i.appendChild(m)}),document.body.appendChild(r);let s=()=>t.find(d=>d.cancel||d.value==="cancel")?.value??null,c=d=>{r.classList.add("fbw-confirm-leave"),document.removeEventListener("keydown",p,!0),setTimeout(()=>{r.remove(),n(d)},140)};r.addEventListener("click",d=>{let f=d.target.closest("[data-fbw-choice-idx]");if(f){c(t[parseInt(f.dataset.fbwChoiceIdx,10)].value);return}d.target===r&&c(s())});let p=d=>{d.key==="Escape"&&(d.stopPropagation(),c(s()))};document.addEventListener("keydown",p,!0)})}var aa=0,fo=0;function ra(e){return!(!e||e.closest(".fbw-panel, .fbw-fab, .fbw-toast, .fbw-confirm, script, style, button, [data-fbw-noedit]")||e.matches("button, br, img, svg, path, use, a[href]")||e.dataset.fbwEditId||!e.textContent.trim())}function $(e){return(e.textContent||"").replace(/^\s+|\s+$/g,"")}function bo(e){if(!ra(e))return;let o="fbw-e-"+aa++;e.dataset.fbwEditId=o,a.originals.set(o,$(e))}function uo(){let e=Array.from(document.querySelectorAll(R));return e.length===0&&(e=[document.querySelector('main, [role="main"], article')||document.body]),e.forEach(t=>{t.dataset.fbwSecId||(t.dataset.fbwSecId="fbw-sec-"+fo++);let n=(t.dataset.screenLabel||t.dataset.fbwLabel||t.querySelector(".label")?.innerText||t.querySelector("h1, h2")?.innerText||(t===document.body||t.tagName==="MAIN"||t.tagName==="ARTICLE"?document.title||"Page":"Section "+fo)).trim();t.dataset.fbwSecLabel=n.slice(0,80)}),document.querySelectorAll(Rt).forEach(bo),e.length===1&&e[0]===document.body||e.forEach(t=>{let n=document.createTreeWalker(t,NodeFilter.SHOW_ELEMENT,{acceptNode(i){return i.children.length>0||i.dataset&&i.dataset.fbwEditId?NodeFilter.FILTER_SKIP:NodeFilter.FILTER_ACCEPT}}),r;for(;r=n.nextNode();)bo(r)}),typeof window<"u"&&(window.__fbwOriginals=a.originals),e}function mo(e){let t=e.closest("[data-fbw-sec-id]")?.dataset.fbwSecLabel||"?",n=e.tagName.toLowerCase(),r=[...e.classList].filter(s=>!s.startsWith("fbw-")).slice(0,2).join("."),i=(e.textContent||"").replace(/\s+/g," ").trim().slice(0,28);return`[${t}] \xB7 ${n}${r?"."+r:""}${i?` \xB7 "${i}"`:""}`}function ia(){let e=0;return a.elementOps.forEach((o,t)=>{document.contains(t)||(a.elementOps.delete(t),e++)}),e}function T(e,o,t){a.elementOps.has(e)||a.elementOps.set(e,{ops:[],descriptor:mo(e)});let n=a.elementOps.get(e);n.ops=n.ops.filter(i=>i.op!==o);let r={op:o};t!==void 0&&(r.args=t),a.appMode==="review"&&(r.proposed=!0),n.ops.push(r),M(k)}function Ge(e){a.elementOps.delete(e),M(k)}function go(e,o){let t=(o||"").trim();if(!a.elementOps.has(e)){if(!t)return;a.elementOps.set(e,{ops:[],descriptor:mo(e)})}let n=a.elementOps.get(e);n.ops=n.ops.filter(r=>r.op!=="note"),t&&n.ops.push({op:"note",args:{text:t}}),n.ops.length===0&&a.elementOps.delete(e),M(k)}function Te(e){let o=a.elementOps.get(e);return o&&o.ops.find(n=>n.op==="note")?.args?.text||""}function G(e){return{x:parseFloat(e.dataset.fbwTx||"0"),y:parseFloat(e.dataset.fbwTy||"0"),scale:parseFloat(e.dataset.fbwScale||"1"),rotate:parseFloat(e.dataset.fbwRotate||"0")}}function X(e,o){e.dataset.fbwTx=o.x,e.dataset.fbwTy=o.y,e.dataset.fbwScale=o.scale,e.dataset.fbwRotate=o.rotate||0;let t=[];(o.x!==0||o.y!==0)&&t.push(`translate(${o.x}px, ${o.y}px)`),o.rotate&&t.push(`rotate(${o.rotate}deg)`),o.scale!==1&&t.push(`scale(${o.scale})`),e.style.transform=t.join(" ")}function k(){ia();let e=[];return document.querySelectorAll("[data-fbw-edit-id][data-fbw-edited]").forEach(o=>{let t=o.dataset.fbwEditId,n=a.originals.get(t),r=$(o);if(n!==r){let i=o.closest("[data-fbw-sec-id]");e.push({id:t,before:n,after:r,section:i?.dataset.fbwSecLabel||"?"})}}),e}var gt=null;function ho(){try{let e=localStorage.getItem(Se);if(!e)return;let o=JSON.parse(e);o.globalNote&&a.panel&&(a.panel.querySelector("[data-fbw-global]").value=o.globalNote),o.sectionFeedback&&Object.entries(o.sectionFeedback).forEach(([r,i])=>a.sectionFeedback.set(r,i)),Array.isArray(o.attachments)&&o.attachments.forEach(r=>a.attachments.push(r)),Array.isArray(o.annotations)&&o.annotations.forEach(r=>a.annotations.push(r));let t={anno:a.annotations.length,sec:a.sectionFeedback.size,att:a.attachments.length,hasGlobal:!!(o.globalNote||"").trim()};if(t.anno+t.sec+t.att+(t.hasGlobal?1:0)>0&&o.savedAt&&Date.now()-o.savedAt>6e4){let s=[];t.anno&&s.push(l("restore.piece.anno",{count:t.anno})),t.sec&&s.push(l("restore.piece.sec",{count:t.sec})),t.att&&s.push(l("restore.piece.att",{count:t.att})),t.hasGlobal&&s.push(l("restore.piece.global")),setTimeout(()=>b(l("restore.hint",{pieces:s.join(" \xB7 ")})),600)}}catch{}}var ht=!1;function wt(){if(!a.panel)return;let e;try{let o={};document.querySelectorAll("[data-fbw-edit-id][data-fbw-edited]").forEach(r=>{let i=r.dataset.fbwEditId,s=$(r);a.originals.get(i)!==s&&(o[i]=s)});let t={};a.sectionFeedback.forEach((r,i)=>{t[i]=r});let n={globalNote:a.panel.querySelector("[data-fbw-global]").value,sectionFeedback:t,attachments:a.attachments.map(r=>({id:r.id,name:r.name,type:r.type})),annotations:a.annotations,edits:o,savedAt:Date.now()};e=JSON.stringify(n)}catch(o){console.warn("[fbw] saveState serialize failed:",o);return}try{localStorage.setItem(Se,e),ht=!1}catch(o){console.warn("[fbw] saveState quota exceeded, payload size:",e.length,o?.name),ht||(ht=!0,b(l("persist.quota")));try{let t=JSON.parse(e);t.annotations=(t.annotations||[]).map(n=>({...n,image:n.image?{...n.image,dataURL:""}:n.image})),localStorage.setItem(Se,JSON.stringify(t))}catch{}}}function L(){gt&&clearTimeout(gt),gt=setTimeout(wt,400)}function wo(){try{localStorage.removeItem(Se)}catch{}}var Xe=[{key:"spacing",i18nKey:"design.tag.spacing"},{key:"color",i18nKey:"design.tag.color"},{key:"typography",i18nKey:"design.tag.typography"},{key:"layout",i18nKey:"design.tag.layout"},{key:"copy",i18nKey:"design.tag.copy"}];function sa(e){let o=Xe.map(r=>({key:r.key,label:l(r.i18nKey)})),t=new Set,n=e;for(;;){let r=n.match(/^\s*\[([^\]]+)\]\s*/);if(!r)break;let i=r[1].trim(),s=o.find(c=>c.label===i);if(!s)break;t.add(s.key),n=n.slice(r[0].length)}return t}function ce(e,o){if(!e||!o)return;let t=sa(o.value||"");e.querySelectorAll("[data-fbw-tag]").forEach(n=>{n.classList.toggle("fbw-on",t.has(n.dataset.fbwTag))})}function la(e,o){if(!e)return;let t=Xe.find(c=>c.key===o);if(!t)return;let n=l(t.i18nKey),r=`[${n}] `,i=e.value||"",s=new RegExp(`^\\s*\\[${n.replace(/[.*+?^${}()|[\\]\\\\]/g,"\\$&")}\\]\\s*`);s.test(i)?e.value=i.replace(s,""):e.value=r+i,e.dispatchEvent(new Event("input",{bubbles:!0})),e.focus()}function Ve(e,o){e&&e.addEventListener("click",t=>{let n=t.target.closest("[data-fbw-tag]");if(!n)return;t.preventDefault(),t.stopPropagation();let r=o();r&&(la(r,n.dataset.fbwTag),ce(e,r))})}function ca(){return'<div class="fbw-design-tags" data-fbw-tags>'+Xe.map(e=>`<button class="fbw-design-tag" type="button" data-fbw-tag="${e.key}">${l(e.i18nKey)}</button>`).join("")+"</div>"}var z=null,_=null,be=null,xo=!1;function da(){xo||(xo=!0,se(e=>{let o=be;if(!o)return;let t=e.clientX-o.startX,n=e.clientY-o.startY,r=o.box;if(o.type==="move")r.style.left=o.origLeft+t+"px",r.style.top=o.origTop+n+"px";else if(o.type==="resize"){let{origLeft:s,origTop:c,origW:p,origH:d,corner:f}=o,m=s,y=c,h=p,g=d;if(f.includes("e")&&(h=Math.max(24,p+t)),f.includes("s")&&(g=Math.max(24,d+n)),f.includes("w")){let u=Math.max(24,p-t);m=s+(p-u),h=u}if(f.includes("n")){let u=Math.max(24,d-n);y=c+(d-u),g=u}r.style.left=m+"px",r.style.top=y+"px",r.style.width=h+"px",r.style.height=g+"px"}}),le(()=>{if(!be)return;let e=be.persist;if(be=null,e)try{e()}catch{}}))}function pa(){if(!a.editMode)return;a.editMode=!1,document.body.classList.remove("fbw-edit-mode"),document.querySelectorAll("[data-fbw-edit-id]").forEach(o=>{o.contentEditable="false",o.spellcheck=!1});let e=document.querySelector(".fbw-selected");e&&e.classList.remove("fbw-selected"),a.selectedEl=null,a.elemToolbar?.classList.remove("fbw-toolbar-open"),a.resizeHandles?.classList.remove("fbw-on"),a.fontPicker?.classList.remove("fbw-fp-open"),a.editToggleBtn&&a.editToggleBtn.classList.remove("fbw-active"),a.editFab?.classList.remove("fbw-active")}function ue(){a.marqueeMode=!a.marqueeMode,a.marqueeMode&&a.editMode&&pa(),document.body.classList.toggle("fbw-marquee-mode",a.marqueeMode),a.marqueeToggleBtn&&a.marqueeToggleBtn.classList.toggle("fbw-active",a.marqueeMode),a.marqueeFab&&a.marqueeFab.classList.toggle("fbw-active",a.marqueeMode),b(a.marqueeMode?l("marquee.on"):l("marquee.off"))}function vo(){a.marqueeMode&&(a.marqueeMode=!1,document.body.classList.remove("fbw-marquee-mode"),a.marqueeToggleBtn&&a.marqueeToggleBtn.classList.remove("fbw-active"))}function fa(e){return e?!e.closest(".fbw-panel, .fbw-fab, .fbw-elem-toolbar, .fbw-confirm, .fbw-toast, .fbw-resize-handles, .fbw-anno, .fbw-marquee-drawing, .fbw-font-picker"):!1}function ko(e,o){let t=null;return document.querySelectorAll("[data-fbw-sec-id]").forEach(n=>{let r=n.getBoundingClientRect();e>=r.left&&e<=r.right&&o>=r.top&&o<=r.bottom&&(t=n)}),t||document.querySelector("[data-fbw-sec-id]")||document.querySelector(R)||document.body}function yo(e,o){if(!_||!z)return;let t=Math.min(z.startX,e),n=Math.min(z.startY,o),r=Math.abs(e-z.startX),i=Math.abs(o-z.startY);_.style.left=t+"px",_.style.top=n+"px",_.style.width=r+"px",_.style.height=i+"px"}function ba(e,o){let t=Math.min(z.startX,e),n=Math.min(z.startY,o),r=Math.abs(e-z.startX),i=Math.abs(o-z.startY);if(r<12||i<12)return;let s=ko(t+r/2,n+i/2),c=s?s.getBoundingClientRect():{left:0,top:0,width:1,height:1},p={id:"fbw-anno-"+Date.now()+"-"+Math.random().toString(36).slice(2,7),type:"region",secId:s?.dataset.fbwSecId||null,secLabel:s?.dataset.fbwSecLabel||null,rectPct:{x:(t-c.left)/c.width,y:(n-c.top)/c.height,w:r/c.width,h:i/c.height},content:"",note:"",image:null};p._autoEdit=!0,a.annotations.push(p),xt(p),L()}function ua(e,o){let t=ko(e,o);if(!t)return null;let n=t.getBoundingClientRect(),r={id:"fbw-anno-"+Date.now()+"-"+Math.random().toString(36).slice(2,7),type:"floating",secId:t.dataset.fbwSecId,secLabel:t.dataset.fbwSecLabel||null,rectPct:{x:(e-n.left)/n.width,y:(o-n.top)/n.height,w:0,h:0},content:"",_editing:!0};return a.annotations.push(r),xt(r),r}function Me(e){return String(e).replace(/[&<>"']/g,o=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[o])}function xt(e){e.type||(e.type="region"),e.text&&!e.note&&(e.note=e.text,delete e.text);let o=document.querySelector(`[data-anno-id="${e.id}"]`);return o&&o.remove(),e.type==="floating"?ma(e):ga(e)}function ma(e){let o=e.secId?document.querySelector(`[data-fbw-sec-id="${e.secId}"]`):null;if(!o)return;let t=o.getBoundingClientRect(),n=document.createElement("div");n.className="fbw-anno fbw-anno-floating",n.dataset.annoId=e.id,n.style.position="absolute",n.style.left=t.left+window.scrollX+e.rectPct.x*t.width+"px",n.style.top=t.top+window.scrollY+e.rectPct.y*t.height+"px",n.style.maxWidth=Math.max(180,t.width*.45)+"px";let r=()=>{a.annotations=a.annotations.filter(c=>c.id!==e.id),n.remove(),L()},i=()=>{if(e._editing=!1,!e.content||!e.content.trim()){r();return}n.innerHTML=`<div class="fbw-anno-floating-text">${Me(e.content).replace(/\n/g,"<br>")}</div><button class="fbw-anno-floating-x" data-action="delete" aria-label="delete">\xD7</button>`},s=()=>{e._editing=!0,n.innerHTML=`<textarea class="fbw-anno-floating-input" placeholder="${l("anno.placeholder.content")}"></textarea><button class="fbw-anno-floating-x" data-action="delete" aria-label="delete">\xD7</button>`;let c=n.querySelector("textarea");c.value=e.content||"",setTimeout(()=>{c.focus(),c.setSelectionRange(c.value.length,c.value.length)},0),["keydown","keyup","keypress","mousedown"].forEach(p=>c.addEventListener(p,d=>d.stopPropagation())),c.addEventListener("input",()=>{e.content=c.value,L()}),c.addEventListener("blur",i),c.addEventListener("keydown",p=>{p.key==="Escape"&&(p.preventDefault(),c.blur())})};n.addEventListener("click",c=>{c.target.closest('[data-action="delete"]')&&(c.stopPropagation(),r())}),n.addEventListener("dblclick",c=>{c.stopPropagation(),e._editing||s()}),document.body.appendChild(n),e._editing?s():i()}function ga(e){let o=e.secId?document.querySelector(`[data-fbw-sec-id="${e.secId}"]`):null;if(!o)return;let t=o.getBoundingClientRect(),n=document.createElement("div");n.className="fbw-anno",n.dataset.annoId=e.id,n.style.position="absolute",n.style.left=t.left+window.scrollX+e.rectPct.x*t.width+"px",n.style.top=t.top+window.scrollY+e.rectPct.y*t.height+"px",n.style.width=e.rectPct.w*t.width+"px",n.style.height=e.rectPct.h*t.height+"px",n.innerHTML=`
    <div class="fbw-anno-actions">
      <button data-action="note" data-tooltip="${l("anno.action.note")}">${K}</button>
      <button data-action="image" data-tooltip="${l("anno.action.image")}">${Ee}</button>
  ...
  `,document.body.appendChild(n);let r=()=>{let p=e.secId?document.querySelector(`[data-fbw-sec-id="${e.secId}"]`):null;if(!p)return;let d=p.getBoundingClientRect(),f=d.left+window.scrollX,m=d.top+window.scrollY;e.rectPct.x=(parseFloat(n.style.left)-f)/d.width,e.rectPct.y=(parseFloat(n.style.top)-m)/d.height,e.rectPct.w=parseFloat(n.style.width)/d.width,e.rectPct.h=parseFloat(n.style.height)/d.height,L()};da(),n.addEventListener("mousedown",p=>{p.button===0&&(p.target.closest("[data-action], textarea, [data-handle]")||n.classList.contains("fbw-anno-editing")||(p.preventDefault(),be={type:"move",box:n,persist:r,startX:p.clientX,startY:p.clientY,origLeft:parseFloat(n.style.left),origTop:parseFloat(n.style.top)}))}),n.querySelectorAll("[data-handle]").forEach(p=>{p.addEventListener("mousedown",d=>{d.button===0&&(d.preventDefault(),d.stopPropagation(),be={type:"resize",box:n,persist:r,corner:p.dataset.handle,startX:d.clientX,startY:d.clientY,origLeft:parseFloat(n.style.left),origTop:parseFloat(n.style.top),origW:parseFloat(n.style.width),origH:parseFloat(n.style.height)})})});let i=()=>{let p=n.querySelector(".fbw-anno-content"),d="";e.image?.dataURL&&(d+=`<img class="fbw-anno-img" src="${e.image.dataURL}" alt="${Me(e.image.name||"")}">`),e.content&&(d+=`<div class="fbw-anno-text-content">${Me(e.content).replace(/\n/g,"<br>")}</div>`),e.note&&(d+=`<div class="fbw-anno-text-note">${Me(e.note).replace(/\n/g,"<br>")}</div>`),p.innerHTML=d;let f=!!e.image&&!e.content?.trim()&&!e.note?.trim();n.classList.toggle("fbw-anno-image-only",f)};i();let s=()=>{a.annotations=a.annotations.filter(p=>p.id!==e.id),n.remove(),L()},c=p=>{let d=p==="content"?"fbw-anno-textarea fbw-anno-textarea-content":"fbw-anno-textarea fbw-anno-textarea-note",f=p==="content"?l("anno.placeholder.content"):l("anno.placeholder.note"),m=n.querySelector(".fbw-anno-content"),y=p==="note"?ca():"";m.innerHTML=`${y}<textarea class="${d}" placeholder="${f}">${Me(e[p]||"")}</textarea>`;let h=m.querySelector("textarea"),g=m.querySelector("[data-fbw-tags]");setTimeout(()=>{h.focus(),h.setSelectionRange(h.value.length,h.value.length)},0),["keydown","keyup","keypress","mousedown"].forEach(E=>h.addEventListener(E,W=>W.stopPropagation())),h.addEventListener("input",()=>{e[p]=h.value,L(),g&&ce(g,h)}),g&&(ce(g,h),Ve(g,()=>h)),n.classList.add("fbw-anno-editing");let u=!1,w=()=>{u||(u=!0,n.classList.remove("fbw-anno-editing"),i())},C=()=>{document.removeEventListener("mousedown",x,!0),w(),!e.content?.trim()&&!e.note?.trim()&&!e.image&&s()},x=E=>{n.contains(E.target)||C()};h.addEventListener("blur",w),h.addEventListener("keydown",E=>{E.key==="Escape"&&(E.preventDefault(),h.blur(),C())}),document.addEventListener("mousedown",x,!0)};n.addEventListener("dblclick",p=>{p.target.closest("[data-action]")||p.target.closest("textarea")||(p.stopPropagation(),p.preventDefault(),c("content"))}),n.addEventListener("click",p=>{let d=p.target.closest("[data-action]");if(!d)return;p.stopPropagation();let f=d.dataset.action;if(f==="content")c("content");else if(f==="note")c("note");else if(f==="image"){let m=document.createElement("input");m.type="file",m.accept="image/*",m.onchange=y=>{let h=y.target.files[0];if(!h)return;let g=new FileReader;g.onload=()=>{e.image={name:h.name,dataURL:g.result,type:h.type};let u=new Image;u.onload=()=>{let w=u.naturalWidth/u.naturalHeight,C=parseFloat(n.style.width),x=parseFloat(n.style.height),E=C/x,W=C,ve=x;w>E?ve=C/w:W=x*w,n.style.width=W+"px",n.style.height=ve+"px",r(),i()},u.src=g.result,i(),L()},g.readAsDataURL(h)},m.click()}else f==="delete"&&s()}),e._autoEdit&&(delete e._autoEdit,setTimeout(()=>c("content"),0))}function yt(){document.querySelectorAll(".fbw-anno").forEach(e=>e.remove()),a.annotations.forEach(xt)}function So(){document.addEventListener("mousedown",e=>{a.marqueeMode&&e.button===0&&fa(e.target)&&(e.preventDefault(),e.stopPropagation(),z={startX:e.clientX,startY:e.clientY},_=document.createElement("div"),_.className="fbw-marquee-drawing",document.body.appendChild(_),yo(e.clientX,e.clientY))},!0),se(e=>{z&&(e.preventDefault(),yo(e.clientX,e.clientY))}),le(e=>{z&&(ba(e.clientX,e.clientY),z=null,_&&(_.remove(),_=null))}),document.addEventListener("keydown",e=>{e.key==="Escape"&&a.marqueeMode&&!e.target.matches("textarea, input")&&(e.preventDefault(),ue())}),te(()=>{yt()}),document.addEventListener("dblclick",e=>{a.editMode||a.marqueeMode||e.target.closest(".fbw-panel, .fbw-fab, .fbw-fab-bar, .fbw-elem-toolbar, .fbw-anno, .fbw-tooltip, .fbw-confirm, .fbw-help-popover, .fbw-note-popover, .fbw-marker-popover, .fbw-font-picker, .fbw-resize-handles, .fbw-marquee-drawing, .fbw-toast")||e.target.dataset?.fbwEditId||!(e.target.closest&&e.target.closest("[data-fbw-sec-id]"))||(e.preventDefault(),e.stopPropagation(),ua(e.clientX,e.clientY),L())})}var A=null,me=null,Ze=null,ha=80;function wa(){return A||(A=document.createElement("div"),A.className="fbw-tooltip",document.body.appendChild(A),A)}function xa(e){let o=e.getBoundingClientRect(),t=A.getBoundingClientRect(),n=o.left+o.width/2-t.width/2,r=o.top-t.height-6;n<8&&(n=8),n+t.width>window.innerWidth-8&&(n=window.innerWidth-t.width-8),r<8&&(r=o.bottom+6),A.style.left=n+"px",A.style.top=r+"px"}function Eo(e,o){wa(),A.textContent=e,A.classList.add("fbw-on"),requestAnimationFrame(()=>xa(o))}function vt(){me&&(clearTimeout(me),me=null),Ze=null,A&&A.classList.remove("fbw-on")}function Lo(){document.addEventListener("mouseover",e=>{let o=e.target.closest&&e.target.closest("[data-tooltip]");if(!o||o===Ze)return;Ze=o;let t=o.dataset.tooltip;if(!t)return;me&&clearTimeout(me),A&&A.classList.contains("fbw-on")?Eo(t,o):me=setTimeout(()=>Eo(t,o),ha)},!0),document.addEventListener("mouseout",e=>{let o=e.target.closest&&e.target.closest("[data-tooltip]");if(o&&o===Ze){if(e.relatedTarget&&o.contains(e.relatedTarget))return;vt()}},!0),document.addEventListener("mousedown",vt,!0),ie(vt)}function ya(){return typeof navigator<"u"&&/Mac|iPhone|iPad/.test(navigator.platform)?"\u2318":"Ctrl"}function N(e,o){return`<div class="fbw-help-row">${(Array.isArray(e)?e:[e]).map(r=>`<kbd>${r}</kbd>`).join("")} <span>${o}</span></div>`}function va(){let e=ya();return`
  ...
  `}function To(){if(!a.helpPopover)return;let e=a.helpToggleBtn||a.helpFab;if(!e)return;let o=e.getBoundingClientRect(),t=a.helpPopover,n=window.innerHeight,r=n-24;t.style.maxHeight=r+"px",t.style.overflowY="auto";let i=t.getBoundingClientRect(),s=o.left+o.width/2-i.width/2,c=o.top-i.height-12;s<8&&(s=8),s+i.width>window.innerWidth-8&&(s=window.innerWidth-i.width-8),c<8&&(c=o.bottom+12),c+i.height>n-8&&(c=Math.max(8,n-i.height-8)),t.style.left=s+"px",t.style.top=c+"px"}function Fe(){let e=a.helpPopover;if(e){if(e.classList.contains("fbw-on")){e.classList.remove("fbw-on");return}e.innerHTML=va(),e.classList.add("fbw-on"),requestAnimationFrame(()=>To())}}function Co(){a.helpPopover&&a.helpPopover.classList.remove("fbw-on")}function Mo(){document.addEventListener("mousedown",e=>{let o=a.helpPopover;if(!o||!o.classList.contains("fbw-on")||e.target.closest('.fbw-help-popover, .fbw-help-fab, [data-fbw-btn="help"]'))return;let t=typeof e.composedPath=="function"?e.composedPath():[];t.some(n=>n&&n.dataset&&n.dataset.fbwBtn==="help")||t.some(n=>n&&n.classList&&n.classList.contains("fbw-help-popover"))||Co()},!0),document.addEventListener("keydown",e=>{e.key==="Escape"&&a.helpPopover?.classList.contains("fbw-on")&&Co()}),te(()=>{a.helpPopover?.classList.contains("fbw-on")&&To()})}function Fo(){let o=We()==="zh"?l("panel.localeName.en"):l("panel.localeName.zh");return`
    <div class="fbw-head">
      <span class="fbw-head-title">${K}<span>${l("panel.title")}</span></span>
      <span class="fbw-head-actions">
        <button class="fbw-icon-btn" data-fbw-shot data-tooltip="${l("panel.btn.shot.title")}">${Ee}</button>
    ...
    <div class="fbw-row">
      ...
      <span class="fbw-pill">${Ee}<span data-fbw-counter="att">0</span></span>
    </div>
  ...
  `}function Ao(){return`
    ...
    <button data-op="highlight" data-tooltip="${l("tip.highlight")}">${Wt}</button>
  ...
  `}function ka(){return'<div class="fbw-design-tags" data-fbw-tags>'+[["spacing",l("design.tag.spacing")],["color",l("design.tag.color")],["typography",l("design.tag.typography")],["layout",l("design.tag.layout")],["copy",l("design.tag.copy")]].map(([e,o])=>`<button class="fbw-design-tag" type="button" data-fbw-tag="${e}">${o}</button>`).join("")+"</div>"}var H=[],ge=[],$o=50;function Je(e){if(!e)return null;let o=a.elementOps.get(e);return{el:e,style:{transform:e.style.transform||"",fontFamily:e.style.fontFamily||"",backgroundColor:e.style.backgroundColor||"",backgroundImage:e.style.backgroundImage||"",visibility:e.style.visibility||""},dataset:{fbwTx:e.dataset.fbwTx??null,fbwTy:e.dataset.fbwTy??null,fbwScale:e.dataset.fbwScale??null,fbwRotate:e.dataset.fbwRotate??null,fbwOpHidden:e.dataset.fbwOpHidden??null,fbwOpDeleted:e.dataset.fbwOpDeleted??null,fbwHighlight:e.dataset.fbwHighlight??null,fbwOriginalSrc:e.dataset.fbwOriginalSrc??null},attrs:{tagAs:e.getAttribute("data-fbw-tag-as"),href:e.tagName==="A"?e.getAttribute("href"):void 0,src:e.tagName==="IMG"?e.getAttribute("src"):void 0},text:e.textContent,edited:e.dataset.fbwEdited??null,fbwChanged:e.classList.contains("fbw-changed"),opsClone:o?JSON.parse(JSON.stringify(o)):null}}function Oo(e){if(!e)return!1;let o=e.el;if(!o||!document.contains(o))return!1;for(let t of Object.keys(e.style))o.style[t]=e.style[t];for(let t of Object.keys(e.dataset))e.dataset[t]===null?delete o.dataset[t]:o.dataset[t]=e.dataset[t];return e.attrs.tagAs===null?o.removeAttribute("data-fbw-tag-as"):o.setAttribute("data-fbw-tag-as",e.attrs.tagAs),o.tagName==="A"&&e.attrs.href!==void 0&&(e.attrs.href===null?o.removeAttribute("href"):o.setAttribute("href",e.attrs.href)),o.tagName==="IMG"&&e.attrs.src!==void 0&&e.attrs.src!==null&&(o.src=e.attrs.src),typeof e.text=="string"&&o.textContent!==e.text&&(o.textContent=e.text),e.edited===null?delete o.dataset.fbwEdited:o.dataset.fbwEdited=e.edited,o.classList.toggle("fbw-changed",!!e.fbwChanged),e.opsClone?a.elementOps.set(o,e.opsClone):a.elementOps.delete(o),!0}function I(e){if(!e)return;let o=Je(e);o&&(H.push(o),H.length>$o&&H.shift(),ge.length=0)}function B(e){if(!e||!e.length)return;let o=[];for(let t of e){let n=Je(t);n&&o.push(n)}o.length&&(H.push({__group:!0,snaps:o}),H.length>$o&&H.shift(),ge.length=0)}function zo(e){if(e&&e.__group){let o=!1;for(let t of e.snaps)Oo(t)&&(o=!0);return o}return Oo(e)}function Io(e){if(e&&e.__group){let o=e.snaps.map(t=>Je(t.el)).filter(Boolean);return o.length?{__group:!0,snaps:o}:null}return Je(e.el)}function Pe(){if(H.length===0){b(l("undo.empty")||"\u6CA1\u6709\u53EF\u64A4\u9500\u7684\u64CD\u4F5C");return}let e=H.pop(),o=Io(e);o&&ge.push(o),zo(e)?(M(k),L(),b(l("undo.done")||"\u5DF2\u64A4\u9500")):b(l("undo.gone")||"\u5143\u7D20\u5DF2\u4E0D\u5728\u9875\u9762")}function kt(){if(ge.length===0){b(l("redo.empty")||"\u6CA1\u6709\u53EF\u91CD\u505A\u7684\u64CD\u4F5C");return}let e=ge.pop(),o=Io(e);o&&H.push(o),zo(e)?(M(k),L(),b(l("redo.done")||"\u5DF2\u91CD\u505A")):b(l("redo.gone")||"\u5143\u7D20\u5DF2\u4E0D\u5728\u9875\u9762")}function Do(){return H.length>0}function Ro(){return ge.length>0}function O(e){b(e,{action:{label:l("toast.undo")||"\u64A4\u9500",onClick:Pe},duration:4e3})}var Ae=null,de="unknown";async function Sa(){if(de==="denied"||de==="unsupported")return[];if(typeof navigator>"u"||typeof navigator.queryLocalFonts!="function")return de="unsupported",[];try{let e=await navigator.queryLocalFonts();de="granted";let o=new Set,t=[];for(let n of e)o.has(n.family)||(o.add(n.family),t.push({name:n.family,family:`"${n.family.replace(/"/g,'\\"')}"`,source:"local"}));return t.sort((n,r)=>n.name.localeCompare(r.name)),t}catch(e){return de="denied",console.warn("[fbw] queryLocalFonts denied:",e?.name||"?","\xB7",e?.message||e),[]}}async function Ea(){if(Ae)return Ae;let e={generic:[],document:[],local:[]};e.generic.push({name:"\u7CFB\u7EDF\u9ED8\u8BA4",family:"__inherit__",source:"inherit"}),e.generic.push({name:"system-ui",family:"system-ui, -apple-system, sans-serif",source:"generic"}),e.generic.push({name:"serif",family:"serif",source:"generic"}),e.generic.push({name:"sans-serif",family:"sans-serif",source:"generic"}),e.generic.push({name:"monospace",family:"ui-monospace, monospace",source:"generic"}),e.generic.push({name:"cursive",family:"cursive",source:"generic"});try{let t=new Set;document.fonts.forEach(n=>{let r=(n.family||"").replace(/^['"]|['"]$/g,"");r&&!t.has(r)&&(t.add(r),e.document.push({name:r,family:`"${r}"`,source:"document"}))})}catch{}e.local=await Sa();let o=new Map;return[...e.generic,...e.document,...e.local].forEach(t=>{o.has(t.name)||o.set(t.name,t)}),Ae=[...o.values()],Ae}function _o(e){return(e||"").replace(/^['"]|['"]$/g,"").trim().toLowerCase()}function La(e){return e?window.getComputedStyle(e).fontFamily.split(",").map(_o).filter(Boolean):[]}function Ca(e){return e==="document"?l("font.group.document"):e==="local"?l("font.group.local"):l("font.group.generic")}async function Ta(){let e=await Ea(),o={inherit:0,generic:1,document:2,local:3},t=[...e].sort((s,c)=>(o[s.source]||0)-(o[c.source]||0)),n=null,r=t.map(s=>{let c="";return s.source!==n&&s.source!=="inherit"?(n=s.source,c=`<div class="fbw-fp-group">${Ca(s.source)}</div>`):s.source==="inherit"&&(n="inherit"),c+`
    ...
    `}).join(""),i="";de==="denied"?i=`<div class="fbw-fp-hint">${l("font.localDenied")}</div>`:de==="unsupported"&&(i=`<div class="fbw-fp-hint">${l("font.localUnsupported")}</div>`),a.fontPicker.innerHTML=r+i}function Qe(){let e=a.elemToolbar.getBoundingClientRect(),o=e.bottom+6,t=e.left;t+240>window.innerWidth-8&&(t=window.innerWidth-248),t<8&&(t=8),o+360>window.innerHeight-8&&(o=Math.max(8,e.top-366)),a.fontPicker.style.top=o+"px",a.fontPicker.style.left=t+"px"}async function qo(){a.fontPicker.classList.add("fbw-fp-open"),Qe(),!Ae&&typeof navigator<"u"&&"queryLocalFonts"in navigator&&(a.fontPicker.innerHTML=`<div class="fbw-fp-loading">${l("font.loading")}</div>`),await Ta(),Qe();let e=La(window.__fbwSelEl);a.fontPicker.querySelectorAll(".fbw-fp-item").forEach(o=>{if(o.dataset.fpFamily==="__inherit__")return;let t=_o(o.dataset.fpName);e.includes(t)&&o.classList.add("fbw-fp-active")})}function V(){a.fontPicker.classList.remove("fbw-fp-open")}function Ho(){a.fontPicker.addEventListener("click",e=>{let o=e.target.closest(".fbw-fp-item");if(!o||!a.selectedEl)return;e.stopPropagation();let t=o.dataset.fpFamily.replace(/&quot;/g,'"'),n=o.dataset.fpName,r=j();B(r),r.forEach(i=>{t==="__inherit__"?(i.style.fontFamily="",delete i.dataset.fbwFontName,T(i,"font",{family:"\u7CFB\u7EDF\u9ED8\u8BA4"})):(i.style.fontFamily=t,i.dataset.fbwFontName=n,T(i,"font",{family:n}))}),O(r.length>1?`${l("op.font",{name:n})} \xB7 ${r.length}`:l("op.font",{name:n})),V()}),document.addEventListener("mousedown",e=>{a.fontPicker.classList.contains("fbw-fp-open")&&(e.target.closest(".fbw-font-picker, .fbw-elem-toolbar")||V())},!0)}var Bo=["tl","tr","br","bl"];function Uo(){let e=document.createElement("div");return e.className="fbw-resize-handles",Bo.forEach(o=>{let t=document.createElement("div");t.className="fbw-rotate-zone",t.dataset.handle=o,t.title="\u62D6\u52A8\u65CB\u8F6C \xB7 \u6309\u4F4F Shift \u5438\u9644 15\xB0",e.appendChild(t)}),Bo.forEach(o=>{let t=document.createElement("div");t.className="fbw-resize-handle",t.dataset.handle=o,t.title="\u62D6\u52A8\u7F29\u653E",e.appendChild(t)}),e}function St(e){!a.resizeHandles||!e||(a.resizeHandles.classList.add("fbw-on"),Ne(e))}function Yo(){a.resizeHandles&&a.resizeHandles.classList.remove("fbw-on")}function Ne(e){if(!a.resizeHandles||!e)return;let o=e.getBoundingClientRect();a.resizeHandles.style.top=o.top+"px",a.resizeHandles.style.left=o.left+"px",a.resizeHandles.style.width=o.width+"px",a.resizeHandles.style.height=o.height+"px"}var v=null,ne=null,Wo=[.5,.75,1,1.25,1.5,2],Ko=[0,45,90,135,180,-45,-90,-135];function Ma(){return ne||(ne=document.createElement("div"),ne.className="fbw-drag-readout",document.body.appendChild(ne),ne)}function jo(e,o,t){let n=Ma();n.textContent=e,n.style.left=o+14+"px",n.style.top=t+14+"px",n.classList.add("fbw-on")}function Fa(){ne&&ne.classList.remove("fbw-on")}function Pa(e){let o=Wo.find(t=>Math.abs(e-t)<.03);return o!==void 0?`${o.toFixed(2)}\xD7 \u2713`:`${e.toFixed(2)}\xD7`}function Aa(e){let o=Math.round(e),t=Ko.find(n=>Math.abs(o-n)<=2);return t!==void 0?`${t}\xB0 \u2713`:`${o}\xB0`}function Na(e){if(!a.elemToolbar)return;let o=e.getBoundingClientRect(),t=a.elemToolbar.getBoundingClientRect(),n=o.top-t.height-24,r=o.left;n<8&&(n=o.bottom+24),r+t.width>window.innerWidth-8&&(r=window.innerWidth-t.width-8),r<8&&(r=8),a.elemToolbar.style.top=n+"px",a.elemToolbar.style.left=r+"px"}function Go(){a.resizeHandles.addEventListener("mousedown",e=>{if(!a.editMode||!a.selectedEl||e.button!==0)return;let o=e.target.closest(".fbw-rotate-zone"),t=e.target.closest(".fbw-resize-handle");if(!o&&!t)return;e.preventDefault(),e.stopPropagation();let n=a.selectedEl,r=n.getBoundingClientRect(),i=r.left+r.width/2,s=r.top+r.height/2,c=G(n);if(I(n),t){let p=Math.hypot(e.clientX-i,e.clientY-s);v={mode:"scale",el:n,cx:i,cy:s,startDist:Math.max(p,1),baseScale:c.scale,baseX:c.x,baseY:c.y,baseRotate:c.rotate||0},document.body.style.cursor=window.getComputedStyle(t).cursor}else v={mode:"rotate",el:n,cx:i,cy:s,baseRotate:c.rotate||0,startAngle:Math.atan2(e.clientY-s,e.clientX-i)*180/Math.PI},document.body.style.cursor="grabbing"}),se(e=>{if(v){if(e.preventDefault(),v.mode==="scale"){let t=Math.hypot(e.clientX-v.cx,e.clientY-v.cy)/v.startDist,n=Math.max(.2,Math.min(3,v.baseScale*t));X(v.el,{x:v.baseX,y:v.baseY,scale:n,rotate:v.baseRotate}),jo(Pa(n),e.clientX,e.clientY)}else if(v.mode==="rotate"){let o=Math.atan2(e.clientY-v.cy,e.clientX-v.cx)*180/Math.PI,t=v.baseRotate+(o-v.startAngle);for(;t>180;)t-=360;for(;t<=-180;)t+=360;e.shiftKey&&(t=Math.round(t/15)*15);let n=G(v.el);X(v.el,{...n,rotate:t}),jo(Aa(t),e.clientX,e.clientY)}Ne(v.el),Na(v.el)}}),le(()=>{if(!v)return;let e=G(v.el);if(v.mode==="scale"){let o=Wo.find(n=>Math.abs(e.scale-n)<.03),t=o!==void 0?o:e.scale;o!==void 0&&X(v.el,{...e,scale:t}),T(v.el,"scale",{scale:parseFloat(t.toFixed(3))})}else if(v.mode==="rotate"){let o=Ko.find(n=>Math.abs(e.rotate-n)<=2),t=o!==void 0?o:e.rotate;o!==void 0&&X(v.el,{...e,rotate:t}),T(v.el,"rotate",{rotate:parseFloat(t.toFixed(2))})}Fa(),Ne(v.el),v=null,document.body.style.cursor=""})}var Oa=[{name:"yellow",value:"rgba(255, 235, 80, 0.55)",swatch:"#ffeb50",label:"\u9EC4"},{name:"green",value:"rgba(140, 220, 130, 0.55)",swatch:"#8cdc82",label:"\u7EFF"},{name:"blue",value:"rgba(150, 200, 255, 0.55)",swatch:"#96c8ff",label:"\u84DD"},{name:"pink",value:"rgba(255, 170, 200, 0.55)",swatch:"#ffaac8",label:"\u7C89"},{name:"orange",value:"rgba(255, 200, 130, 0.55)",swatch:"#ffc882",label:"\u6A59"}];function $a(){return`
    <div class="fbw-marker-row">${Oa.map(o=>`
  ...
  `}var Oe=null,Et=null;function za(e){let o=window.getSelection();if(!o||o.rangeCount===0)return null;let t=o.getRangeAt(0);return t.collapsed||!e.contains(t.commonAncestorContainer)?null:t.cloneRange()}function Ia(e,o,t){let n=document.createElement("span");n.className="fbw-hl",n.dataset.fbwHighlight=t||"1",n.style.background=o,n.style.borderRadius="2px",n.style.padding="0 1px";try{return e.surroundContents(n),n}catch{let r=e.extractContents();return n.appendChild(r),e.insertNode(n),n}}function Da(){let e=a.elemToolbar?.querySelector('[data-op="highlight"]');if(!e||!a.markerPopover)return;let o=a.markerPopover;o.style.visibility="hidden",o.style.top="0px",o.style.left="0px";let t=o.offsetHeight||80,n=o.offsetWidth||200,r=e.getBoundingClientRect(),i=a.elemToolbar.getBoundingClientRect(),s=i.right+8,c=i.top;s+n>window.innerWidth-8&&(s=i.left-n-8),s<8&&(s=Math.max(8,Math.min(r.left,window.innerWidth-n-8)),c=i.top-t-8,c<8&&(c=i.bottom+8)),o.style.top=c+"px",o.style.left=s+"px",o.style.visibility=""}function Vo(){a.markerPopover&&(Oe=a.selectedEl||null,Et=Oe?za(Oe):null,a.markerPopover.innerHTML=$a(),a.markerPopover.classList.add("fbw-on"),Da())}function U(){a.markerPopover&&a.markerPopover.classList.remove("fbw-on"),Oe=null,Et=null}function Ra(e){e.querySelectorAll(".fbw-hl").forEach(o=>{let t=o.parentNode;for(;o.firstChild;)t.insertBefore(o.firstChild,o);t.removeChild(o),t.normalize?.()})}function Xo(e,o,t,n){if(!e)return;if(n){I(e),o&&(Ia(n,o,t),window.getSelection()?.removeAllRanges(),T(e,"highlight",{color:o,name:t,scope:"range"}),O(l("op.highlight")+(t?": "+t:"")));return}let r=j();B(r),r.forEach(s=>{o?(s.style.background=o,s.dataset.fbwHighlight=t||"1",T(s,"highlight",{color:o,name:t,scope:"element"})):(Ra(s),s.style.background="",delete s.dataset.fbwHighlight,T(s,"highlight",{color:null}))});let i=o?l("op.highlight")+(t?": "+t:""):l("highlight.clear");O(r.length>1?`${i} \xB7 ${r.length}`:i)}function Zo(){let e=a.markerPopover;e&&(e.addEventListener("click",o=>{o.stopPropagation();let t=Oe||a.selectedEl;if(!t)return;let n=Et,r=o.target.closest("[data-color]");if(r){Xo(t,r.dataset.color,r.dataset.name,n),U();return}o.target.closest("[data-clear]")&&(Xo(t,"",null,null),U())}),document.addEventListener("mousedown",o=>{e.classList.contains("fbw-on")&&(o.target.closest('.fbw-marker-popover, [data-op="highlight"], .fbw-elem-toolbar')||U())},!0))}var Jo=["p","h1","h2","h3","h4","h5","h6"],P=null,Y=null;function Qo(){return P=document.createElement("div"),P.className="fbw-tag-popover",P.innerHTML=Jo.map(e=>`<button data-fbw-tag="${e}">${e.toUpperCase()}</button>`).join(""),P}function _a(e){return(e.getAttribute("data-fbw-tag-as")||e.tagName).toLowerCase()}function Lt(e){if(!P)return;let o=_a(e);P.querySelectorAll("[data-fbw-tag]").forEach(t=>{t.classList.toggle("fbw-active",t.dataset.fbwTag===o)})}function en(){if(!P||!a.selectedEl)return;let e=a.elemToolbar.getBoundingClientRect();P.style.top=e.bottom+6+"px",P.style.left=e.left+24+"px",P.classList.add("fbw-on"),Y=a.selectedEl.getAttribute("data-fbw-tag-as"),Lt(a.selectedEl)}function q(){P&&(P.classList.remove("fbw-on"),a.selectedEl&&Y!==void 0&&(Y===null?a.selectedEl.removeAttribute("data-fbw-tag-as"):a.selectedEl.setAttribute("data-fbw-tag-as",Y),Y=null))}function qa(e){a.selectedEl&&(e===a.selectedEl.tagName.toLowerCase()?a.selectedEl.removeAttribute("data-fbw-tag-as"):a.selectedEl.setAttribute("data-fbw-tag-as",e))}function Ha(e,o){if(!e||!Jo.includes(o))return;let t=e.tagName.toLowerCase(),n=Y;if(Y=null,o===t&&n==null){q();return}if(o===t){I(e),e.removeAttribute("data-fbw-tag-as");let r=a.elementOps.get(e);r&&(r.ops=r.ops.filter(i=>i.op!=="tag"),r.ops.length||Ge(e)),O(l("op.tag.cleared")||"\u5DF2\u64A4\u9500\u6807\u7B7E\u53D8\u66F4"),q();return}I(e),e.setAttribute("data-fbw-tag-as",o),T(e,"tag",{from:t,to:o}),O(l("op.tag.done",{tag:o.toUpperCase()})||`\u6807\u7B7E\u53D8\u66F4\u4E3A ${o.toUpperCase()}`),q()}function tn(){P&&(P.addEventListener("click",e=>{let o=e.target.closest("[data-fbw-tag]");!o||!a.selectedEl||(e.stopPropagation(),Ha(a.selectedEl,o.dataset.fbwTag))}),P.addEventListener("mouseover",e=>{let o=e.target.closest("[data-fbw-tag]");o&&(qa(o.dataset.fbwTag),Lt(a.selectedEl))}),P.addEventListener("mouseleave",()=>{a.selectedEl&&(Y===null?a.selectedEl.removeAttribute("data-fbw-tag-as"):Y!==void 0&&a.selectedEl.setAttribute("data-fbw-tag-as",Y),Lt(a.selectedEl))}),document.addEventListener("mousedown",e=>{P.classList.contains("fbw-on")&&(e.target.closest('.fbw-tag-popover, [data-op="tag"]')||q())},!0))}function Ba(e,o){if(!e)return!1;let t=e.selectionStart??e.value.length,n=e.selectionEnd??e.value.length,r=e.value.slice(0,t),i=e.value.slice(n);e.value=r+o+i;let s=t+o.length;return e.selectionStart=e.selectionEnd=s,e.dispatchEvent(new Event("input",{bubbles:!0})),!0}async function on(){if(typeof window.EyeDropper!="function"){b(l("eyedropper.unsupported")||"\u53D6\u8272\u5668\u4E0D\u652F\u6301\u5F53\u524D\u6D4F\u89C8\u5668 \xB7 \u9700\u8981 Chrome / Edge 95+");return}let e=a.panel?.classList.contains("fbw-open");e&&a.panel.classList.remove("fbw-open");let o;try{o=await new window.EyeDropper().open()}catch{e&&a.panel?.classList.add("fbw-open");return}e&&a.panel?.classList.add("fbw-open");let t=o.sRGBHex,n=document.activeElement,r=!1;n&&n.tagName==="TEXTAREA"&&n.closest(".fbw-panel, .fbw-anno, .fbw-note-popover")&&(r=Ba(n,t));try{await navigator.clipboard.writeText(t)}catch{}b(r?l("eyedropper.inserted",{hex:t})||`${t} \xB7 \u5DF2\u63D2\u5165\u53CD\u9988\u6846 + \u526A\u8D34\u677F`:l("eyedropper.copied",{hex:t})||`${t} \xB7 \u5DF2\u590D\u5236\u5230\u526A\u8D34\u677F`)}var ja="fbw",$e="kv",ze="blobs";var et=null;function Ct(){return et||(et=new Promise((e,o)=>{let t=indexedDB.open(ja,2);t.onupgradeneeded=n=>{let r=t.result;r.objectStoreNames.contains($e)||r.createObjectStore($e),r.objectStoreNames.contains(ze)||r.createObjectStore(ze)},t.onsuccess=()=>e(t.result),t.onerror=()=>o(t.error)}),et)}function nn(e,o){return Ct().then(t=>new Promise((n,r)=>{let s=t.transaction(e,"readonly").objectStore(e).get(o);s.onsuccess=()=>n(s.result),s.onerror=()=>r(s.error)}))}function an(e,o,t){return Ct().then(n=>new Promise((r,i)=>{let s=n.transaction(e,"readwrite");s.objectStore(e).put(t,o),s.oncomplete=()=>r(),s.onerror=()=>i(s.error)}))}function rn(e,o){return Ct().then(t=>new Promise((n,r)=>{let i=t.transaction(e,"readwrite");i.objectStore(e).delete(o),i.oncomplete=()=>n(),i.onerror=()=>r(i.error)}))}var tt=e=>nn($e,e),ot=(e,o)=>an($e,e,o),nt=e=>rn($e,e),sn=e=>nn(ze,e),ln=(e,o)=>an(ze,e,o),cn=e=>rn(ze,e);function dn(e){return new Promise((o,t)=>{let n=new FileReader;n.onload=()=>o(n.result),n.onerror=t,n.readAsDataURL(e)})}function at(e){if(!e||!e.type?.startsWith("image/"))return;let o="fbw-att-"+Date.now()+"-"+Math.random().toString(36).slice(2,7),t=e.name||"\u622A\u56FE-"+new Date().toISOString().slice(11,19).replace(/:/g,"")+".png";dn(e).then(n=>{a.attachments.push({id:o,name:t,dataURL:n,type:e.type}),Z(),L(),b(l("panel.attachment.added",{count:a.attachments.length})),ln(o,e).catch(r=>console.warn("[fbw] idb put blob failed:",r))}).catch(n=>console.warn("[fbw] read blob failed:",n))}async function pn(){let e=0;for(let o of a.attachments)if(!o.dataURL)try{let t=await sn(o.id);t&&(o.dataURL=await dn(t),e++)}catch{}e>0&&Z()}function Z(){let e=a.panel.querySelector("[data-fbw-attachments]");e.innerHTML="",a.attachments.forEach((o,t)=>{let n=document.createElement("div");n.className="fbw-thumb";let r=document.createElement("img");r.src=o.dataURL;let i=document.createElement("button");i.className="fbw-thumb-x",i.innerHTML="\xD7",i.type="button",i.addEventListener("click",s=>{s.stopPropagation();let c=a.attachments.splice(t,1)[0];Z(),M(k),L(),c?.id&&cn(c.id).catch(()=>{})}),n.appendChild(r),n.appendChild(i),e.appendChild(n)}),M(k)}function fn(){let e=t=>{let n=t.clipboardData?.items;if(!n)return;let r=!1;for(let i of n)if(i.type.startsWith("image/")){let s=i.getAsFile();s&&(at(s),r=!0)}r&&t.preventDefault()},o=a.panel.querySelector("[data-fbw-global]");["keydown","keyup","keypress"].forEach(t=>o.addEventListener(t,n=>n.stopPropagation())),o.addEventListener("paste",e),a.panel.addEventListener("paste",e),a.panel.addEventListener("dragover",t=>{t.preventDefault(),t.dataTransfer?.types?.includes("Files")&&a.panel.classList.add("fbw-drag-over")}),a.panel.addEventListener("dragleave",t=>{(t.target===a.panel||!a.panel.contains(t.relatedTarget))&&a.panel.classList.remove("fbw-drag-over")}),a.panel.addEventListener("drop",t=>{t.preventDefault(),a.panel.classList.remove("fbw-drag-over"),Array.from(t.dataTransfer?.files||[]).filter(r=>r.type.startsWith("image/")).forEach(at)})}function Ua(e){let o=a.elemToolbar?.querySelector('[data-op="note"]');o&&o.classList.toggle("fbw-has-note",!!Te(e))}function Ya(){if(!a.notePopover)return;let e=a.elemToolbar.querySelector('[data-op="note"]');if(!e)return;let o=e.getBoundingClientRect(),t=a.notePopover,n=o.bottom+6,r=o.left;r+300>window.innerWidth-8&&(r=window.innerWidth-308),r<8&&(r=8),n+180>window.innerHeight-8&&(n=Math.max(8,o.top-186)),t.style.top=n+"px",t.style.left=r+"px"}function Wa(e){let o=a.notePopover;if(!o)return;let t=o.querySelector("[data-fbw-note-text]");t.value=Te(e),o.classList.add("fbw-on"),Ya(),ce(o.querySelector("[data-fbw-tags]"),t),setTimeout(()=>t.focus(),0)}function re(){a.notePopover&&a.notePopover.classList.remove("fbw-on")}function bn(){let e=a.notePopover;if(!e)return;let o=e.querySelector("[data-fbw-note-text]");["keydown","keyup","keypress"].forEach(t=>o.addEventListener(t,n=>n.stopPropagation())),o.addEventListener("input",()=>{a.selectedEl&&(go(a.selectedEl,o.value),Ua(a.selectedEl),ce(e.querySelector("[data-fbw-tags]"),o))}),Ve(e.querySelector("[data-fbw-tags]"),()=>o),e.querySelector("[data-fbw-note-close]").addEventListener("click",t=>{t.stopPropagation(),re()}),document.addEventListener("mousedown",t=>{e.classList.contains("fbw-on")&&(t.target.closest(".fbw-note-popover, .fbw-elem-toolbar")||re())},!0)}function un(){a.elemToolbar.addEventListener("click",e=>{let o=e.target.closest("[data-op]");if(!o||!a.selectedEl)return;e.stopPropagation();let t=o.dataset.op,n=a.selectedEl;if(t==="close"){F();return}if(t==="delete"){let r=j();B(r),r.forEach(i=>{T(i,"delete"),i.dataset.fbwOpDeleted="1"}),O(r.length>1?`${l("op.delete")} \xB7 ${r.length}`:l("op.delete"));return}if(t==="hide"){let r=j();B(r),r.forEach(i=>{T(i,"hide"),i.dataset.fbwOpHidden="1"}),O(r.length>1?`${l("op.hide")} \xB7 ${r.length}`:l("op.hide"));return}if(t==="link"){if(n.tagName!=="A")return;let r=n.getAttribute("href")||"",i=prompt(l("op.link.prompt")||"\u6539\u94FE\u63A5 (href)\uFF1A",r);if(i==null)return;let s=i.trim();if(s===r)return;I(n),n.setAttribute("href",s),T(n,"href",{before:r,after:s}),O(l("op.link.done")||`\u94FE\u63A5\u5DF2\u6539\uFF1A${s.slice(0,40)}${s.length>40?"\u2026":""}`);return}if(t==="restore"){let r=j();B(r),r.forEach(i=>{delete i.dataset.fbwOpDeleted,delete i.dataset.fbwOpHidden,delete i.dataset.fbwTx,delete i.dataset.fbwTy,delete i.dataset.fbwScale,delete i.dataset.fbwRotate,delete i.dataset.fbwHighlight,i.removeAttribute("data-fbw-tag-as"),i.style.transform="",i.style.backgroundImage="",i.style.backgroundColor="",i.tagName==="IMG"&&i.dataset.fbwOriginalSrc&&(i.src=i.dataset.fbwOriginalSrc,delete i.dataset.fbwOriginalSrc),Ge(i)}),O(r.length>1?`${l("op.restore")} \xB7 ${r.length}`:l("op.restore")),pe(n);return}if(t.startsWith("move-")){let r=j();B(r);let i=t.slice(5),s=e.shiftKey?16:4;r.forEach(c=>{let p=G(c);i==="up"&&(p.y-=s),i==="down"&&(p.y+=s),i==="left"&&(p.x-=s),i==="right"&&(p.x+=s),X(c,p),T(c,"move",{x:p.x,y:p.y})}),pe(n);return}if(t==="zoom-in"||t==="zoom-out"){let r=j();B(r);let i=t==="zoom-in"?1.1:1/1.1;r.forEach(s=>{let c=G(s);c.scale=Math.max(.2,Math.min(3,c.scale*i)),X(s,c),T(s,"scale",{scale:parseFloat(c.scale.toFixed(3))})}),pe(n);return}if(t==="font"){window.__fbwSelEl=n,a.fontPicker.classList.contains("fbw-fp-open")?V():(U(),re(),q(),qo());return}if(t==="highlight"){a.markerPopover?.classList.contains("fbw-on")?U():(V(),re(),q(),Vo());return}if(t==="tag"){a.tagPopover?.classList.contains("fbw-on")?q():(V(),re(),U(),en());return}if(t==="pick"){on();return}if(t==="note"){a.notePopover?.classList.contains("fbw-on")?re():(V(),U(),q(),Wa(n));return}if(t==="replace-img"){let r=document.createElement("input");r.type="file",r.accept="image/*",r.onchange=i=>{let s=i.target.files[0];if(!s)return;let c=new FileReader;c.onload=()=>{I(n),n.tagName==="IMG"?(n.dataset.fbwOriginalSrc||(n.dataset.fbwOriginalSrc=n.src),n.src=c.result):n.style.backgroundImage=`url(${c.result})`,T(n,"replace-img",{name:s.name}),a.attachments.push({id:"fbw-att-"+Date.now()+"-"+Math.random().toString(36).slice(2,7),name:s.name||"\u66FF\u6362\u56FE-"+Date.now()+".png",dataURL:c.result,type:s.type}),Z(),O(l("op.replaceImg"))},c.readAsDataURL(s)},r.click()}})}var Ka=10,ae=null;function mn(){document.addEventListener("mousedown",e=>{if(!a.editMode||!a.selectedEl||e.button!==0||e.target.closest(".fbw-elem-toolbar, .fbw-panel, .fbw-fab, .fbw-resize-handle"))return;let o=e.target,t=rt(o);if(!(o===a.selectedEl||t===a.selectedEl||a.selectedEl.contains(o))||a.selectedEl.dataset.fbwEditing==="1")return;let r=G(a.selectedEl);ae={el:a.selectedEl,startX:e.clientX,startY:e.clientY,baseX:r.x,baseY:r.y,baseScale:r.scale}},!0),se(e=>{if(ae&&!a.dragState){let r=e.clientX-ae.startX,i=e.clientY-ae.startY;if(Math.hypot(r,i)<Ka)return;I(ae.el),a.dragState={...ae,moved:!0},ae=null,document.body.style.cursor="move",e.preventDefault()}if(!a.dragState)return;let o=e.clientX-a.dragState.startX,t=e.clientY-a.dragState.startY,n={x:a.dragState.baseX+o,y:a.dragState.baseY+t,scale:a.dragState.baseScale};X(a.dragState.el,n),it()}),le(()=>{if(ae=null,!a.dragState)return;let e=a.dragState.el;if(a.dragState.moved){let o=G(e);T(e,"move",{x:Math.round(o.x),y:Math.round(o.y)})}a.dragState=null,document.body.style.cursor=""})}function Ga(e){if(!e)return"";let o=e.getAttribute("data-screen-label")||e.getAttribute("aria-label");if(o)return o.trim();let t=e.querySelector("h1, h2, h3, h4, h5, h6");if(t&&t.textContent){let r=t.textContent.trim().replace(/\s+/g," ");if(r)return r.length>18?r.slice(0,18)+"\u2026":r}if(e.id)return"#"+e.id;let n=(e.className||"").toString().split(/\s+/).find(r=>r&&!r.startsWith("fbw-"));return n?"."+n:e.tagName.toLowerCase()}function Xa(e){if(!e)return"";let o=e.tagName.toLowerCase(),t=e.parentElement?e.parentElement.closest("section, article, [data-fbw-sec-id]"):null;!t&&e.matches("section, article, [data-fbw-sec-id]")&&(t=e);let n=t&&t!==e?Ga(t):"",r=e.parentElement,i="";if(r){let s=[...r.children].filter(c=>c.tagName===e.tagName);s.length>1&&(i=` (${s.indexOf(e)+1}/${s.length})`)}return[n,o+i].filter(Boolean).join(" \xB7 ")}function yn(e){if(!a.elemToolbar)return;let o=a.elemToolbar.querySelector("[data-fbw-path]"),t=a.elemToolbar.querySelector("[data-fbw-path-divider]");if(!o||!t)return;let n=Xa(e);n?(o.textContent=n,o.title=n,o.style.display="",t.style.display=""):(o.style.display="none",t.style.display="none")}function rt(e){if(!e)return e;let o=e.closest("svg");if(o&&!o.matches(".fbw-icon-btn svg, .fbw-elem-toolbar svg, .fbw-fab svg, .fbw-panel svg"))return o;if(!e.dataset?.fbwEditId&&e.closest){let t=e.closest("[data-fbw-edit-id]");if(t)return t}return e}var gn=24;function pe(e){let o=e.getBoundingClientRect(),t=a.elemToolbar.getBoundingClientRect(),n=o.top-t.height-gn,r=o.left;n<8&&(n=o.bottom+gn),r+t.width>window.innerWidth-8&&(r=window.innerWidth-t.width-8),r<8&&(r=8),a.elemToolbar.style.top=n+"px",a.elemToolbar.style.left=r+"px"}function Va(e){for(let o of e.childNodes)if(o.nodeType===3&&o.textContent.trim())return!0;return!1}function Mt(){if(!a.elemToolbar)return;let e=a.elemToolbar.querySelector(".fbw-tb-count"),o=a.selectedEls.size;if(o<=1){e&&e.remove();return}e||(e=document.createElement("span"),e.className="fbw-tb-count",a.elemToolbar.appendChild(e)),e.textContent=o,e.title=`${o} selected`}function vn(e){if(!a.elemToolbar||!e)return;let o=a.selectedEls.size>1,t=e.matches("img")||(getComputedStyle(e).backgroundImage||"none")!=="none";a.elemToolbar.querySelector('[data-op="replace-img"]').style.display=!o&&t?"inline-flex":"none";let n=Va(e)&&!e.matches("img, svg, video, iframe"),r=a.elemToolbar.querySelector('[data-op="font"]');r&&(r.style.display=n?"inline-flex":"none");let i=a.elemToolbar.querySelector('[data-op="highlight"]');i&&(i.style.display=n?"inline-flex":"none");let s=/^(p|h[1-6])$/i.test(e.tagName),c=a.elemToolbar.querySelector('[data-op="tag"]');c&&(c.style.display=!o&&s?"inline-flex":"none");let p=e.matches("a[href]"),d=a.elemToolbar.querySelector('[data-op="link"]');d&&(d.style.display=!o&&p?"inline-flex":"none");let f=a.elemToolbar.querySelector('[data-op="note"]');f&&(f.style.display=o?"none":"inline-flex",f.classList.toggle("fbw-has-note",!!Te(e)))}function hn(e){a.selectedEls.size===1&&a.selectedEl===e||(F(),a.selectedEl=e,a.selectedEls.add(e),e.classList.add("fbw-selected"),vn(e),Mt(),yn(e),a.elemToolbar.classList.add("fbw-toolbar-open"),pe(e),St(e))}function Za(e){if(a.selectedEls.has(e)){if(a.selectedEls.delete(e),e.classList.remove("fbw-selected"),a.selectedEl===e){let o=a.selectedEls.values().next().value;if(o)a.selectedEl=o;else{F();return}}}else a.selectedEls.add(e),e.classList.add("fbw-selected"),a.selectedEl=e;vn(a.selectedEl),Mt(),yn(a.selectedEl),a.elemToolbar.classList.add("fbw-toolbar-open"),pe(a.selectedEl),St(a.selectedEl)}function F(){a.selectedEls.forEach(e=>e.classList.remove("fbw-selected")),a.selectedEls.clear(),a.selectedEl=null,typeof window<"u"&&(window.__fbwSelEl=null),V(),re(),U(),q(),a.elemToolbar.classList.remove("fbw-toolbar-open"),Mt(),Yo()}function j(){return[...a.selectedEls].filter(e=>document.contains(e))}function Ja(e){I(e),F(),e.contentEditable="true",e.spellcheck=!1,e.dataset.fbwEditing="1",e.dataset.fbwEdited="1",e.focus();try{let o=document.createRange();o.selectNodeContents(e);let t=window.getSelection();t.removeAllRanges(),t.addRange(o)}catch{}}var Tt=null;function it(){a.selectedEl&&(Tt&&cancelAnimationFrame(Tt),Tt=requestAnimationFrame(()=>{pe(a.selectedEl),Ne(a.selectedEl),a.fontPicker.classList.contains("fbw-fp-open")&&Qe()}))}function wn(e){let o=e.target.dataset?.fbwEditId;o&&(e.target.classList.toggle("fbw-changed",a.originals.get(o)!==$(e.target)),M(k),L())}function xn(){document.body.classList.toggle("fbw-edit-mode",a.editMode),document.querySelectorAll("[data-fbw-edit-id]").forEach(e=>{e.contentEditable="false",e.spellcheck=!1}),a.editMode||F(),a.editToggleBtn&&a.editToggleBtn.classList.toggle("fbw-active",a.editMode),a.editFab&&a.editFab.classList.toggle("fbw-active",a.editMode),a.editMode&&a.marqueeMode&&(a.marqueeMode=!1,document.body.classList.remove("fbw-marquee-mode"),a.marqueeFab&&a.marqueeFab.classList.remove("fbw-active"),a.marqueeToggleBtn&&a.marqueeToggleBtn.classList.remove("fbw-active"))}function he(){if(!a.editMode){a.marqueeMode&&vo(),a.editMode=!0,xn(),b(l("edit.on"));return}let e=po(k);a.editMode=!1,xn(),b(e>0?l("edit.off.pending",{count:e}):l("edit.off"))}function kn(){let e="[data-fbw-sec-id]",o=".fbw-panel, .fbw-fab, .fbw-fab-bar, .fbw-elem-toolbar, .fbw-confirm, .fbw-toast, .fbw-marker-popover, .fbw-tag-popover, .fbw-font-picker, .fbw-note-popover, .fbw-help-popover, .fbw-tooltip, .fbw-anno, script, style";document.addEventListener("click",t=>{if(!a.editMode)return;let n=t.target;if(!n||n.closest(o))return;n.closest&&n.closest("a[href]")&&t.preventDefault();let r=n.closest(e);if(!r){a.selectedEl&&F();return}if(n===r){a.selectedEl&&F();return}n=rt(n),!(n.isContentEditable&&n===a.selectedEl)&&(t.preventDefault(),t.stopPropagation(),t.shiftKey||t.metaKey||t.ctrlKey?Za(n):hn(n))},!0),document.addEventListener("dblclick",t=>{if(!a.editMode)return;let n=t.target;if(!n||n.closest(o)||!n.closest(e))return;n=rt(n);let r=n.tagName.toLowerCase();if(!(r==="svg"||r==="img")){if(a.appMode==="review"){t.preventDefault(),t.stopPropagation(),hn(n);return}t.preventDefault(),t.stopPropagation(),Ja(n)}},!0),document.addEventListener("blur",t=>{let n=t.target;n&&n.dataset&&n.dataset.fbwEditing==="1"&&(n.contentEditable="false",delete n.dataset.fbwEditing)},!0),document.addEventListener("keydown",t=>{if(t.key==="Escape"){a.selectedEl&&(t.preventDefault(),F());let n=document.activeElement;n&&n.dataset&&n.dataset.fbwEditing==="1"&&(n.contentEditable="false",delete n.dataset.fbwEditing,n.blur())}}),["input","compositionend","paste","cut","drop"].forEach(t=>{document.addEventListener(t,wn,!0)}),document.addEventListener("blur",t=>{t.target.dataset?.fbwEditId&&wn(t)},!0),document.addEventListener("keydown",t=>{(t.target.dataset?.fbwEditId||t.target.closest(".fbw-panel, .fbw-confirm"))&&t.stopPropagation()},!0),ie(it),te(it),document.addEventListener("slidechange",()=>F())}function Ie(e){let o=e.closest("[data-fbw-sec-id]");if(!o)return null;let n=[...document.querySelectorAll(R)].indexOf(o);if(n<0)return null;let r=[],i=e;for(;i&&i!==o;){let s=i.tagName.toLowerCase(),c=i.parentElement;if(!c)break;let p=[...c.children].filter(d=>d.tagName===i.tagName);p.length>1&&(s+=`:nth-of-type(${p.indexOf(i)+1})`),r.unshift(s),i=c}return{secIndex:n,secLabel:o.dataset.fbwSecLabel||null,path:r.join(" > "),contentSample:(e.textContent||"").replace(/\s+/g," ").trim().slice(0,40),tag:e.tagName.toLowerCase()}}function Ft(e,o,t){let r=e.querySelectorAll(t)[o.secIndex];if(!r)return{ok:!1,reason:"section-not-found"};let i=null;try{i=o.path?r.querySelector(o.path):r}catch{return{ok:!1,reason:"invalid-path"}}if(!i)return{ok:!1,reason:"element-not-found"};let s=(i.textContent||"").replace(/\s+/g," ").trim().slice(0,40);return{ok:!0,el:i,contentMismatch:s!==o.contentSample}}function Qa(e){if(!e)return"";let o=e.getAttribute("data-screen-label")||e.dataset.fbwSecLabel||e.getAttribute("aria-label");if(o)return o.trim();let t=e.querySelector("h1, h2, h3, h4, h5, h6");return t&&t.textContent?t.textContent.trim().replace(/\s+/g," ").slice(0,24):e.id?"#"+e.id:e.tagName.toLowerCase()}function er(e){if(!e)return"";let o=e.closest("section, article, [data-fbw-sec-id]"),t=o?Qa(o):"",n=e.tagName.toLowerCase(),r=(e.textContent||"").replace(/\s+/g," ").trim().slice(0,60),i=Ie(e),s=`[${t||"page"}] ${n}${r?` \xB7 "${r}${r.length>=60?"\u2026":""}"`:""}`;return i&&i.path?`${s}
selector: ${i.path}`:s}async function Sn(){if(!a.selectedEl){b(l("copy.descriptor.empty")||"\u6CA1\u6709\u9009\u4E2D\u5143\u7D20");return}let e=er(a.selectedEl);try{await navigator.clipboard.writeText(e),b(l("copy.descriptor.done")||"\u5DF2\u590D\u5236\u5143\u7D20\u63CF\u8FF0\u7B26")}catch{let t=document.createElement("textarea");t.value=e,t.style.position="fixed",t.style.opacity="0",document.body.appendChild(t),t.select();try{document.execCommand("copy"),b(l("copy.descriptor.done")||"\u5DF2\u590D\u5236\u5143\u7D20\u63CF\u8FF0\u7B26")}catch{b(l("copy.descriptor.fail")||"\u590D\u5236\u5931\u8D25")}document.body.removeChild(t)}}var tr=["delete","hide","replace-img","tag","font","highlight","scale","rotate","move","href"];function or(e,o){for(let t of tr)if(e.some(n=>n.op===t))return t;return o?"text":e[0]?.op||null}function En(){let e=new Set;document.querySelectorAll("[data-fbw-edit-id]").forEach(t=>{let n=t.dataset.fbwEditId,r=a.originals.get(n);r!==void 0&&r!==$(t)&&e.add(t)});let o=new Set(e);a.elementOps.forEach((t,n)=>{document.contains(n)&&t.ops?.length&&o.add(n)}),o.forEach(t=>{let r=a.elementOps.get(t)?.ops||[],i=e.has(t),s=or(r,i);t.classList.add("fbw-audit-changed"),s&&t.setAttribute("data-fbw-audit-op",s);let c=r.length+(i?1:0);c>0&&t.setAttribute("data-fbw-audit-count",String(c))})}function Ln(){document.querySelectorAll(".fbw-audit-changed").forEach(e=>{e.classList.remove("fbw-audit-changed"),e.removeAttribute("data-fbw-audit-count"),e.removeAttribute("data-fbw-audit-op"),e.removeAttribute("data-fbw-audit-kind")})}function Cn(){if(document.body.classList.toggle("fbw-audit-mode")){En();let o=document.querySelectorAll(".fbw-audit-changed").length;b(o?l("audit.on",{n:o})||`\u5BA1\u8BA1\u6A21\u5F0F \xB7 ${o} \u5904\u6539\u52A8`:l("audit.empty")||"\u5BA1\u8BA1\u6A21\u5F0F \xB7 \u6CA1\u6709\u6539\u52A8")}else Ln(),b(l("audit.off")||"\u5BA1\u8BA1\u6A21\u5F0F\u5173\u95ED")}function Tn(){document.body.classList.contains("fbw-audit-mode")&&(Ln(),En())}var J=null;function nr(){return J||(J=document.createElement("div"),J.className="fbw-measure-overlay",document.body.appendChild(J),J)}function st(e,o,t,n){let r=document.createElement("div");return r.className="fbw-measure-line fbw-measure-line-"+e,r.style.left=o+"px",r.style.top=t+"px",e==="h"?r.style.width=n+"px":r.style.height=n+"px",r}function lt(e,o,t,n){let r=document.createElement("div");return r.className="fbw-measure-label",r.textContent=e,r.style.left=o+"px",r.style.top=t+"px",r.style.transform=n==="h"?"translate(-50%, -130%)":"translate(8px, -50%)",r}function Mn(e){if(!a.selectedEl||!e||e===a.selectedEl)return Q();let o=a.selectedEl.getBoundingClientRect(),t=e.getBoundingClientRect();if(!o.width||!t.width)return Q();let n=nr();n.innerHTML="",n.classList.add("fbw-on");let r=document.createElement("div");r.className="fbw-measure-target",r.style.left=t.left+"px",r.style.top=t.top+"px",r.style.width=t.width+"px",r.style.height=t.height+"px",n.appendChild(r);let i=o.left+o.width/2,s=o.top+o.height/2,c=o.top-t.top,p=t.bottom-o.bottom,d=o.left-t.left,f=t.right-o.right;if(Math.abs(c)>.5){let m=Math.min(o.top,t.top);n.appendChild(st("v",i,m,Math.abs(c))),n.appendChild(lt(Math.round(c)+"px",i,(o.top+t.top)/2,"v"))}if(Math.abs(p)>.5){let m=Math.min(o.bottom,t.bottom);n.appendChild(st("v",i,m,Math.abs(p))),n.appendChild(lt(Math.round(p)+"px",i,(o.bottom+t.bottom)/2,"v"))}if(Math.abs(d)>.5){let m=Math.min(o.left,t.left);n.appendChild(st("h",m,s,Math.abs(d))),n.appendChild(lt(Math.round(d)+"px",(o.left+t.left)/2,s,"h"))}if(Math.abs(f)>.5){let m=Math.min(o.right,t.right);n.appendChild(st("h",m,s,Math.abs(f))),n.appendChild(lt(Math.round(f)+"px",(o.right+t.right)/2,s,"h"))}}function Q(){J&&(J.classList.remove("fbw-on"),J.innerHTML="")}function Fn(e){return String(e||"").replace(/```/g,"`\u200B`\u200B`")}function we(e){return String(e||"").replace(/^(#{1,6}\s|[*\-+]\s|>\s|\d+\.\s)/gm,"\\$1")}function De(){let e=k(),o=a.panel.querySelector("[data-fbw-global]").value.trim(),t=new Date().toLocaleString("zh-CN",{hour12:!1}),r="# "+(document.title||"\u9875\u9762\u53CD\u9988")+` \xB7 \u53CD\u9988
...
`,r+=`${i.content?we(i.content):"_(\u7A7A)_"}
...
`),r}function ar(){return new Promise(e=>{if(window.html2canvas)return e(!0);let o=document.createElement("script");o.src="https://cdn.jsdelivr.net/npm/html2canvas@1.4.1/dist/html2canvas.min.js",o.integrity="sha384-ZZ1pncU3bQe8y31yfZdMFdSpttDoPmOZg2wguVK9almUodir1PghgT0eY7Mrty8H",o.crossOrigin="anonymous",o.referrerPolicy="no-referrer",o.onload=()=>e(!0),o.onerror=()=>e(!1),document.head.appendChild(o)})}async function Pn(){if(b(l("shot.loading")),!await ar()){b(l("shot.loadFailed"));return}document.body.classList.add("fbw-printing"),await new Promise(t=>requestAnimationFrame(t));let o;try{o=await window.html2canvas(document.body,{useCORS:!0,allowTaint:!0,logging:!1,x:window.scrollX,y:window.scrollY,width:window.innerWidth,height:window.innerHeight,windowWidth:document.documentElement.scrollWidth,windowHeight:document.documentElement.scrollHeight,scale:window.devicePixelRatio||1})}catch(t){console.error("[fbw] screenshot failed",t),b(l("shot.failed")),document.body.classList.remove("fbw-printing");return}document.body.classList.remove("fbw-printing"),o.toBlob(t=>{if(!t){b(l("shot.failed"));return}t.name="screenshot-"+new Date().toISOString().slice(0,19).replace(/[:T]/g,"-")+".jpg",at(t)},"image/jpeg",.85)}function Re(){a.panel.classList.toggle("fbw-open");let e=a.panel.classList.contains("fbw-open");if(a.fbToggleBtn&&a.fbToggleBtn.classList.toggle("fbw-active",e),a.fbFab.classList.toggle("fbw-active",e),e&&(document.querySelectorAll("[data-fbw-edit-id]").forEach(o=>{let t=o.dataset.fbwEditId;o.classList.toggle("fbw-changed",a.originals.get(t)!==$(o))}),M(k),L(),a.currentSec)){let o=a.currentSec.dataset.fbwSecId,t=a.sectionFeedback.get(o);a.panel.querySelector("[data-fbw-saved]").classList.toggle("fbw-on",!!t)}}function An(){a.panel.querySelector("[data-fbw-close]").addEventListener("click",t=>{t.stopPropagation(),a.panel.classList.remove("fbw-open"),a.fbToggleBtn&&a.fbToggleBtn.classList.remove("fbw-active"),a.fbFab.classList.remove("fbw-active")}),a.fbFab.addEventListener("click",Re);let e=a.panel.querySelector("[data-fbw-locale]");e&&e.addEventListener("click",t=>{t.stopPropagation(),lo()});let o=a.panel.querySelector("[data-fbw-shot]");o&&o.addEventListener("click",t=>{t.stopPropagation();let n=a.panel.classList.contains("fbw-open");n&&a.panel.classList.remove("fbw-open"),Pn().finally(()=>{n&&a.panel.classList.add("fbw-open")})}),a.panel.querySelector('[data-fbw-action="copy"]').addEventListener("click",()=>{let t=De();navigator.clipboard.writeText(t).then(()=>b(l("panel.copy"))).catch(()=>{let n=document.createElement("textarea");n.value=t,document.body.appendChild(n),n.select(),document.execCommand("copy"),document.body.removeChild(n),b(l("panel.copy.fallback"))})}),a.panel.querySelector("[data-fbw-clear-all]").addEventListener("click",t=>{t.stopPropagation(),a.confirmDialog.classList.add("fbw-on")}),a.confirmDialog.querySelector("[data-fbw-confirm-cancel]").addEventListener("click",()=>{a.confirmDialog.classList.remove("fbw-on")}),a.confirmDialog.querySelector("[data-fbw-confirm-ok]").addEventListener("click",()=>{a.sectionFeedback.clear(),a.attachments.length=0,a.annotations.length=0,document.querySelectorAll(".fbw-anno").forEach(t=>t.remove()),Z(),a.panel.querySelector("[data-fbw-global]").value="",a.panel.querySelector("[data-fbw-current-text]").value="",a.panel.querySelector("[data-fbw-saved]").classList.remove("fbw-on"),document.querySelectorAll("[data-fbw-edit-id]").forEach(t=>{let n=t.dataset.fbwEditId,r=a.originals.get(n);r!==void 0&&$(t)!==r&&(t.innerText=r,t.classList.remove("fbw-changed"))}),a.elementOps.forEach((t,n)=>{delete n.dataset.fbwOpDeleted,delete n.dataset.fbwOpHidden,delete n.dataset.fbwTx,delete n.dataset.fbwTy,delete n.dataset.fbwScale,delete n.dataset.fbwRotate,delete n.dataset.fbwHighlight,n.style.transform="",n.style.backgroundImage="",n.style.backgroundColor="",n.tagName==="IMG"&&n.dataset.fbwOriginalSrc&&(n.src=n.dataset.fbwOriginalSrc,delete n.dataset.fbwOriginalSrc)}),a.elementOps.clear(),F(),wo(),M(k),a.confirmDialog.classList.remove("fbw-on"),b(l("panel.cleared"))}),window.addEventListener("beforeunload",wt)}function _e(e){a.currentSec=e;let o=a.panel.querySelector("[data-fbw-current-page]"),t=a.panel.querySelector("[data-fbw-current-text]"),n=a.panel.querySelector("[data-fbw-saved]");if(!e){o.textContent="\u2014",t.value="",t.disabled=!0,n.classList.remove("fbw-on");return}t.disabled=!1,o.textContent=e.dataset.fbwSecLabel||"Section";let r=e.dataset.fbwSecId,i=a.sectionFeedback.get(r);t.value=i?.note||"",n.classList.toggle("fbw-on",!!i)}function Nn(e){let o=a.panel.querySelector("[data-fbw-current-text]");o.addEventListener("input",n=>{if(!a.currentSec)return;let r=a.currentSec.dataset.fbwSecId,i=a.currentSec.dataset.fbwSecLabel,s=n.target.value.trim();s?(a.sectionFeedback.set(r,{label:i,note:s}),a.panel.querySelector("[data-fbw-saved]").classList.add("fbw-on")):(a.sectionFeedback.delete(r),a.panel.querySelector("[data-fbw-saved]").classList.remove("fbw-on")),M(k),L()}),["keydown","keyup","keypress"].forEach(n=>o.addEventListener(n,r=>r.stopPropagation())),a.panel.querySelector("[data-fbw-global]").addEventListener("input",L);let t=document.querySelector("deck-stage");if(t){document.addEventListener("slidechange",r=>_e(r.detail?.slide||null));let n=t.querySelector("section.slide")||e[0];n&&_e(n)}else{if(document.body.classList.add("fbw-no-overlay"),e.length){let r=new IntersectionObserver(i=>{let s=i.filter(c=>c.isIntersecting).sort((c,p)=>p.intersectionRatio-c.intersectionRatio)[0];s&&_e(s.target)},{threshold:[.3,.5,.7]});e.forEach(i=>r.observe(i)),_e(e[0])}if(e.length===1&&(e[0]===document.body||e[0].tagName==="MAIN"||e[0].tagName==="ARTICLE")){let r=e[0],i=()=>{let c=(document.title||"Page").slice(0,80);r.dataset.fbwSecLabel!==c&&(r.dataset.fbwSecLabel=c,a.currentSec===r&&_e(r))};window.addEventListener("popstate",i),["pushState","replaceState"].forEach(c=>{let p=history[c];history[c]=function(...d){let f=p.apply(this,d);return setTimeout(i,0),f}});let s=document.querySelector("title");s&&new MutationObserver(i).observe(s,{childList:!0,characterData:!0,subtree:!0})}}}function Pt(e){return{id:e.id||e.dataset.fbId||null,cssPath:rr(e),contentHash:ir(e),fbId:e.dataset.fbwEditId||null,tag:e.tagName.toLowerCase()}}function On(e){return typeof CSS<"u"&&CSS.escape?CSS.escape(e):String(e).replace(/[^\w-]/g,o=>"\\"+o)}function rr(e){let o=e.closest("[data-fbw-sec-id]")||document.body,t=[],n=e;for(;n&&n!==o&&n!==document.body;){let i=n.tagName.toLowerCase();if(n.id){t.unshift("#"+On(n.id)),n=null;break}let s=[...n.classList].filter(p=>!p.startsWith("fbw-")).slice(0,2);s.length&&(i+="."+s.map(On).join("."));let c=n.parentElement;if(c){let p=[...c.children].filter(d=>d.tagName===n.tagName);if(p.length>1){let d=p.indexOf(n)+1;i+=`:nth-of-type(${d})`}}t.unshift(i),n=c}return[o.dataset?.fbwSecId?`[data-fbw-sec-id="${o.dataset.fbwSecId}"]`:"",t.join(" > ")].filter(Boolean).join(" > ")}function ir(e){let o=(e.textContent||"").replace(/\s+/g," ").trim().slice(0,80),t=0;for(let n=0;n<o.length;n++)t=(t<<5)-t+o.charCodeAt(n),t|=0;return{sample:o.slice(0,40),hash:(t>>>0).toString(16).padStart(8,"0")}}var At="sessionsDir";function xe(){return typeof window<"u"&&typeof window.showDirectoryPicker=="function"}async function sr(e,o="readwrite"){if(!e?.queryPermission)return!1;let t={mode:o};try{if(await e.queryPermission(t)==="granted"||await e.requestPermission(t)==="granted")return!0}catch{}return!1}async function $n(){let e=await tt(At);return e&&await sr(e)?e:null}async function zn(){let e=await window.showDirectoryPicker({id:"redline-sessions",mode:"readwrite",startIn:"desktop"});return await ot(At,e),e}async function In(){await nt(At)}var lr=(()=>{let e=new Uint32Array(256);for(let o=0;o<256;o++){let t=o;for(let n=0;n<8;n++)t=t&1?3988292384^t>>>1:t>>>1;e[o]=t>>>0}return e})();function cr(e){let o=4294967295;for(let t=0;t<e.length;t++)o=lr[(o^e[t])&255]^o>>>8;return(o^4294967295)>>>0}function dr(e=new Date){let o=(e.getHours()&31)<<11|(e.getMinutes()&63)<<5|Math.floor(e.getSeconds()/2)&31,t=(e.getFullYear()-1980&127)<<9|(e.getMonth()+1&15)<<5|e.getDate()&31;return{time:o,date:t}}function S(e,o,t){e.setUint16(o,t,!0)}function D(e,o,t){e.setUint32(o,t,!0)}function Dn(e){let o=new TextEncoder,{time:t,date:n}=dr(),r=[],i=[],s=0;for(let f of e){let m=o.encode(f.name),y=f.data,h=cr(y),g=y.length,u=new ArrayBuffer(30+m.length),w=new DataView(u);D(w,0,67324752),S(w,4,20),S(w,6,2048),S(w,8,0),S(w,10,t),S(w,12,n),D(w,14,h),D(w,18,g),D(w,22,g),S(w,26,m.length),S(w,28,0),new Uint8Array(u,30).set(m),r.push(new Uint8Array(u),y);let C=new ArrayBuffer(46+m.length),x=new DataView(C);D(x,0,33639248),S(x,4,20),S(x,6,20),S(x,8,2048),S(x,10,0),S(x,12,t),S(x,14,n),D(x,16,h),D(x,20,g),D(x,24,g),S(x,28,m.length),S(x,30,0),S(x,32,0),S(x,34,0),S(x,36,0),D(x,38,0),D(x,42,s),new Uint8Array(C,46).set(m),i.push(new Uint8Array(C)),s+=30+m.length+g}let c=i.reduce((f,m)=>f+m.length,0),p=new ArrayBuffer(22),d=new DataView(p);return D(d,0,101010256),S(d,4,0),S(d,6,0),S(d,8,e.length),S(d,10,e.length),D(d,12,c),D(d,16,s),S(d,20,0),new Blob([...r,...i,new Uint8Array(p)],{type:"application/zip"})}var pr="1.0";function Rn(){let e=a.panel?.querySelector("[data-fbw-global]")?.value?.trim()||"",o=[];a.sectionFeedback.forEach((r,i)=>{o.push({secId:i,secLabel:r.label,note:r.note})});let t=[];k().forEach(r=>{let i=document.querySelector(`[data-fbw-edit-id="${r.id}"]`);i&&t.push({op:"text",selector:Pt(i),section:r.section,before:r.before,after:r.after})}),a.elementOps.forEach((r,i)=>{r.ops.forEach(s=>{t.push({op:s.op,selector:Pt(i),descriptor:r.descriptor,...s.args!==void 0?{args:s.args}:{},...s.proposed?{proposed:!0}:{}})})});let n=a.attachments.map(r=>({id:r.id,name:r.name,type:r.type,dataURL:r.dataURL}));return{schemaVersion:pr,widgetVersion:ke,appMode:a.appMode||"deck",sessionId:"fbw-sess-"+Date.now()+"-"+Math.random().toString(36).slice(2,8),capturedAt:new Date().toISOString(),capturedAtMs:Date.now(),env:{userAgent:(navigator.userAgent||"").slice(0,200),locale:navigator.language||"",viewport:{w:window.innerWidth,h:window.innerHeight,dpr:window.devicePixelRatio||1},timezone:Intl.DateTimeFormat().resolvedOptions().timeZone},page:{url:location.href,title:document.title||null,pathname:location.pathname},source:{hint:location.pathname.replace(/^.*\//,""),matchBy:"pathname"},feedback:{global:e||null,perSection:o},edits:t,annotations:a.annotations.map(r=>{let i=r.type||"region",s={id:r.id,type:i,secId:r.secId,secLabel:r.secLabel,rectPct:r.rectPct};return i==="floating"?{...s,content:r.content||""}:{...s,content:r.content||"",note:r.note||r.text||"",image:r.image?{name:r.image.name,type:r.image.type,dataURL:r.image.dataURL}:null}}),attachments:n}}function fr(e){return(e||"session").replace(/[\\/:*?"<>|\s]+/g,"_").replace(/_+/g,"_").slice(0,80)}function br(){let e=new Date,o=t=>String(t).padStart(2,"0");return`${e.getFullYear()}-${o(e.getMonth()+1)}-${o(e.getDate())}-${o(e.getHours())}${o(e.getMinutes())}${o(e.getSeconds())}`}function _n(e){return fr(e||document.title)+"-"+br()}async function ct(e,o,t){let r=await(await e.getFileHandle(o,{create:!0})).createWritable();await r.write(t),await r.close()}async function dt(e){return(await fetch(e)).blob()}function pt(e){if(!e)return"png";let o=e.split("/")[1]||"png";return o==="jpeg"?"jpg":o.replace(/[^a-z0-9]/gi,"")}async function qn(e,o){if(!xe())return{ok:!1,fallback:"download",reason:"no-fs-access"};let t=await $n(),n=!1;if(!t)try{t=await zn(),n=!0}catch(r){return{ok:!1,fallback:"download",reason:"picker-cancelled",error:r?.message}}try{let r=[];if(Array.isArray(e.annotations)){for(let c of e.annotations)if(c.image?.dataURL){let p=(c.id||"").split("-").pop().slice(0,8)||Math.random().toString(36).slice(2,10),d=`${o}-anno-${p}.${pt(c.image.type)}`,f=await dt(c.image.dataURL);await ct(t,d,f),r.push(d),c.image={name:c.image.name,type:c.image.type,filename:d}}}if(Array.isArray(e.attachments))for(let c=0;c<e.attachments.length;c++){let p=e.attachments[c];if(p.dataURL){let d=`${o}-att-${String(c+1).padStart(2,"0")}.${pt(p.type)}`,f=await dt(p.dataURL);await ct(t,d,f),r.push(d),e.attachments[c]={id:p.id,name:p.name,type:p.type,filename:d}}}let i=o+".json",s=o+".md";return await ct(t,i,JSON.stringify(e,null,2)),await ct(t,s,De()),{ok:!0,dirName:t.name,jsonName:i,mdName:s,firstPick:n,imageFiles:r}}catch(r){return{ok:!1,fallback:"download",reason:"write-failed",error:r?.message}}}function Hn(e,o){let t=new Blob([JSON.stringify(e,null,2)],{type:"application/json"});Bn(t,o+".json")}function Bn(e,o){let t=URL.createObjectURL(e),n=document.createElement("a");n.href=t,n.download=o,n.click(),URL.revokeObjectURL(t)}async function Nt(e,o){let t=new TextEncoder,n=[];if(Array.isArray(e.annotations)){for(let i of e.annotations)if(i.image?.dataURL){let s=(i.id||"").split("-").pop().slice(0,8)||Math.random().toString(36).slice(2,10),c=`${o}-anno-${s}.${pt(i.image.type)}`,p=new Uint8Array(await(await dt(i.image.dataURL)).arrayBuffer());n.push({name:c,data:p}),i.image={name:i.image.name,type:i.image.type,filename:c}}}if(Array.isArray(e.attachments))for(let i=0;i<e.attachments.length;i++){let s=e.attachments[i];if(s.dataURL){let c=`${o}-att-${String(i+1).padStart(2,"0")}.${pt(s.type)}`,p=new Uint8Array(await(await dt(s.dataURL)).arrayBuffer());n.push({name:c,data:p}),e.attachments[i]={id:s.id,name:s.name,type:s.type,filename:c}}}n.unshift({name:`${o}.json`,data:t.encode(JSON.stringify(e,null,2))},{name:`${o}.md`,data:t.encode(De())});let r=Dn(n);return Bn(r,o+".zip"),{ok:!0,fileCount:n.length}}async function ur(){try{return typeof chrome>"u"||!chrome.storage?.sync?null:(await chrome.storage.sync.get({saveMode:"zip"})).saveMode}catch{return null}}function jn(){let e=a.panel.querySelector('[data-fbw-action="save"]');e&&(e.addEventListener("click",async()=>{let o=Rn(),t=_n();if(await ur()!=="fs"||!xe()){e.disabled=!0;try{await Nt(o,t),b(l("save.unsupported",{stem:t+".zip"}))}catch(i){Hn(o,t),b(l("save.failed",{reason:i?.message||"zip-failed"}))}finally{e.disabled=!1}return}e.disabled=!0;try{let i=await qn(o,t);if(i.ok){let s=(i.imageFiles||[]).length,c=`/{json, md${s>0?` + ${s} imgs`:""}}`;b(l(i.firstPick?"save.first":"save.again",{dir:i.dirName,suffix:c}))}else i.reason==="picker-cancelled"?b(l("save.cancelled")):(await Nt(o,t),b(l("save.failed",{reason:i.reason||"unknown"})))}finally{e.disabled=!1}}),e.addEventListener("contextmenu",async o=>{o.preventDefault(),await In(),b(l("save.dirCleared"))}))}var Un={html2canvas:{src:"https://cdn.jsdelivr.net/npm/html2canvas@1.4.1/dist/html2canvas.min.js",integrity:"sha384-ZZ1pncU3bQe8y31yfZdMFdSpttDoPmOZg2wguVK9almUodir1PghgT0eY7Mrty8H"},jspdf:{src:"https://cdn.jsdelivr.net/npm/jspdf@2.5.1/dist/jspdf.umd.min.js",integrity:"sha384-JcnsjUPPylna1s1fvi1u12X5qjY5OL56iySh75FdtrwhO/SWXgMjoVqcKyIIWOLk"}};function Yn({src:e,integrity:o}){return new Promise(t=>{let n=document.createElement("script");n.src=e,n.integrity=o,n.crossOrigin="anonymous",n.referrerPolicy="no-referrer",n.onload=()=>t(!0),n.onerror=()=>t(!1),document.head.appendChild(n)})}function mr(){let e=[];return window.html2canvas||e.push(Yn(Un.html2canvas)),window.jspdf||e.push(Yn(Un.jspdf)),e.length?Promise.all(e).then(o=>o.every(Boolean)&&!!window.html2canvas&&!!window.jspdf):Promise.resolve(!0)}function ye(e,o){if(e=e||{},a.panel.classList.remove("fbw-open"),a.fbToggleBtn&&a.fbToggleBtn.classList.remove("fbw-active"),a.fbFab.classList.remove("fbw-active"),o)try{o()}catch{}if(e.image)return gr();document.body.classList.add("fbw-printing"),b(l("pdf.vector.hint")),setTimeout(()=>{try{window.print()}catch(t){console.error(t)}setTimeout(()=>document.body.classList.remove("fbw-printing"),2e3)},250)}async function gr(){if(b(l("pdf.loading")),!await mr()){b(l("pdf.loadFailed"));return}let o=document.querySelector("deck-stage"),t=o&&parseInt(o.getAttribute("width"),10)||1920,n=o&&parseInt(o.getAttribute("height"),10)||1080,r=[...document.querySelectorAll("section.slide")];if(!r.length)return hr();let i=r.map(g=>g.hasAttribute("data-deck-active"));document.body.classList.add("fbw-printing");let s=null,c="";try{s=o&&o.shadowRoot&&o.shadowRoot.querySelector(".canvas")}catch{}s&&(c=s.style.transform||"",s.style.transform="none");let{jsPDF:p}=window.jspdf,d=t>n?"landscape":"portrait",f=new p({unit:"px",format:[t,n],orientation:d,hotfixes:["px_scaling"]}),m="http://www.w3.org/2000/svg",y=new Map;document.querySelectorAll("symbol[id]").forEach(g=>y.set(g.id,g));let h=[];r.forEach(g=>{g.querySelectorAll("use").forEach(u=>{let C=(u.getAttribute("href")||u.getAttribute("xlink:href")||"").replace(/^#/,""),x=y.get(C);if(!x)return;let E=u.ownerSVGElement,W=x.getAttribute("viewBox"),ve=!1;E&&!E.getAttribute("viewBox")&&W&&(E.setAttribute("viewBox",W),ve=!0);let qe=document.createElementNS(m,"g");[...x.childNodes].forEach(He=>qe.appendChild(He.cloneNode(!0))),["transform","fill","stroke","class","opacity","style"].forEach(He=>{let Dt=u.getAttribute(He);Dt&&qe.setAttribute(He,Dt)});let Qn=u;u.parentNode.insertBefore(qe,u),u.parentNode.removeChild(u),h.push({g:qe,original:Qn,parentSvg:E,vbAdded:ve})})}),b(l("pdf.progress",{i:0,total:r.length}));try{for(let u=0;u<r.length;u++){r.forEach((E,W)=>{W===u?E.setAttribute("data-deck-active",""):E.removeAttribute("data-deck-active")}),await new Promise(E=>requestAnimationFrame(()=>requestAnimationFrame(E)));try{await document.fonts.ready}catch{}b(l("pdf.progress",{i:u+1,total:r.length}));let w={width:t,height:n,windowWidth:t,windowHeight:n,scale:2,useCORS:!0,allowTaint:!0,backgroundColor:"#ffffff",logging:!1},C;try{C=await window.html2canvas(r[u],{...w,foreignObjectRendering:!0})}catch(E){console.warn("foreignObject mode failed, fallback to JS render:",E),C=await window.html2canvas(r[u],w)}let x=C.toDataURL("image/jpeg",.92);u>0&&f.addPage([t,n],d),f.addImage(x,"JPEG",0,0,t,n,void 0,"FAST")}let g=(document.title||"deck").replace(/[\\/:*?"<>|]/g,"_")+"-image.pdf";f.save(g),b(l("pdf.saved",{file:g}))}catch(g){console.error(g),b(l("pdf.failed",{reason:g.message||g}))}finally{h.forEach(g=>{try{g.g.parentNode.insertBefore(g.original,g.g),g.g.parentNode.removeChild(g.g),g.vbAdded&&g.parentSvg&&g.parentSvg.removeAttribute("viewBox")}catch{}}),s&&(s.style.transform=c),r.forEach((g,u)=>{i[u]?g.setAttribute("data-deck-active",""):g.removeAttribute("data-deck-active")}),document.body.classList.remove("fbw-printing")}}async function hr(){document.body.classList.add("fbw-printing"),await new Promise(r=>requestAnimationFrame(()=>requestAnimationFrame(r)));try{await document.fonts.ready}catch{}let e=document.documentElement,o=Math.max(e.scrollWidth,document.body.scrollWidth),t=Math.max(e.scrollHeight,document.body.scrollHeight);b(l("pdf.progress",{i:0,total:1}));let n;try{n=await window.html2canvas(document.body,{useCORS:!0,allowTaint:!0,logging:!1,backgroundColor:"#ffffff",scale:2,x:0,y:0,width:o,height:t,windowWidth:o,windowHeight:t})}catch(r){console.error(r),b(l("pdf.failed",{reason:r.message||r})),document.body.classList.remove("fbw-printing");return}try{let{jsPDF:r}=window.jspdf,i=14400,s=(document.title||"page").replace(/[\\/:*?"<>|]/g,"_")+"-long.pdf";if(t<=i){let c=new r({unit:"px",format:[o,t],orientation:"portrait",hotfixes:["px_scaling"]}),p=n.toDataURL("image/jpeg",.9);c.addImage(p,"JPEG",0,0,o,t,void 0,"FAST"),c.save(s)}else{let c=i,p=n.width/o,d=Math.floor(c*p),f=Math.ceil(n.height/d),m=new r({unit:"px",format:[o,c],orientation:"portrait",hotfixes:["px_scaling"]});for(let y=0;y<f;y++){b(l("pdf.progress",{i:y+1,total:f}));let h=y*d,g=Math.min(d,n.height-h),u=document.createElement("canvas");u.width=n.width,u.height=g;let w=u.getContext("2d");w.fillStyle="#ffffff",w.fillRect(0,0,u.width,u.height),w.drawImage(n,0,h,n.width,g,0,0,n.width,g);let C=u.toDataURL("image/jpeg",.9);y>0&&m.addPage([o,c],"portrait"),m.addImage(C,"JPEG",0,0,o,g/p,void 0,"FAST"),await new Promise(x=>setTimeout(x,0))}m.save(s)}b(l("pdf.saved",{file:s}))}catch(r){console.error(r),b(l("pdf.failed",{reason:r.message||r}))}finally{document.body.classList.remove("fbw-printing")}}var Ot="sourceDir";async function wr(e,o="readwrite"){if(!e?.queryPermission)return!1;let t={mode:o};try{if(await e.queryPermission(t)==="granted"||await e.requestPermission(t)==="granted")return!0}catch{}return!1}async function xr(){let e=await tt(Ot);return e&&await wr(e)?e:null}async function yr(){let e=await window.showDirectoryPicker({id:"redline-source",mode:"readwrite",startIn:"desktop"});return await ot(Ot,e),e}async function Wn(){await nt(Ot)}async function vr(e){let o=decodeURIComponent(location.pathname.split("/").pop()||"");if(o)try{return await e.getFileHandle(o)}catch{}let t=window.prompt(`\u5728\u9009\u5B9A\u76EE\u5F55\u4E0B\u627E\u4E0D\u5230 "${o}"
\u6E90 HTML \u6587\u4EF6\u540D\uFF08\u542B .html\uFF09`,o);if(!t)return null;try{return await e.getFileHandle(t)}catch{return null}}function kr(e){let o=[];/\{\{[\s\S]+?\}\}|<%[\s\S]+?%>|<\?php|\{%[\s\S]+?%\}/.test(e)&&o.push("\u6A21\u677F\u8BED\u6CD5 (Mustache/EJS/PHP/Jinja)"),/__webpack_|window\.webpackChunk|window\.__NEXT_DATA__|window\.__remixContext/.test(e)&&o.push("build \u4EA7\u7269");let t=(e.match(/<link[^>]+rel=["']stylesheet/gi)||[]).length;return t>2&&o.push(`${t} \u4E2A\u5916\u90E8 stylesheet`),/<script[^>]+type=["']module["'][^>]*src=/i.test(e)&&o.push("JS module \u5F15\u7528"),o}function Sr(e){let o=0,t=0,n=[];return document.querySelectorAll("[data-fbw-edit-id]").forEach(r=>{let i=r.dataset.fbwEditId,s=a.originals.get(i),c=$(r);if(s===c)return;let p=Ie(r);if(!p){t++,n.push({kind:"text",desc:s.slice(0,30),reason:"no-path"});return}let d=Ft(e,p,R);if(!d.ok){t++,n.push({kind:"text",desc:s.slice(0,30),reason:d.reason});return}if(d.contentMismatch){t++,n.push({kind:"text",desc:s.slice(0,30),reason:"content-drift"});return}d.el.textContent=c,o++}),a.elementOps.forEach((r,i)=>{let s=Ie(i);if(!s){t+=r.ops.length,n.push({kind:"op",desc:r.descriptor,reason:"no-path"});return}let c=Ft(e,s,R);if(!c.ok){t+=r.ops.length,n.push({kind:"op",desc:r.descriptor,reason:c.reason});return}let p=c.el;r.ops.forEach(d=>{try{if(d.op==="note")return;if(d.op==="delete")p.remove();else if(d.op==="hide")p.style.visibility="hidden";else if(d.op==="move"){let f=(p.style.transform||"").replace(/translate\([^)]+\)/g,"").trim();p.style.transform=(f+` translate(${d.args.x}px, ${d.args.y}px)`).trim()}else if(d.op==="scale"){let f=(p.style.transform||"").replace(/scale\([^)]+\)/g,"").trim();p.style.transform=(f+` scale(${d.args.scale})`).trim()}else if(d.op==="rotate"){let f=(p.style.transform||"").replace(/rotate\([^)]+\)/g,"").trim();p.style.transform=(f+` rotate(${d.args.rotate}deg)`).trim()}else if(d.op==="font")p.style.fontFamily=d.args.family==="\u7CFB\u7EDF\u9ED8\u8BA4"?"":d.args.family;else if(d.op==="highlight")p.style.backgroundColor=d.args?.color||"";else{t++,n.push({kind:"op",desc:r.descriptor,op:d.op,reason:"unsupported"});return}o++}catch(f){t++,n.push({kind:"op",desc:r.descriptor,op:d.op,reason:f.message})}})}),["fbwEditId","fbwSecId","fbwSecLabel","fbwTx","fbwTy","fbwScale","fbwRotate","fbwOriginalSrc","fbwFontName","fbwHighlight","fbwOpDeleted","fbwOpHidden"].forEach(r=>{let i="[data-"+r.replace(/[A-Z]/g,s=>"-"+s.toLowerCase())+"]";e.querySelectorAll(i).forEach(s=>delete s.dataset[r])}),e.querySelectorAll(".fbw-changed, .fbw-selected").forEach(r=>{r.classList.remove("fbw-changed"),r.classList.remove("fbw-selected")}),{applied:o,failed:t,failures:n}}function Er(){let e=new Date,o=t=>String(t).padStart(2,"0");return`${e.getFullYear()}${o(e.getMonth()+1)}${o(e.getDate())}-${o(e.getHours())}${o(e.getMinutes())}${o(e.getSeconds())}`}async function Lr(e,o,t){let r=`${o.replace(/\.html?$/i,"")}.bak.${Er()}.html`,s=await(await e.getFileHandle(r,{create:!0})).createWritable();return await s.write(t),await s.close(),r}async function Kn(){if(!xe())return b(l("patch.unsupported")),{ok:!1,reason:"no-fs-access"};if(location.protocol!=="file:")return b(l("patch.notFile")),{ok:!1,reason:"not-file-protocol"};let e=await xr();if(!e)try{e=await yr()}catch{return b(l("patch.cancelled")),{ok:!1,reason:"picker-cancelled"}}let o=await vr(e);if(!o)return b(l("patch.fileNotFound")),{ok:!1,reason:"file-not-found"};let t=await o.getFile(),n=await t.text(),r=kr(n);if(r.length&&await mt({title:l("warn.complex.title"),desc:l("warn.complex.desc",{flags:r.join(`
\xB7 `)}),choices:[{label:l("common.cancel"),value:"cancel"},{label:l("warn.complex.continue"),value:"continue",danger:!0}]})!=="continue")return b(l("patch.cancelled")),{ok:!1,reason:"user-cancelled-warning"};let i=new DOMParser().parseFromString(n,"text/html"),{applied:s,failed:c,failures:p}=Sr(i);if(s===0)return b(c===0?l("patch.noChanges"):l("patch.partialFail",{failed:c})),p.length&&console.warn("[fbw] failures:",p),{ok:!1,applied:s,failed:c,failures:p};let d="";try{d=await Lr(e,t.name,n)}catch(g){if(await mt({title:l("patch.backupFail.title"),desc:l("patch.backupFail.desc",{reason:g.message}),choices:[{label:l("common.cancel"),value:"cancel"},{label:l("warn.complex.continue"),value:"continue",danger:!0}]})!=="continue")return b(l("patch.cancelled")),{ok:!1,reason:"backup-failed-user-cancelled"}}let f=`<!DOCTYPE html>
`+i.documentElement.outerHTML,m=await o.createWritable();await m.write(f),await m.close();let y=c>0?` / ${c} failed`:"",h=d?` \xB7 backup ${d}`:"";return b(l("patch.success",{file:t.name,applied:s,failedSuffix:y,backupSuffix:h})),p.length&&console.warn("[fbw] failures:",p),{ok:!0,applied:s,failed:c,failures:p,backupName:d,fileName:t.name}}function ft(){let e=document.querySelector("deck-stage");if(!e||!e.shadowRoot){setTimeout(ft,80);return}let o=e.shadowRoot.querySelector(".overlay");if(!o){setTimeout(ft,80);return}if(o.querySelector("[data-fbw-btn]"))return;let t=o.querySelector(".reset"),n=document.createElement("span");n.className="divider";let r=document.createElement("button");r.className="btn",r.dataset.fbwBtn="edit",r.type="button",r.dataset.tooltip=l("overlay.edit"),r.setAttribute("aria-label",l("overlay.edit")),r.innerHTML=Be.replace('viewBox="0 0 24 24"','viewBox="0 0 24 24" width="14" height="14"'),r.addEventListener("click",u=>{u.stopPropagation(),he()});let i=document.createElement("button");i.className="btn",i.dataset.fbwBtn="save-edit",i.type="button",i.dataset.tooltip=l("overlay.save"),i.setAttribute("aria-label",l("overlay.save")),i.innerHTML=Bt.replace('viewBox="0 0 24 24"','viewBox="0 0 24 24" width="14" height="14"')+'<span class="fbw-edit-count">0</span>',i.addEventListener("click",u=>{u.stopPropagation(),Kn()}),i.addEventListener("contextmenu",async u=>{u.preventDefault(),u.stopPropagation(),await Wn(),b(l("patch.dirCleared"))}),a.saveEditBtn=i;let s=document.createElement("span");s.className="divider";let c=document.createElement("button");c.className="btn",c.dataset.fbwBtn="feedback",c.type="button",c.dataset.tooltip=l("overlay.feedback"),c.setAttribute("aria-label",l("overlay.feedback")),c.innerHTML=K.replace('viewBox="0 0 24 24"','viewBox="0 0 24 24" width="14" height="14"'),c.addEventListener("click",u=>{u.stopPropagation(),Re()});let p=document.createElement("span");p.className="divider";let d=document.createElement("button");d.className="btn",d.dataset.fbwBtn="marquee",d.type="button",d.dataset.tooltip=l("overlay.marquee"),d.setAttribute("aria-label",l("overlay.marquee")),d.innerHTML=Ue.replace('viewBox="0 0 24 24"','viewBox="0 0 24 24" width="14" height="14"'),d.addEventListener("click",u=>{u.stopPropagation(),ue()}),a.marqueeToggleBtn=d;let f=document.createElement("span");f.className="divider";let m=document.createElement("button");m.className="btn",m.dataset.fbwBtn="export",m.type="button",m.dataset.tooltip=l("overlay.export"),m.setAttribute("aria-label",l("overlay.export")),m.innerHTML=Ye.replace('viewBox="0 0 24 24"','viewBox="0 0 24 24" width="14" height="14"'),m.addEventListener("click",u=>{u.stopPropagation(),ye({image:u.shiftKey},F)});let y=document.createElement("span");y.className="divider";let h=document.createElement("button");h.className="btn",h.dataset.fbwBtn="help",h.type="button",h.dataset.tooltip=l("overlay.help"),h.setAttribute("aria-label",l("overlay.help")),h.innerHTML=je.replace('viewBox="0 0 24 24"','viewBox="0 0 24 24" width="14" height="14"'),h.addEventListener("click",u=>{u.stopPropagation(),Fe(h)}),a.helpToggleBtn=h,t?t.after(n,r,i,s,c,p,d,f,m,y,h):o.append(n,r,i,s,c,p,d,f,m,y,h),a.editToggleBtn=r,a.fbToggleBtn=c;let g=document.createElement("style");g.textContent=`
    .btn[data-fbw-btn].fbw-active {
      color: #dc3c3c !important;
    }
  `,e.shadowRoot.appendChild(g),document.body.classList.remove("fbw-no-overlay")}function Cr(){let e=document.createElement("style");e.id="fbw-styles",e.dataset.fbwInternal="1",e.textContent=_t,document.head.appendChild(e)}function Tr(){let e=document.createElement("div");e.className="fbw-panel",e.id="fbwPanel",e.innerHTML=Fo(),a.panel=e;let o=document.createElement("div");o.className="fbw-confirm",o.innerHTML=Po(),a.confirmDialog=o;let t=document.createElement("button");t.className="fbw-fab fbw-edit-fab",t.innerHTML=Be,t.dataset.tooltip=l("overlay.edit"),t.setAttribute("aria-label",l("overlay.edit")),a.editFab=t;let n=document.createElement("button");n.className="fbw-fab fbw-fb-fab",n.innerHTML=K,n.dataset.tooltip=l("overlay.feedback"),n.setAttribute("aria-label",l("overlay.feedback")),a.fbFab=n;let r=document.createElement("button");r.className="fbw-fab fbw-marquee-fab",r.innerHTML=Ue,r.dataset.tooltip=l("overlay.marquee"),r.setAttribute("aria-label",l("overlay.marquee")),a.marqueeFab=r;let i=document.createElement("button");i.className="fbw-fab fbw-undo-fab",i.innerHTML=ao,i.dataset.tooltip=l("overlay.undo"),i.setAttribute("aria-label",l("overlay.undo")),i.style.display="none",a.undoFab=i;let s=document.createElement("button");s.className="fbw-fab fbw-redo-fab",s.innerHTML=ro,s.dataset.tooltip=l("overlay.redo"),s.setAttribute("aria-label",l("overlay.redo")),s.style.display="none",a.redoFab=s;let c=document.createElement("button");c.className="fbw-fab fbw-export-fab",c.innerHTML=Ye,c.dataset.tooltip=l("overlay.export"),c.setAttribute("aria-label",l("overlay.export")),a.exportFab=c;let p=document.createElement("button");p.className="fbw-fab fbw-help-fab",p.innerHTML=je,p.dataset.tooltip=l("overlay.help"),p.setAttribute("aria-label",l("overlay.help")),a.helpFab=p;let d=document.createElement("button");d.className="fbw-fab fbw-fold-fab",d.innerHTML=Yt,d.dataset.tooltip=l("overlay.fold"),d.setAttribute("aria-label",l("overlay.fold")),a.foldFab=d;let f=document.createElement("div");f.className="fbw-help-popover",a.helpPopover=f;let m=document.createElement("div");m.className="fbw-elem-toolbar",m.innerHTML=Ao(),a.elemToolbar=m;let y=document.createElement("div");y.className="fbw-font-picker",a.fontPicker=y;let h=document.createElement("div");h.className="fbw-note-popover",h.innerHTML=No(),a.notePopover=h;let g=document.createElement("div");g.className="fbw-marker-popover",a.markerPopover=g,a.resizeHandles=Uo();let u=Qo();a.tagPopover=u;let w=document.createElement("div");w.className="fbw-fab-bar",w.appendChild(t),w.appendChild(n),w.appendChild(r),w.appendChild(c),w.appendChild(i),w.appendChild(s);let C=document.createElement("span");C.className="fbw-fab-divider",w.appendChild(C),w.appendChild(p);let x=document.createElement("span");x.className="fbw-fab-divider fbw-fab-divider-2",w.appendChild(x),w.appendChild(d),a.fabBar=w,document.body.appendChild(e),document.body.appendChild(o),document.body.appendChild(w),document.body.appendChild(f),document.body.appendChild(m),document.body.appendChild(y),document.body.appendChild(h),document.body.appendChild(g),document.body.appendChild(u),document.body.appendChild(a.resizeHandles)}function Mr(){let e=!1,o=t=>t.target.dataset?.fbwEditId||t.target.matches&&t.target.matches("textarea, input")||t.target.closest&&t.target.closest(".fbw-panel, .fbw-confirm");document.addEventListener("keydown",t=>{if(!o(t)){if(t.key===" "){e=!0;return}if(e&&(t.key==="p"||t.key==="P")&&!t.shiftKey){t.preventDefault(),ye({image:!1},F);return}if(t.shiftKey&&(t.key==="P"||t.key==="p")){t.preventDefault(),ye({image:!0},F);return}if((t.metaKey||t.ctrlKey)&&!t.shiftKey&&(t.key==="s"||t.key==="S")){t.preventDefault(),a.panel?.querySelector('[data-fbw-action="save"]')?.click();return}if((t.metaKey||t.ctrlKey)&&!t.shiftKey&&(t.key==="z"||t.key==="Z")){t.preventDefault(),Pe();return}if((t.metaKey||t.ctrlKey)&&t.shiftKey&&(t.key==="z"||t.key==="Z")||(t.metaKey||t.ctrlKey)&&!t.shiftKey&&(t.key==="y"||t.key==="Y")){t.preventDefault(),kt();return}if((t.metaKey||t.ctrlKey)&&!t.shiftKey&&(t.key==="c"||t.key==="C")){if(window.getSelection?.()?.toString()||!a.selectedEl)return;t.preventDefault(),Sn();return}if((t.metaKey||t.ctrlKey)&&!t.shiftKey&&(t.key==="m"||t.key==="M")){t.preventDefault(),a.panel?.querySelector('[data-fbw-action="copy"]')?.click();return}t.ctrlKey||t.metaKey||t.altKey||e||(t.key==="e"||t.key==="E"?(t.preventDefault(),he()):t.key==="f"||t.key==="F"?(t.preventDefault(),Re()):t.key==="m"||t.key==="M"?(t.preventDefault(),ue()):t.key==="a"||t.key==="A"?(t.preventDefault(),Cn()):t.key==="?"?(t.preventDefault(),Fe()):(t.key==="Delete"||t.key==="Backspace")&&a.selectedEl&&a.editMode&&(t.preventDefault(),a.elemToolbar?.querySelector('[data-op="delete"]')?.click()))}}),document.addEventListener("keyup",t=>{t.key===" "&&(e=!1),t.key==="Alt"&&(document.body.classList.remove("fbw-measuring"),Q())}),window.addEventListener("blur",()=>{e=!1,document.body.classList.remove("fbw-measuring"),Q()}),document.addEventListener("mousemove",t=>{if(!t.altKey||!a.selectedEl){document.body.classList.contains("fbw-measuring")&&(document.body.classList.remove("fbw-measuring"),Q());return}document.body.classList.add("fbw-measuring");let n=t.target;if(!n||n.closest(".fbw-panel, .fbw-fab, .fbw-fab-bar, .fbw-elem-toolbar, .fbw-confirm, .fbw-toast, .fbw-tooltip, .fbw-anno, .fbw-resize-handles, .fbw-measure-overlay, .fbw-help-popover, .fbw-note-popover, .fbw-marker-popover, .fbw-font-picker, .fbw-tag-popover")){Q();return}if(n===a.selectedEl||a.selectedEl.contains(n)){Q();return}Mn(n)},!0)}function $t(){a.undoFab&&(a.undoFab.style.display=Do()?"inline-flex":"none"),a.redoFab&&(a.redoFab.style.display=Ro()?"inline-flex":"none")}function Fr(){a.editFab.addEventListener("click",()=>{if(document.body.classList.contains("fbw-fab-collapsed")){Gn(!1),a.editMode||he();return}he()}),a.exportFab.addEventListener("click",e=>ye({image:e.shiftKey},F)),a.marqueeFab.addEventListener("click",ue),a.undoFab.addEventListener("click",e=>{e.stopPropagation(),Pe(),$t()}),a.redoFab.addEventListener("click",e=>{e.stopPropagation(),kt(),$t()}),a.helpFab.addEventListener("click",e=>{e.stopPropagation(),Fe()}),a.foldFab.addEventListener("click",e=>{e.stopPropagation(),Gn(!0)})}var zt="fbw-fab-collapsed::"+(location.pathname||"/").slice(0,200);function Gn(e){document.body.classList.toggle("fbw-fab-collapsed",e);try{e?localStorage.setItem(zt,"1"):localStorage.removeItem(zt)}catch{}}function Pr(){try{localStorage.getItem(zt)==="1"&&document.body.classList.add("fbw-fab-collapsed")}catch{}}function Ar(){let e=null;ie(()=>{document.body.classList.add("fbw-scrolling"),e&&clearTimeout(e),e=setTimeout(()=>{document.body.classList.remove("fbw-scrolling")},800)});let o=220,t=260,n=-1,r=-1,i=0;window.addEventListener("mousemove",s=>{n=s.clientX,r=s.clientY,!i&&(i=requestAnimationFrame(()=>{i=0;let c=window.innerWidth-n<o&&window.innerHeight-r<t;document.body.classList.toggle("fbw-mouse-near-fab",c)}))},{passive:!0})}var Xn=null;function Vn(){if(!a.fabBar)return;let e=a.fabBar.getBoundingClientRect(),o=e.left+e.width/2,t=e.top+e.height/2,n=a.fabBar.style.pointerEvents;a.fabBar.style.pointerEvents="none";let r=document.elementFromPoint(o,t)||document.body;a.fabBar.style.pointerEvents=n,r.closest&&r.closest(".fbw-panel, .fbw-tooltip, .fbw-toast, .fbw-confirm, .fbw-elem-toolbar, .fbw-resize-handles, .fbw-note-popover, .fbw-font-picker, .fbw-marker-popover, .fbw-help-popover, .fbw-anno")&&(r=document.body);let i=null,s=r;for(;s&&s!==document.documentElement;){let d=window.getComputedStyle(s).backgroundColor,f=d&&d.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)(?:,\s*([\d.]+))?\)/);if(f&&(f[4]!==void 0?parseFloat(f[4]):1)>.5){i={r:+f[1],g:+f[2],b:+f[3]};break}s=s.parentElement}if(!i){let f=window.getComputedStyle(document.documentElement).backgroundColor.match(/\d+/g);i=f?{r:+f[0],g:+f[1],b:+f[2]}:{r:255,g:255,b:255}}let p=.299*i.r+.587*i.g+.114*i.b<140;Xn!==p&&(Xn=p,document.body.classList.toggle("fbw-dark-bg",p))}function Nr(){let e=null,o=()=>{e&&clearTimeout(e),e=setTimeout(Vn,250)};setTimeout(Vn,80),ie(o),te(o)}function Zn(){return document.querySelector("deck-stage")?"deck":document.querySelectorAll(R).length>0?"doc":"review"}function Jn(){let e=a.panel?.querySelector(".fbw-mode-chip");e&&(e.textContent=l("mode.chip."+(a.appMode||"doc")))}function Or(){let e=()=>{let o=Zn();o!==a.appMode&&(document.body.classList.remove("fbw-mode-"+a.appMode),document.body.classList.add("fbw-mode-"+o),ee("appMode changed:",a.appMode,"\u2192",o),a.appMode=o,Jn())};window.addEventListener("popstate",e),["pushState","replaceState"].forEach(o=>{let t=history[o];t.__fbwPatched||(history[o]=function(...n){let r=t.apply(this,n);return setTimeout(e,0),r},history[o].__fbwPatched=!0)})}function It(){ee("init start"),Cr(),Tr(),a.appMode=Zn(),document.body.classList.add("fbw-mode-"+a.appMode),ee("appMode:",a.appMode),Jn(),Or();let e=uo();kn(),un(),mn(),Go(),So(),Ho(),Zo(),tn(),bn(),An(),jn(),Nn(e),fn(),Mr(),a.onChangeHook=()=>{Tn(),$t()},Fr(),Ar(),Nr(),Lo(),Mo(),Pr(),document.querySelector("deck-stage")?ft():document.body.classList.add("fbw-no-overlay"),ho(),Z(),yt(),M(k),pn().catch(o=>ee("rehydrate failed:",o)),ee("init done")}(function(){typeof window>"u"||window.__feedbackWidgetLoaded||(window.__feedbackWidgetLoaded=!0,window.__feedbackWidgetVersion=ke,ee(`redline v${ke} loaded \xB7 \u5173\u95ED\u65E5\u5FD7: window.__fbwDebug = false`),document.readyState==="loading"?document.addEventListener("DOMContentLoaded",It):It())})();})();
