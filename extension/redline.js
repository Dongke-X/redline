...
Click edit FAB to expand`,"help.title":"Shortcuts","help.group.modes":"Modes","help.group.actions":"Actions","help.group.selection":"Selection","help.group.history":"Feedback / History","help.group.view":"View","help.group.pointer":"Pointer","help.group.export":"Export","help.group.misc":"More","keys.hover":"hover","keys.click":"click","keys.drag":"drag","help.shortcut.edit":"Edit mode","help.shortcut.feedback":"Feedback panel","help.shortcut.marquee":"Marquee annotate","help.shortcut.cancel":"Cancel selection","help.shortcut.delete":"Delete selected element","help.shortcut.save":"Save feedback","help.shortcut.copy":"Copy feedback","help.shortcut.undo":"Undo","help.shortcut.redo":"Redo","help.shortcut.copyDescriptor":"Copy descriptor","help.shortcut.multiSelect":"Toggle multi-select","help.shortcut.rubberBand":"Rubber-band select","help.shortcut.audit":"Audit","help.shortcut.measure":"Measure","help.shortcut.pdfVector":"Vector PDF","help.shortcut.pdfImage":"Long-image PDF","help.shortcut.htmlEditable":"Editable HTML","help.shortcut.htmlReadonly":"Read-only HTML","help.shortcut.help":"Show help"}},No="fbw-locale",Pt=null;function _a(){try{let e=localStorage.getItem(No);return e&&ke[e]?e:null}catch{return null}}function Da(){if(typeof window<"u"&&window.__fbwLocale&&ke[window.__fbwLocale])return window.__fbwLocale;let e=_a();return e||((typeof navigator<"u"&&navigator.language||"en").toLowerCase().startsWith("zh")?"zh":"en")}function it(){return Pt||(Pt=Da()),Pt}function Oo(){let o=it()==="zh"?"en":"zh";try{localStorage.setItem(No,o)}catch{}typeof location<"u"&&location.reload()}function l(e,o){let t=it(),a=(ke[t]||ke.en)[e];return a===void 0&&(a=ke.en&&ke.en[e]||e),o&&Object.keys(o).forEach(i=>{a=a.replace(new RegExp("\\{"+i+"\\}","g"),o[i])}),a}var qa={scroll:"window",resize:"window",mousemove:"document",mouseup:"document"},$o=new Map;function Ba(e){let o=$o.get(e);if(o||(o={subs:new Set,attached:!1},$o.set(e,o)),!o.attached){let t=qa[e]==="window"?window:document,a=e==="mousemove"||e==="mouseup"?{passive:!1,capture:!1}:{passive:!0,capture:!0};t.addEventListener(e,i=>{o.subs.forEach(s=>{try{s(i)}catch(c){console.warn("[fbw] event bus subscriber failed:",e,c)}})},a),o.attached=!0}return o}function st(e,o){let t=Ba(e);return t.subs.add(o),()=>t.subs.delete(o)}var we=e=>st("scroll",e),de=e=>st("resize",e),Q=e=>st("mousemove",e),ee=e=>st("mouseup",e);var fe=null;function b(e,o){fe&&fe.parentNode&&fe.remove();let t=document.createElement("div");if(t.className="fbw-toast",o?.action){let n=document.createElement("span");n.textContent=e,t.appendChild(n);let a=document.createElement("button");a.className="fbw-toast-action",a.type="button",a.textContent=o.action.label,a.addEventListener("click",i=>{i.stopPropagation();try{o.action.onClick()}catch{}t.parentNode&&t.remove(),fe===t&&(fe=null)}),t.appendChild(a)}else t.textContent=e;fe=t,document.body.appendChild(t),setTimeout(()=>{t.parentNode&&t.remove(),fe===t&&(fe=null)},o?.duration??2400)}function ze(e,o){if(!e)return;e.textContent=o;let t=e.closest(".fbw-pill");t&&t.classList.toggle("fbw-has-count",Number(o)>0)}function P(e){if(!r.panel)return;let o=e?e().length:0;ze(r.panel.querySelector('[data-fbw-counter="edit"]'),o),ze(r.panel.querySelector('[data-fbw-counter="sec"]'),r.sectionFeedback.size),ze(r.panel.querySelector('[data-fbw-counter="att"]'),r.attachments.length);let t=r.panel.querySelector('[data-fbw-counter="ops"]');if(t&&ze(t,r.elementOps.size),r.saveEditBtn){let n=o+r.elementOps.size,a=r.saveEditBtn.querySelector(".fbw-edit-count");a&&(a.textContent=n),r.saveEditBtn.classList.toggle("fbw-has-changes",n>0)}if(r.panel){let n=r.panel.querySelector('[data-fbw-counter="sec"]');n&&ze(n,r.sectionFeedback.size+r.annotations.length)}if(typeof r.onChangeHook=="function")try{r.onChangeHook()}catch{}}function zo(e){return(e?e().length:0)+r.elementOps.size}function At({title:e,desc:o,choices:t}){return new Promise(n=>{let a=document.createElement("div");a.className="fbw-confirm fbw-on",a.innerHTML=`
  ...
  `}function Vo(){if(!r.helpPopover)return;let e=r.helpToggleBtn||r.helpFab;if(!e)return;let o=e.getBoundingClientRect(),t=r.helpPopover,n=window.innerHeight,a=n-24;t.style.maxHeight=a+"px",t.style.overflowY="auto";let i=t.getBoundingClientRect(),s=o.left+o.width/2-i.width/2,c=o.top-i.height-12;s<8&&(s=8),s+i.width>window.innerWidth-8&&(s=window.innerWidth-i.width-8),c<8&&(c=o.bottom+12),c+i.height>n-8&&(c=Math.max(8,n-i.height-8)),t.style.left=s+"px",t.style.top=c+"px"}function He(){let e=r.helpPopover;if(e){if(e.classList.contains("fbw-on")){e.classList.remove("fbw-on");return}e.innerHTML=lr(),e.classList.add("fbw-on"),requestAnimationFrame(()=>Vo())}}function Ht(){r.helpPopover&&r.helpPopover.classList.remove("fbw-on")}function Zo(){document.addEventListener("click",e=>{e.target.closest&&e.target.closest("[data-fbw-help-close]")&&(e.stopPropagation(),Ht())},!0),document.addEventListener("mousedown",e=>{let o=r.helpPopover;if(!o||!o.classList.contains("fbw-on")||e.target.closest('.fbw-help-popover, .fbw-help-fab, [data-fbw-btn="help"]'))return;let t=typeof e.composedPath=="function"?e.composedPath():[];t.some(n=>n&&n.dataset&&n.dataset.fbwBtn==="help")||t.some(n=>n&&n.classList&&n.classList.contains("fbw-help-popover"))||Ht()},!0),document.addEventListener("keydown",e=>{e.key==="Escape"&&r.helpPopover?.classList.contains("fbw-on")&&Ht()}),de(()=>{r.helpPopover?.classList.contains("fbw-on")&&Vo()})}function Jo(){let o=it()==="zh"?l("panel.localeName.en"):l("panel.localeName.zh");return`
    <div class="fbw-head">
      ...
      <span class="fbw-head-actions">
        ...
        <button class="fbw-icon-btn" data-fbw-locale data-tooltip="${l("panel.btn.locale.title",{lang:o})}">${fo}</button>
    ...
    <div class="fbw-row">
      <button class="fbw-btn fbw-primary" data-fbw-action="save" data-tooltip="${l("panel.btn.save.title")}">${lo}<span>${l("panel.btn.save")}</span></button>
      <button class="fbw-btn" data-fbw-action="copy" data-tooltip="${l("panel.btn.copy.title")}">${so}<span>${l("panel.btn.copy")}</span></button>
    </div>
  `}function Qo(){return`
    <div class="fbw-confirm-box">
  ...
  `}function en(){return`
    ...
    <button data-op="font" data-tooltip="${l("tip.font")}">${Ao}</button>
    <button data-op="tag" data-tooltip="${l("tip.tag")}" style="display:none;">${Lo}</button>
    <button data-op="highlight" data-tooltip="${l("tip.highlight")}">${mo}</button>
    <button data-op="pick" data-tooltip="${l("tip.pick")}">${Co}</button>
    <button data-op="style" data-tooltip="${l("tip.style")}">${Mo}</button>
    <button data-op="replace-img" data-tooltip="${l("tip.replaceImg")}" style="display:none;">${wo}</button>
    <span class="fbw-tb-divider"></span>
    <button data-op="move-up" data-tooltip="${l("tip.moveUp")}">${yo}</button>
    <button data-op="move-down" data-tooltip="${l("tip.moveDown")}">${xo}</button>
    <button data-op="move-left" data-tooltip="${l("tip.moveLeft")}">${vo}</button>
    <button data-op="move-right" data-tooltip="${l("tip.moveRight")}">${ko}</button>
    <span class="fbw-tb-divider"></span>
    <button data-op="zoom-in" data-tooltip="${l("tip.zoomIn")}">${So}</button>
    <button data-op="zoom-out" data-tooltip="${l("tip.zoomOut")}">${Eo}</button>
    <span class="fbw-tb-divider"></span>
    <button data-op="link" data-tooltip="${l("tip.link")}" style="display:none;">${po}</button>
    <button data-op="note" data-tooltip="${l("tip.note")}">${J}</button>
    <button data-op="hide" data-tooltip="${l("tip.hide")}" class="fbw-danger">${go}</button>
    <button data-op="delete" data-tooltip="${l("tip.delete")}" class="fbw-danger">${Ft}</button>
    <button data-op="restore" data-tooltip="${l("tip.restore")}" class="fbw-restore">${ho}</button>
    <span class="fbw-tb-divider"></span>
  ...
  `}function cr(){return'<div class="fbw-design-tags" data-fbw-tags>'+[["spacing",l("design.tag.spacing")],["color",l("design.tag.color")],["typography",l("design.tag.typography")],["layout",l("design.tag.layout")],["copy",l("design.tag.copy")]].map(([e,o])=>`<button class="fbw-design-tag" type="button" data-fbw-tag="${e}">${o}</button>`).join("")+"</div>"}var X=[],Me=[],nn=50;function ft(e){if(!e)return null;let o=r.elementOps.get(e);return{el:e,style:{transform:e.style.transform||"",fontFamily:e.style.fontFamily||"",backgroundColor:e.style.backgroundColor||"",backgroundImage:e.style.backgroundImage||"",visibility:e.style.visibility||"",fontSize:e.style.fontSize||"",padding:e.style.padding||"",margin:e.style.margin||""},dataset:{fbwTx:e.dataset.fbwTx??null,fbwTy:e.dataset.fbwTy??null,fbwScale:e.dataset.fbwScale??null,fbwRotate:e.dataset.fbwRotate??null,fbwOpHidden:e.dataset.fbwOpHidden??null,fbwOpDeleted:e.dataset.fbwOpDeleted??null,fbwHighlight:e.dataset.fbwHighlight??null,fbwOriginalSrc:e.dataset.fbwOriginalSrc??null},attrs:{tagAs:e.getAttribute("data-fbw-tag-as"),href:e.tagName==="A"?e.getAttribute("href"):void 0,src:e.tagName==="IMG"?e.getAttribute("src"):void 0},innerHTML:e.innerHTML,edited:e.dataset.fbwEdited??null,fbwChanged:e.classList.contains("fbw-changed"),opsClone:o?JSON.parse(JSON.stringify(o)):null}}function on(e){if(!e)return!1;let o=e.el;if(!o||!document.contains(o))return!1;for(let t of Object.keys(e.style))o.style[t]=e.style[t];for(let t of Object.keys(e.dataset))e.dataset[t]===null?delete o.dataset[t]:o.dataset[t]=e.dataset[t];return e.attrs.tagAs===null?o.removeAttribute("data-fbw-tag-as"):o.setAttribute("data-fbw-tag-as",e.attrs.tagAs),o.tagName==="A"&&e.attrs.href!==void 0&&(e.attrs.href===null?o.removeAttribute("href"):o.setAttribute("href",e.attrs.href)),o.tagName==="IMG"&&e.attrs.src!==void 0&&e.attrs.src!==null&&(o.src=e.attrs.src),typeof e.innerHTML=="string"&&o.innerHTML!==e.innerHTML&&(o.innerHTML=e.innerHTML),e.edited===null?delete o.dataset.fbwEdited:o.dataset.fbwEdited=e.edited,o.classList.toggle("fbw-changed",!!e.fbwChanged),e.opsClone?r.elementOps.set(o,e.opsClone):r.elementOps.delete(o),!0}function j(e){if(!e)return;let o=ft(e);o&&(X.push(o),X.length>nn&&X.shift(),Me.length=0)}function D(e){if(!e||!e.length)return;let o=[];for(let t of e){let n=ft(t);n&&o.push(n)}o.length&&(X.push({__group:!0,snaps:o}),X.length>nn&&X.shift(),Me.length=0)}function an(e){if(e&&e.__group){let o=!1;for(let t of e.snaps)on(t)&&(o=!0);return o}return on(e)}function rn(e){if(e&&e.__group){let o=e.snaps.map(t=>ft(t.el)).filter(Boolean);return o.length?{__group:!0,snaps:o}:null}return ft(e.el)}function _e(){if(X.length===0){b(l("undo.empty")||"\u6CA1\u6709\u53EF\u64A4\u9500\u7684\u64CD\u4F5C");return}let e=X.pop(),o=rn(e);o&&Me.push(o),an(e)?(P(E),T(),b(l("undo.done")||"\u5DF2\u64A4\u9500")):b(l("undo.gone")||"\u5143\u7D20\u5DF2\u4E0D\u5728\u9875\u9762")}function _t(){if(Me.length===0){b(l("redo.empty")||"\u6CA1\u6709\u53EF\u91CD\u505A\u7684\u64CD\u4F5C");return}let e=Me.pop(),o=rn(e);o&&X.push(o),an(e)?(P(E),T(),b(l("redo.done")||"\u5DF2\u91CD\u505A")):b(l("redo.gone")||"\u5143\u7D20\u5DF2\u4E0D\u5728\u9875\u9762")}function sn(){return X.length>0}function ln(){return Me.length>0}function H(e){b(e,{action:{label:l("toast.undo")||"\u64A4\u9500",onClick:_e},duration:4e3})}var De=null,ye="unknown";async function dr(){if(ye==="denied"||ye==="unsupported")return[];if(typeof navigator>"u"||typeof navigator.queryLocalFonts!="function")return ye="unsupported",[];try{let e=await navigator.queryLocalFonts();ye="granted";let o=new Set,t=[];for(let n of e)o.has(n.family)||(o.add(n.family),t.push({name:n.family,family:`"${n.family.replace(/"/g,'\\"')}"`,source:"local"}));return t.sort((n,a)=>n.name.localeCompare(a.name)),t}catch(e){return ye="denied",console.warn("[fbw] queryLocalFonts denied:",e?.name||"?","\xB7",e?.message||e),[]}}async function fr(){if(De)return De;let e={generic:[],document:[],local:[]};e.generic.push({name:"\u7CFB\u7EDF\u9ED8\u8BA4",family:"__inherit__",source:"inherit"}),e.generic.push({name:"system-ui",family:"system-ui, -apple-system, sans-serif",source:"generic"}),e.generic.push({name:"serif",family:"serif",source:"generic"}),e.generic.push({name:"sans-serif",family:"sans-serif",source:"generic"}),e.generic.push({name:"monospace",family:"ui-monospace, monospace",source:"generic"}),e.generic.push({name:"cursive",family:"cursive",source:"generic"});try{let t=new Set;document.fonts.forEach(n=>{let a=(n.family||"").replace(/^['"]|['"]$/g,"");a&&!t.has(a)&&(t.add(a),e.document.push({name:a,family:`"${a}"`,source:"document"}))})}catch{}e.local=await dr();let o=new Map;return[...e.generic,...e.document,...e.local].forEach(t=>{o.has(t.name)||o.set(t.name,t)}),De=[...o.values()],De}function cn(e){return(e||"").replace(/^['"]|['"]$/g,"").trim().toLowerCase()}function pr(e){return e?window.getComputedStyle(e).fontFamily.split(",").map(cn).filter(Boolean):[]}function br(e){return e==="document"?l("font.group.document"):e==="local"?l("font.group.local"):l("font.group.generic")}async function ur(){let e=await fr(),o={inherit:0,generic:1,document:2,local:3},t=[...e].sort((s,c)=>(o[s.source]||0)-(o[c.source]||0)),n=null,a=t.map(s=>{let c="";return s.source!==n&&s.source!=="inherit"?(n=s.source,c=`<div class="fbw-fp-group">${br(s.source)}</div>`):s.source==="inherit"&&(n="inherit"),c+`
    ...
    `}).join(""),i="";ye==="denied"?i=`<div class="fbw-fp-hint">${l("font.localDenied")}</div>`:ye==="unsupported"&&(i=`<div class="fbw-fp-hint">${l("font.localUnsupported")}</div>`),r.fontPicker.innerHTML=a+i}function pt(){let e=r.elemToolbar.getBoundingClientRect(),o=e.bottom+6,t=e.left;t+240>window.innerWidth-8&&(t=window.innerWidth-248),t<8&&(t=8),o+360>window.innerHeight-8&&(o=Math.max(8,e.top-366)),r.fontPicker.style.top=o+"px",r.fontPicker.style.left=t+"px"}async function dn(){r.fontPicker.classList.add("fbw-fp-open"),pt(),!De&&typeof navigator<"u"&&"queryLocalFonts"in navigator&&(r.fontPicker.innerHTML=`<div class="fbw-fp-loading">${l("font.loading")}</div>`),await ur(),pt();let e=pr(window.__fbwSelEl);r.fontPicker.querySelectorAll(".fbw-fp-item").forEach(o=>{if(o.dataset.fpFamily==="__inherit__")return;let t=cn(o.dataset.fpName);e.includes(t)&&o.classList.add("fbw-fp-active")})}function K(){r.fontPicker.classList.remove("fbw-fp-open")}function fn(){r.fontPicker.addEventListener("click",e=>{let o=e.target.closest(".fbw-fp-item");if(!o||!r.selectedEl)return;e.stopPropagation();let t=o.dataset.fpFamily.replace(/&quot;/g,'"'),n=o.dataset.fpName,a=$();D(a),a.forEach(i=>{t==="__inherit__"?(i.style.fontFamily="",delete i.dataset.fbwFontName,M(i,"font",{family:"\u7CFB\u7EDF\u9ED8\u8BA4"})):(i.style.fontFamily=t,i.dataset.fbwFontName=n,M(i,"font",{family:n}))}),H(a.length>1?`${l("op.font",{name:n})} \xB7 ${a.length}`:l("op.font",{name:n})),K()}),document.addEventListener("mousedown",e=>{r.fontPicker.classList.contains("fbw-fp-open")&&(e.target.closest(".fbw-font-picker, .fbw-elem-toolbar")||K())},!0)}var pn=["tl","tr","br","bl"];function un(){let e=document.createElement("div");return e.className="fbw-resize-handles",pn.forEach(o=>{let t=document.createElement("div");t.className="fbw-rotate-zone",t.dataset.handle=o,t.title="\u62D6\u52A8\u65CB\u8F6C \xB7 \u6309\u4F4F Shift \u5438\u9644 15\xB0",e.appendChild(t)}),pn.forEach(o=>{let t=document.createElement("div");t.className="fbw-resize-handle",t.dataset.handle=o,t.title="\u62D6\u52A8\u7F29\u653E",e.appendChild(t)}),e}function Dt(e){!r.resizeHandles||!e||(r.resizeHandles.classList.add("fbw-on"),qe(e))}function mn(){r.resizeHandles&&r.resizeHandles.classList.remove("fbw-on")}function qe(e){if(!r.resizeHandles||!e)return;let o=e.getBoundingClientRect();r.resizeHandles.style.top=o.top+"px",r.resizeHandles.style.left=o.left+"px",r.resizeHandles.style.width=o.width+"px",r.resizeHandles.style.height=o.height+"px"}var v=null,pe=null,gn=[.5,.75,1,1.25,1.5,2],wn=[0,45,90,135,180,-45,-90,-135];function mr(){return pe||(pe=document.createElement("div"),pe.className="fbw-drag-readout",document.body.appendChild(pe),pe)}function bn(e,o,t){let n=mr();n.textContent=e,n.style.left=o+14+"px",n.style.top=t+14+"px",n.classList.add("fbw-on")}function gr(){pe&&pe.classList.remove("fbw-on")}function wr(e){let o=gn.find(t=>Math.abs(e-t)<.03);return o!==void 0?`${o.toFixed(2)}\xD7 \u2713`:`${e.toFixed(2)}\xD7`}function hr(e){let o=Math.round(e),t=wn.find(n=>Math.abs(o-n)<=2);return t!==void 0?`${t}\xB0 \u2713`:`${o}\xB0`}function yr(e){if(!r.elemToolbar)return;let o=e.getBoundingClientRect(),t=r.elemToolbar.getBoundingClientRect(),n=o.top-t.height-24,a=o.left;n<8&&(n=o.bottom+24),a+t.width>window.innerWidth-8&&(a=window.innerWidth-t.width-8),a<8&&(a=8),r.elemToolbar.style.top=n+"px",r.elemToolbar.style.left=a+"px"}function hn(){r.resizeHandles.addEventListener("mousedown",e=>{if(!r.editMode||!r.selectedEl||e.button!==0)return;let o=e.target.closest(".fbw-rotate-zone"),t=e.target.closest(".fbw-resize-handle");if(!o&&!t)return;e.preventDefault(),e.stopPropagation();let n=r.selectedEl,a=n.getBoundingClientRect(),i=a.left+a.width/2,s=a.top+a.height/2,c=te(n);if(j(n),t){let f=Math.hypot(e.clientX-i,e.clientY-s);v={mode:"scale",el:n,cx:i,cy:s,startDist:Math.max(f,1),baseScale:c.scale,baseX:c.x,baseY:c.y,baseRotate:c.rotate||0},document.body.style.cursor=window.getComputedStyle(t).cursor}else v={mode:"rotate",el:n,cx:i,cy:s,baseRotate:c.rotate||0,startAngle:Math.atan2(e.clientY-s,e.clientX-i)*180/Math.PI},document.body.style.cursor="grabbing"}),Q(e=>{if(v){if(e.preventDefault(),v.mode==="scale"){let t=Math.hypot(e.clientX-v.cx,e.clientY-v.cy)/v.startDist,n=Math.max(.2,Math.min(3,v.baseScale*t));oe(v.el,{x:v.baseX,y:v.baseY,scale:n,rotate:v.baseRotate}),bn(wr(n),e.clientX,e.clientY)}else if(v.mode==="rotate"){let o=Math.atan2(e.clientY-v.cy,e.clientX-v.cx)*180/Math.PI,t=v.baseRotate+(o-v.startAngle);for(;t>180;)t-=360;for(;t<=-180;)t+=360;e.shiftKey&&(t=Math.round(t/15)*15);let n=te(v.el);oe(v.el,{...n,rotate:t}),bn(hr(t),e.clientX,e.clientY)}qe(v.el),yr(v.el)}}),ee(()=>{if(!v)return;let e=te(v.el);if(v.mode==="scale"){let o=gn.find(n=>Math.abs(e.scale-n)<.03),t=o!==void 0?o:e.scale;o!==void 0&&oe(v.el,{...e,scale:t}),M(v.el,"scale",{scale:parseFloat(t.toFixed(3))})}else if(v.mode==="rotate"){let o=wn.find(n=>Math.abs(e.rotate-n)<=2),t=o!==void 0?o:e.rotate;o!==void 0&&oe(v.el,{...e,rotate:t}),M(v.el,"rotate",{rotate:parseFloat(t.toFixed(2))})}gr(),qe(v.el),v=null,document.body.style.cursor=""})}var xr=[{name:"yellow",value:"rgba(255, 235, 80, 0.55)",swatch:"#ffeb50",label:"\u9EC4"},{name:"green",value:"rgba(140, 220, 130, 0.55)",swatch:"#8cdc82",label:"\u7EFF"},{name:"blue",value:"rgba(150, 200, 255, 0.55)",swatch:"#96c8ff",label:"\u84DD"},{name:"pink",value:"rgba(255, 170, 200, 0.55)",swatch:"#ffaac8",label:"\u7C89"},{name:"orange",value:"rgba(255, 200, 130, 0.55)",swatch:"#ffc882",label:"\u6A59"}];function vr(){return`
  ...
  `}var Be=null,qt=null;function kr(e){let o=window.getSelection();if(!o||o.rangeCount===0)return null;let t=o.getRangeAt(0);return t.collapsed||!e.contains(t.commonAncestorContainer)?null:t.cloneRange()}function Sr(e,o,t){let n=document.createElement("span");n.className="fbw-hl",n.dataset.fbwHighlight=t||"1",n.style.background=o,n.style.borderRadius="2px",n.style.padding="0 1px";try{return e.surroundContents(n),n}catch{let a=e.extractContents();return n.appendChild(a),e.insertNode(n),n}}function Er(){let e=r.elemToolbar?.querySelector('[data-op="highlight"]');if(!e||!r.markerPopover)return;let o=r.markerPopover;o.style.visibility="hidden",o.style.top="0px",o.style.left="0px";let t=o.offsetHeight||80,n=o.offsetWidth||200,a=e.getBoundingClientRect(),i=r.elemToolbar.getBoundingClientRect(),s=i.right+8,c=i.top;s+n>window.innerWidth-8&&(s=i.left-n-8),s<8&&(s=Math.max(8,Math.min(a.left,window.innerWidth-n-8)),c=i.top-t-8,c<8&&(c=i.bottom+8)),o.style.top=c+"px",o.style.left=s+"px",o.style.visibility=""}function xn(){r.markerPopover&&(Be=r.selectedEl||null,qt=Be?kr(Be):null,r.markerPopover.innerHTML=vr(),r.markerPopover.classList.add("fbw-on"),Er())}function G(){r.markerPopover&&r.markerPopover.classList.remove("fbw-on"),Be=null,qt=null}function Lr(e){e.querySelectorAll(".fbw-hl").forEach(o=>{let t=o.parentNode;for(;o.firstChild;)t.insertBefore(o.firstChild,o);t.removeChild(o),t.normalize?.()})}function yn(e,o,t,n){if(!e)return;if(n){j(e),o&&(Sr(n,o,t),window.getSelection()?.removeAllRanges(),M(e,"highlight",{color:o,name:t,scope:"range"}),H(l("op.highlight")+(t?": "+t:"")));return}let a=$();D(a),a.forEach(s=>{o?(s.style.background=o,s.dataset.fbwHighlight=t||"1",M(s,"highlight",{color:o,name:t,scope:"element"})):(Lr(s),s.style.background="",delete s.dataset.fbwHighlight,M(s,"highlight",{color:null}))});let i=o?l("op.highlight")+(t?": "+t:""):l("highlight.clear");H(a.length>1?`${i} \xB7 ${a.length}`:i)}function vn(){let e=r.markerPopover;e&&(e.addEventListener("click",o=>{o.stopPropagation();let t=Be||r.selectedEl;if(!t)return;let n=qt,a=o.target.closest("[data-color]");if(a){yn(t,a.dataset.color,a.dataset.name,n),G();return}o.target.closest("[data-clear]")&&(yn(t,"",null,null),G())}),document.addEventListener("mousedown",o=>{e.classList.contains("fbw-on")&&(o.target.closest('.fbw-marker-popover, [data-op="highlight"], .fbw-elem-toolbar')||G())},!0))}var kn=["p","h1","h2","h3","h4","h5","h6"],z=null,V=null;function Sn(){return z=document.createElement("div"),z.className="fbw-tag-popover",z.innerHTML=kn.map(e=>`<button data-fbw-tag="${e}">${e.toUpperCase()}</button>`).join(""),z}function Cr(e){return(e.getAttribute("data-fbw-tag-as")||e.tagName).toLowerCase()}function Bt(e){if(!z)return;let o=Cr(e);z.querySelectorAll("[data-fbw-tag]").forEach(t=>{t.classList.toggle("fbw-active",t.dataset.fbwTag===o)})}function En(){if(!z||!r.selectedEl)return;let e=r.elemToolbar.getBoundingClientRect();z.style.top=e.bottom+6+"px",z.style.left=e.left+24+"px",z.classList.add("fbw-on"),V=r.selectedEl.getAttribute("data-fbw-tag-as"),Bt(r.selectedEl)}function U(){z&&(z.classList.remove("fbw-on"),r.selectedEl&&V!==void 0&&(V===null?r.selectedEl.removeAttribute("data-fbw-tag-as"):r.selectedEl.setAttribute("data-fbw-tag-as",V),V=null))}function Mr(e){r.selectedEl&&(e===r.selectedEl.tagName.toLowerCase()?r.selectedEl.removeAttribute("data-fbw-tag-as"):r.selectedEl.setAttribute("data-fbw-tag-as",e))}function Tr(e,o){if(!e||!kn.includes(o))return;let t=e.tagName.toLowerCase(),n=V;if(V=null,o===t&&n==null){U();return}if(o===t){j(e),e.removeAttribute("data-fbw-tag-as");let a=r.elementOps.get(e);a&&(a.ops=a.ops.filter(i=>i.op!=="tag"),a.ops.length||Se(e)),H(l("op.tag.cleared")||"\u5DF2\u64A4\u9500\u6807\u7B7E\u53D8\u66F4"),U();return}j(e),e.setAttribute("data-fbw-tag-as",o),M(e,"tag",{from:t,to:o}),H(l("op.tag.done",{tag:o.toUpperCase()})||`\u6807\u7B7E\u53D8\u66F4\u4E3A ${o.toUpperCase()}`),U()}function Ln(){z&&(z.addEventListener("click",e=>{let o=e.target.closest("[data-fbw-tag]");!o||!r.selectedEl||(e.stopPropagation(),Tr(r.selectedEl,o.dataset.fbwTag))}),z.addEventListener("mouseover",e=>{let o=e.target.closest("[data-fbw-tag]");o&&(Mr(o.dataset.fbwTag),Bt(r.selectedEl))}),z.addEventListener("mouseleave",()=>{r.selectedEl&&(V===null?r.selectedEl.removeAttribute("data-fbw-tag-as"):V!==void 0&&r.selectedEl.setAttribute("data-fbw-tag-as",V),Bt(r.selectedEl))}),document.addEventListener("mousedown",e=>{z.classList.contains("fbw-on")&&(e.target.closest('.fbw-tag-popover, [data-op="tag"]')||U())},!0))}function Fr(e,o){if(!e)return!1;let t=e.selectionStart??e.value.length,n=e.selectionEnd??e.value.length,a=e.value.slice(0,t),i=e.value.slice(n);e.value=a+o+i;let s=t+o.length;return e.selectionStart=e.selectionEnd=s,e.dispatchEvent(new Event("input",{bubbles:!0})),!0}async function Cn(){if(typeof window.EyeDropper!="function"){b(l("eyedropper.unsupported")||"\u53D6\u8272\u5668\u4E0D\u652F\u6301\u5F53\u524D\u6D4F\u89C8\u5668 \xB7 \u9700\u8981 Chrome / Edge 95+");return}let e=r.panel?.classList.contains("fbw-open");e&&r.panel.classList.remove("fbw-open");let o;try{o=await new window.EyeDropper().open()}catch{e&&r.panel?.classList.add("fbw-open");return}e&&r.panel?.classList.add("fbw-open");let t=o.sRGBHex,n=document.activeElement,a=!1;n&&n.tagName==="TEXTAREA"&&n.closest(".fbw-panel, .fbw-anno, .fbw-note-popover")&&(a=Fr(n,t));try{await navigator.clipboard.writeText(t)}catch{}b(a?l("eyedropper.inserted",{hex:t})||`${t} \xB7 \u5DF2\u63D2\u5165\u53CD\u9988\u6846 + \u526A\u8D34\u677F`:l("eyedropper.copied",{hex:t})||`${t} \xB7 \u5DF2\u590D\u5236\u5230\u526A\u8D34\u677F`)}var je=[{key:"fontSize",i18n:"style.fontSize",min:8,max:96,step:1,sided:!1},{key:"padding",i18n:"style.padding",min:0,max:80,step:1,sided:!0},{key:"margin",i18n:"style.margin",min:0,max:120,step:1,sided:!0}],S=null,jt=!1,Ut={padding:!1,margin:!1};function Pr(e){let o=e.sided?`<button class="fbw-style-link" data-link="${e.key}" tabindex="-1" title="${l("style.unlink")}">\u21C4</button>`:"";return`
...
`+n.documentElement.outerHTML;hi(a,yi(o)),b(l("singlefile.done",{mode:o})||`\u5DF2\u5BFC\u51FA HTML \xB7 ${o==="readonly"?"\u53EA\u8BFB":"\u53EF\u7F16\u8F91"}`)}catch(t){console.error("[fbw] singlefile export failed",t),b(l("singlefile.fail",{reason:t.message})||"\u5BFC\u51FA\u5931\u8D25: "+t.message)}}async function ai(){if(typeof window<"u"&&typeof window.__fbwBundleSource=="string")return window.__fbwBundleSource;if(typeof chrome<"u"&&chrome.runtime?.getURL)try{let e=chrome.runtime.getURL("redline.js"),o=await fetch(e);if(o.ok)return await o.text()}catch{}for(let e of document.querySelectorAll("script[src]"))if(/redline\.js(\?|$)/.test(e.src))try{let o=await fetch(e.src);if(o.ok)return await o.text()}catch{}for(let e of document.querySelectorAll("script:not([src])"))if(e.textContent&&e.textContent.includes("__feedbackWidgetVersion"))return e.textContent;return null}function ri(e){let o=[".fbw-panel",".fbw-fab-bar",".fbw-elem-toolbar",".fbw-confirm",".fbw-toast",".fbw-help-popover",".fbw-tooltip",".fbw-font-picker",".fbw-note-popover",".fbw-marker-popover",".fbw-tag-popover",".fbw-style-panel",".fbw-resize-handles",".fbw-drag-readout",".fbw-measure-overlay",".fbw-rubber-band",".fbw-marquee-drawing",".fbw-anno","#fbw-styles","style[data-fbw-internal]","script[data-fbw-state]"];for(let t of o)e.querySelectorAll(t).forEach(n=>n.remove());e.querySelectorAll("script").forEach(t=>{(t.src&&/redline\.js(\?|$)/.test(t.src)||!t.src&&t.textContent&&t.textContent.includes("__feedbackWidgetVersion"))&&t.remove()})}function ii(e){let o=e.querySelector("body");if(!o)return;["fbw-edit-mode","fbw-no-overlay","fbw-marquee-mode","fbw-fab-collapsed","fbw-dark-bg","fbw-scrolling","fbw-mouse-near-fab","fbw-printing","fbw-compare-before","fbw-audit-mode","fbw-measuring","fbw-mode-deck","fbw-mode-doc","fbw-mode-review"].forEach(n=>o.classList.remove(n))}var si=500*1024;async function li(e){for(let o of e.querySelectorAll("img[src]")){let t=o.getAttribute("src");if(!(!t||t.startsWith("data:")))try{o.setAttribute("src",await di(ca(t)))}catch{}}for(let o of[...e.querySelectorAll('link[rel="stylesheet"]')]){let t=o.getAttribute("href");if(t)try{let n=ca(t),i=await(await fetch(n)).text();i=await la(i,n);let s=o.ownerDocument.createElement("style");s.textContent=i,o.replaceWith(s)}catch{}}for(let o of e.querySelectorAll("style"))o.textContent&&(o.textContent=await la(o.textContent,location.href))}async function la(e,o){let t=[],n=/url\(\s*(['"]?)([^'")]+)\1\s*\)/g,a;for(;(a=n.exec(e))!==null;)a[2].startsWith("data:")||t.push({match:a[0],url:a[2]});for(let i of t)try{let s=new URL(i.url,o).href,c=await ci(s);e=e.split(i.match).join(`url("${c}")`)}catch{}return e}function ca(e){try{return new URL(e,location.href).href}catch{return e}}async function ci(e){let o=await fetch(e,{mode:"cors"});if(!o.ok)throw new Error("fetch failed: "+o.status);let t=await o.blob();return await Ke(t)}function Ke(e){return new Promise((o,t)=>{let n=new FileReader;n.onload=()=>o(n.result),n.onerror=t,n.readAsDataURL(e)})}async function di(e){let o=await fetch(e,{mode:"cors"});if(!o.ok)throw new Error("fetch failed: "+o.status);let t=await o.blob(),n=t.type||"";if(t.size<=si||n.includes("svg")||n.includes("gif"))return await Ke(t);try{return await fi(t)}catch{return await Ke(t)}}async function fi(e){let o=await createImageBitmap(e),t=document.createElement("canvas");return t.width=o.width,t.height=o.height,t.getContext("2d").drawImage(o,0,0),o.close?.(),await new Promise((n,a)=>{t.toBlob(i=>{if(!i)return a(new Error("toBlob failed"));i.size>=e.size?Ke(e).then(n,a):Ke(i).then(n,a)},"image/webp",.8)})}function pi(){let e={};document.querySelectorAll("[data-fbw-edit-id][data-fbw-edited]").forEach(c=>{let f=c.dataset.fbwEditId,d=r.originals.get(f),p=O(c);d!==void 0&&d!==p&&(e[f]=c.innerHTML)});let o=[];r.elementOps.forEach((c,f)=>{let d=f.dataset?.fbwEditId||null;d&&o.push({id:d,descriptor:c.descriptor,ops:c.ops})});let t={};r.sectionFeedback.forEach((c,f)=>{t[f]=c});let n=r.__rehydrateRevision?.id||null,a=r.__rehydrateRevision?.revision||0,i=bi(),s=a+1;return{schemaVersion:"fbw-singlefile-1",capturedAt:new Date().toISOString(),revisionId:i,revision:s,parentRevisionId:n,exporter:ui(),annotations:r.annotations,elementOps:o,sectionFeedback:t,attachments:r.attachments,edits:e,originals:Array.from(r.originals.entries()),originalsHTML:Array.from(r.originalsHTML.entries()),globalNote:r.panel?.querySelector("[data-fbw-global]")?.value||""}}function bi(){return crypto?.randomUUID?crypto.randomUUID():Date.now().toString(36)+Math.random().toString(36).slice(2,10)}function ui(){let e=navigator.userAgent||"",o=(()=>{let n=e.match(/(Edg|Chrome|Firefox|Safari)\/([\d.]+)/);return n?n[1]==="Safari"&&/Chrome\//.test(e)?"Chrome/"+e.match(/Chrome\/(\d+)/)?.[1]:n[1]+"/"+n[2].split(".")[0]:"browser"})(),t=/Mac/.test(e)?"mac":/Win/.test(e)?"win":/Linux/.test(e)?"linux":"other";return`${o} ${t}`}function mi(e,o){let t=e.querySelector("head");if(!t)return;let n=e.createElement("meta");n.setAttribute("name","fbw-export-mode"),n.setAttribute("content",o),t.appendChild(n)}function gi(e,o){let t=e.querySelector("body")||e,n=e.createElement("script");n.type="application/json",n.setAttribute("data-fbw-state","1"),n.textContent=JSON.stringify(o),t.appendChild(n)}function wi(e,o){let t=e.querySelector("body")||e,n=e.createElement("script");n.textContent=o,t.appendChild(n)}function hi(e,o){let t=new Blob([e],{type:"text/html;charset=utf-8"}),n=URL.createObjectURL(t),a=document.createElement("a");a.href=n,a.download=o,document.body.appendChild(a),a.click(),document.body.removeChild(a),setTimeout(()=>URL.revokeObjectURL(n),1e3)}function yi(e){let o=(document.title||"page").replace(/[\\/:*?"<>|]/g,"_").slice(0,80),t=new Date().toISOString().slice(0,10);return`${o}-${t}-redline${e==="readonly"?"-readonly":""}.html`}function fa(){let e=document.querySelector("script[data-fbw-state]"),o=document.querySelector('meta[name="fbw-export-mode"]'),t=null;if(o&&(t=o.getAttribute("content")),t==="readonly"?(r.readOnly=!0,document.body.classList.add("fbw-readonly"),r.__rehydrateMode="readonly"):t==="editable"&&(r.__rehydrateMode="editable"),!e)return!1;try{let n=JSON.parse(e.textContent||"{}");return ki(n),!0}catch(n){return console.warn("[fbw] inline state parse failed:",n),!1}}function pa(){r.__rehydrateMode==="readonly"?xi():r.__rehydrateMode==="editable"&&vi()}function xi(){if(document.querySelector(".fbw-print-fab"))return;let e=document.createElement("button");e.className="fbw-print-fab",e.type="button",e.innerHTML=bo,e.title=l("readonly.print")||"\u6253\u5370 / \u53E6\u5B58\u4E3A PDF",e.addEventListener("click",()=>window.print()),document.body.appendChild(e)}function vi(){requestAnimationFrame(()=>{let e=r.editFab||document.querySelector(".fbw-edit-fab");if(!e)return;e.classList.add("fbw-breathe"),setTimeout(()=>e.classList.remove("fbw-breathe"),3500);let o=document.createElement("div");o.className="fbw-welcome-tip",o.textContent=l("welcome.editable")||"\u53CC\u51FB\u5143\u7D20\u7EE7\u7EED\u6807 \xB7 \u2318Z \u64A4\u9500",document.body.appendChild(o);let t=e.getBoundingClientRect();requestAnimationFrame(()=>{o.style.left=Math.max(8,t.left+t.width/2-o.offsetWidth/2)+"px",o.style.top=t.top-o.offsetHeight-12+"px",o.classList.add("fbw-on")}),setTimeout(()=>{o.classList.remove("fbw-on"),setTimeout(()=>o.remove(),400)},4200)})}function ki(e){(e.originals||[]).forEach(([o,t])=>r.originals.set(o,t)),(e.originalsHTML||[]).forEach(([o,t])=>r.originalsHTML.set(o,t)),Object.entries(e.edits||{}).forEach(([o,t])=>{let n=document.querySelector(`[data-fbw-edit-id="${da(o)}"]`);n&&(n.innerHTML=t,n.dataset.fbwEdited="1",n.classList.add("fbw-changed"))}),(e.elementOps||[]).forEach(({id:o,descriptor:t,ops:n})=>{if(!o)return;let a=document.querySelector(`[data-fbw-edit-id="${da(o)}"]`);a&&r.elementOps.set(a,{ops:n||[],descriptor:t||""})}),Object.entries(e.sectionFeedback||{}).forEach(([o,t])=>{r.sectionFeedback.set(o,t)}),Array.isArray(e.annotations)&&r.annotations.push(...e.annotations),Array.isArray(e.attachments)&&r.attachments.push(...e.attachments),e.globalNote&&(r.__rehydrateGlobalNote=e.globalNote),(e.revisionId||e.revision)&&(r.__rehydrateRevision={id:e.revisionId||null,revision:e.revision||1,exporter:e.exporter||null,capturedAt:e.capturedAt||null})}function da(e){return typeof CSS<"u"&&CSS.escape?CSS.escape(e):String(e).replace(/[^\w-]/g,o=>"\\"+o)}function Si(){let e=document.querySelector("script[nonce]");return e&&(e.nonce||e.getAttribute("nonce"))||null}function Ei({src:e,integrity:o}){return new Promise(t=>{let n=document.createElement("script");n.src=e,o&&(n.integrity=o,n.crossOrigin="anonymous"),n.referrerPolicy="no-referrer";let a=!1,i=s=>{a||(a=!0,t(s))};n.onload=()=>i(!0),n.onerror=()=>i(!1),document.head.appendChild(n),setTimeout(()=>i(!1),4e3)})}async function Li(e){try{let o=new TextEncoder().encode(e),t=await crypto.subtle.digest("SHA-384",o),n=Array.from(new Uint8Array(t)).map(a=>String.fromCharCode(a)).join("");return"sha384-"+btoa(n)}catch{return null}}async function Ci({src:e,integrity:o},t){try{let n=await fetch(e,{mode:"cors",referrerPolicy:"no-referrer"});if(!n.ok)return!1;let a=await n.text();if(o){let s=await Li(a);if(s&&s!==o)return console.warn("[fbw] SRI mismatch on inline fallback:",e,s,"!=",o),!1}let i=document.createElement("script");return t&&(i.nonce=t),i.textContent=a,document.head.appendChild(i),!0}catch(n){return console.warn("[fbw] fetch+inline fallback failed:",e,n?.message||n),!1}}async function Ve(e,o){if(typeof o=="function"&&o()||await Ei(e)&&(!o||o()))return!0;let t=Si();return!!(await Ci(e,t)&&(!o||o()))}var ba={html2canvas:{src:"https://cdn.jsdelivr.net/npm/html2canvas@1.4.1/dist/html2canvas.min.js",integrity:"sha384-ZZ1pncU3bQe8y31yfZdMFdSpttDoPmOZg2wguVK9almUodir1PghgT0eY7Mrty8H"},jspdf:{src:"https://cdn.jsdelivr.net/npm/jspdf@2.5.1/dist/jspdf.umd.min.js",integrity:"sha384-JcnsjUPPylna1s1fvi1u12X5qjY5OL56iySh75FdtrwhO/SWXgMjoVqcKyIIWOLk"}};async function Mi(){let e=[];return window.html2canvas||e.push(Ve(ba.html2canvas,()=>!!window.html2canvas)),window.jspdf||e.push(Ve(ba.jspdf,()=>!!window.jspdf)),e.length?(await Promise.all(e)).every(Boolean)&&!!window.html2canvas&&!!window.jspdf:!0}function se(e,o){if(e=e||{},r.panel.classList.remove("fbw-open"),r.fbToggleBtn&&r.fbToggleBtn.classList.remove("fbw-active"),r.fbFab.classList.remove("fbw-active"),o)try{o()}catch{}if(e.image)return Ti();document.body.classList.add("fbw-printing"),b(l("pdf.vector.hint")),setTimeout(()=>{try{window.print()}catch(t){console.error(t)}setTimeout(()=>document.body.classList.remove("fbw-printing"),2e3)},250)}async function Ti(){if(b(l("pdf.loading")),!await Mi()){b(l("pdf.loadFailed"));return}let o=document.querySelector("deck-stage"),t=o&&parseInt(o.getAttribute("width"),10)||1920,n=o&&parseInt(o.getAttribute("height"),10)||1080,a=[...document.querySelectorAll("section.slide")];if(!a.length)return Fi();let i=a.map(m=>m.hasAttribute("data-deck-active"));document.body.classList.add("fbw-printing");let s=null,c="";try{s=o&&o.shadowRoot&&o.shadowRoot.querySelector(".canvas")}catch{}s&&(c=s.style.transform||"",s.style.transform="none");let{jsPDF:f}=window.jspdf,d=t>n?"landscape":"portrait",p=new f({unit:"px",format:[t,n],orientation:d,hotfixes:["px_scaling"]}),g="http://www.w3.org/2000/svg",y=new Map;document.querySelectorAll("symbol[id]").forEach(m=>y.set(m.id,m));let w=[];a.forEach(m=>{m.querySelectorAll("use").forEach(u=>{let F=(u.getAttribute("href")||u.getAttribute("xlink:href")||"").replace(/^#/,""),x=y.get(F);if(!x)return;let h=u.ownerSVGElement,B=x.getAttribute("viewBox"),le=!1;h&&!h.getAttribute("viewBox")&&B&&(h.setAttribute("viewBox",B),le=!0);let et=document.createElementNS(g,"g");[...x.childNodes].forEach(tt=>et.appendChild(tt.cloneNode(!0))),["transform","fill","stroke","class","opacity","style"].forEach(tt=>{let ao=u.getAttribute(tt);ao&&et.setAttribute(tt,ao)});let Ha=u;u.parentNode.insertBefore(et,u),u.parentNode.removeChild(u),w.push({g:et,original:Ha,parentSvg:h,vbAdded:le})})}),b(l("pdf.progress",{i:0,total:a.length}));try{for(let u=0;u<a.length;u++){a.forEach((h,B)=>{B===u?h.setAttribute("data-deck-active",""):h.removeAttribute("data-deck-active")}),await new Promise(h=>requestAnimationFrame(()=>requestAnimationFrame(h)));try{await document.fonts.ready}catch{}b(l("pdf.progress",{i:u+1,total:a.length}));let k={width:t,height:n,windowWidth:t,windowHeight:n,scale:2,useCORS:!0,allowTaint:!0,backgroundColor:"#ffffff",logging:!1},F;try{F=await window.html2canvas(a[u],{...k,foreignObjectRendering:!0})}catch(h){console.warn("foreignObject mode failed, fallback to JS render:",h),F=await window.html2canvas(a[u],k)}let x=F.toDataURL("image/jpeg",.92);u>0&&p.addPage([t,n],d),p.addImage(x,"JPEG",0,0,t,n,void 0,"FAST")}let m=(document.title||"deck").replace(/[\\/:*?"<>|]/g,"_")+"-image.pdf";p.save(m),b(l("pdf.saved",{file:m}))}catch(m){console.error(m),b(l("pdf.failed",{reason:m.message||m}))}finally{w.forEach(m=>{try{m.g.parentNode.insertBefore(m.original,m.g),m.g.parentNode.removeChild(m.g),m.vbAdded&&m.parentSvg&&m.parentSvg.removeAttribute("viewBox")}catch{}}),s&&(s.style.transform=c),a.forEach((m,u)=>{i[u]?m.setAttribute("data-deck-active",""):m.removeAttribute("data-deck-active")}),document.body.classList.remove("fbw-printing")}}async function Fi(){document.body.classList.add("fbw-printing"),await new Promise(a=>requestAnimationFrame(()=>requestAnimationFrame(a)));try{await document.fonts.ready}catch{}let e=document.documentElement,o=Math.max(e.scrollWidth,document.body.scrollWidth),t=Math.max(e.scrollHeight,document.body.scrollHeight);b(l("pdf.progress",{i:0,total:1}));let n;try{n=await window.html2canvas(document.body,{useCORS:!0,allowTaint:!0,logging:!1,backgroundColor:"#ffffff",scale:2,x:0,y:0,width:o,height:t,windowWidth:o,windowHeight:t})}catch(a){console.error(a),b(l("pdf.failed",{reason:a.message||a})),document.body.classList.remove("fbw-printing");return}try{let{jsPDF:a}=window.jspdf,i=14400,s=(document.title||"page").replace(/[\\/:*?"<>|]/g,"_")+"-long.pdf";if(t<=i){let c=new a({unit:"px",format:[o,t],orientation:"portrait",hotfixes:["px_scaling"]}),f=n.toDataURL("image/jpeg",.9);c.addImage(f,"JPEG",0,0,o,t,void 0,"FAST"),c.save(s)}else{let c=i,f=n.width/o,d=Math.floor(c*f),p=Math.ceil(n.height/d),g=new a({unit:"px",format:[o,c],orientation:"portrait",hotfixes:["px_scaling"]});for(let y=0;y<p;y++){b(l("pdf.progress",{i:y+1,total:p}));let w=y*d,m=Math.min(d,n.height-w),u=document.createElement("canvas");u.width=n.width,u.height=m;let k=u.getContext("2d");k.fillStyle="#ffffff",k.fillRect(0,0,u.width,u.height),k.drawImage(n,0,w,n.width,m,0,0,n.width,m);let F=u.toDataURL("image/jpeg",.9);y>0&&g.addPage([o,c],"portrait"),g.addImage(F,"JPEG",0,0,o,m/f,void 0,"FAST"),await new Promise(x=>setTimeout(x,0))}g.save(s)}b(l("pdf.saved",{file:s}))}catch(a){console.error(a),b(l("pdf.failed",{reason:a.message||a}))}finally{document.body.classList.remove("fbw-printing")}}var R=null;function ua(){R=document.createElement("div"),R.className="fbw-export-menu";let e=(o,t,n,a)=>`
  ...
  `,R}function Pi(){if(!R||!r.exportFab)return;let e=r.exportFab.getBoundingClientRect(),o=R.offsetWidth||240,t=R.offsetHeight||180,n=e.top-t-8,a=e.left+e.width/2-o/2;a<8&&(a=8),a+o>window.innerWidth-8&&(a=window.innerWidth-o-8),n<8&&(n=e.bottom+8),R.style.top=n+"px",R.style.left=a+"px"}function Et(){R&&(R.classList.add("fbw-on"),requestAnimationFrame(Pi))}function ve(){R&&R.classList.remove("fbw-on")}function ma(){R&&(R.addEventListener("click",e=>{let o=e.target.closest("[data-export]");if(!o)return;e.stopPropagation();let t=o.dataset.export;ve(),t==="pdf-vector"?se({image:!1},L):t==="pdf-image"?se({image:!0},L):t==="html-editable"?Fe({mode:"editable"}):t==="html-readonly"&&Fe({mode:"readonly"})}),document.addEventListener("mousedown",e=>{R.classList.contains("fbw-on")&&(e.target.closest('.fbw-export-menu, .fbw-export-fab, [data-fbw-btn="export"]')||ve())},!0),document.addEventListener("keydown",e=>{e.key==="Escape"&&R.classList.contains("fbw-on")&&ve()}))}function ga(e){return String(e||"").replace(/```/g,"`\u200B`\u200B`")}function Pe(e){return String(e||"").replace(/^(#{1,6}\s|[*\-+]\s|>\s|\d+\.\s)/gm,"\\$1")}function Ze(){let e=E(),o=r.panel.querySelector("[data-fbw-global]").value.trim(),t=new Date().toLocaleString("zh-CN",{hour12:!1}),a="# "+(document.title||"\u9875\u9762\u53CD\u9988")+` \xB7 \u53CD\u9988
...
`),a}var Ai={src:"https://cdn.jsdelivr.net/npm/html2canvas@1.4.1/dist/html2canvas.min.js",integrity:"sha384-ZZ1pncU3bQe8y31yfZdMFdSpttDoPmOZg2wguVK9almUodir1PghgT0eY7Mrty8H"};function Ni(){return Ve(Ai,()=>!!window.html2canvas)}async function wa(){if(b(l("shot.loading")),!await Ni()){b(l("shot.loadFailed"));return}document.body.classList.add("fbw-printing"),await new Promise(t=>requestAnimationFrame(t));let o;try{o=await window.html2canvas(document.body,{useCORS:!0,allowTaint:!0,logging:!1,x:window.scrollX,y:window.scrollY,width:window.innerWidth,height:window.innerHeight,windowWidth:document.documentElement.scrollWidth,windowHeight:document.documentElement.scrollHeight,scale:window.devicePixelRatio||1})}catch(t){console.error("[fbw] screenshot failed",t),b(l("shot.failed")),document.body.classList.remove("fbw-printing");return}document.body.classList.remove("fbw-printing"),o.toBlob(t=>{if(!t){b(l("shot.failed"));return}t.name="screenshot-"+new Date().toISOString().slice(0,19).replace(/[:T]/g,"-")+".jpg",wt(t)},"image/jpeg",.85)}function Je(){r.panel.classList.toggle("fbw-open");let e=r.panel.classList.contains("fbw-open");if(r.fbToggleBtn&&r.fbToggleBtn.classList.toggle("fbw-active",e),r.fbFab.classList.toggle("fbw-active",e),e&&(document.querySelectorAll("[data-fbw-edit-id]").forEach(o=>{let t=o.dataset.fbwEditId;o.classList.toggle("fbw-changed",r.originals.get(t)!==O(o))}),P(E),T(),r.currentSec)){let o=r.currentSec.dataset.fbwSecId,t=r.sectionFeedback.get(o);r.panel.querySelector("[data-fbw-saved]").classList.toggle("fbw-on",!!t)}}function ha(){r.panel.querySelector("[data-fbw-close]").addEventListener("click",t=>{t.stopPropagation(),r.panel.classList.remove("fbw-open"),r.fbToggleBtn&&r.fbToggleBtn.classList.remove("fbw-active"),r.fbFab.classList.remove("fbw-active")}),r.fbFab.addEventListener("click",Je);let e=r.panel.querySelector("[data-fbw-locale]");e&&e.addEventListener("click",t=>{t.stopPropagation(),Oo()});let o=r.panel.querySelector("[data-fbw-shot]");o&&o.addEventListener("click",t=>{t.stopPropagation();let n=r.panel.classList.contains("fbw-open");n&&r.panel.classList.remove("fbw-open"),wa().finally(()=>{n&&r.panel.classList.add("fbw-open")})}),r.panel.querySelector('[data-fbw-action="copy"]').addEventListener("click",()=>{let t=Ze();navigator.clipboard.writeText(t).then(()=>b(l("panel.copy"))).catch(()=>{let n=document.createElement("textarea");n.value=t,document.body.appendChild(n),n.select(),document.execCommand("copy"),document.body.removeChild(n),b(l("panel.copy.fallback"))})}),r.panel.querySelector("[data-fbw-clear-all]").addEventListener("click",t=>{t.stopPropagation(),r.confirmDialog.classList.add("fbw-on")}),r.confirmDialog.querySelector("[data-fbw-confirm-cancel]").addEventListener("click",()=>{r.confirmDialog.classList.remove("fbw-on")}),r.confirmDialog.querySelector("[data-fbw-confirm-ok]").addEventListener("click",()=>{r.sectionFeedback.clear(),r.attachments.length=0,r.annotations.length=0,document.querySelectorAll(".fbw-anno").forEach(t=>t.remove()),ne(),r.panel.querySelector("[data-fbw-global]").value="",r.panel.querySelector("[data-fbw-current-text]").value="",r.panel.querySelector("[data-fbw-saved]").classList.remove("fbw-on"),document.querySelectorAll("[data-fbw-edit-id]").forEach(t=>{let n=t.dataset.fbwEditId,a=r.originals.get(n);a!==void 0&&O(t)!==a&&(t.innerText=a,t.classList.remove("fbw-changed"))}),r.elementOps.forEach((t,n)=>{delete n.dataset.fbwOpDeleted,delete n.dataset.fbwOpHidden,delete n.dataset.fbwTx,delete n.dataset.fbwTy,delete n.dataset.fbwScale,delete n.dataset.fbwRotate,delete n.dataset.fbwHighlight,n.style.transform="",n.style.backgroundImage="",n.style.backgroundColor="",n.tagName==="IMG"&&n.dataset.fbwOriginalSrc&&(n.src=n.dataset.fbwOriginalSrc,delete n.dataset.fbwOriginalSrc)}),r.elementOps.clear(),L(),Bo(),P(E),r.confirmDialog.classList.remove("fbw-on"),b(l("panel.cleared"))}),window.addEventListener("beforeunload",$t)}function Qe(e){r.currentSec=e;let o=r.panel.querySelector("[data-fbw-current-page]"),t=r.panel.querySelector("[data-fbw-current-text]"),n=r.panel.querySelector("[data-fbw-saved]");if(!e){o.textContent="\u2014",t.value="",t.disabled=!0,n.classList.remove("fbw-on");return}t.disabled=!1,o.textContent=e.dataset.fbwSecLabel||"Section";let a=e.dataset.fbwSecId,i=r.sectionFeedback.get(a);t.value=i?.note||"",n.classList.toggle("fbw-on",!!i)}function ya(e){let o=r.panel.querySelector("[data-fbw-current-text]");o.addEventListener("input",n=>{if(!r.currentSec)return;let a=r.currentSec.dataset.fbwSecId,i=r.currentSec.dataset.fbwSecLabel,s=n.target.value.trim();s?(r.sectionFeedback.set(a,{label:i,note:s}),r.panel.querySelector("[data-fbw-saved]").classList.add("fbw-on")):(r.sectionFeedback.delete(a),r.panel.querySelector("[data-fbw-saved]").classList.remove("fbw-on")),P(E),T()}),["keydown","keyup","keypress"].forEach(n=>o.addEventListener(n,a=>a.stopPropagation())),r.panel.querySelector("[data-fbw-global]").addEventListener("input",T);let t=document.querySelector("deck-stage");if(t){document.addEventListener("slidechange",a=>Qe(a.detail?.slide||null));let n=t.querySelector("section.slide")||e[0];n&&Qe(n)}else{if(document.body.classList.add("fbw-no-overlay"),e.length){let a=new IntersectionObserver(i=>{let s=i.filter(c=>c.isIntersecting).sort((c,f)=>f.intersectionRatio-c.intersectionRatio)[0];s&&Qe(s.target)},{threshold:[.3,.5,.7]});e.forEach(i=>a.observe(i)),Qe(e[0])}if(e.length===1&&(e[0]===document.body||e[0].tagName==="MAIN"||e[0].tagName==="ARTICLE")){let a=e[0],i=()=>{let c=(document.title||"Page").slice(0,80);a.dataset.fbwSecLabel!==c&&(a.dataset.fbwSecLabel=c,r.currentSec===a&&Qe(a))};window.addEventListener("popstate",i),["pushState","replaceState"].forEach(c=>{let f=history[c];history[c]=function(...d){let p=f.apply(this,d);return setTimeout(i,0),p}});let s=document.querySelector("title");s&&new MutationObserver(i).observe(s,{childList:!0,characterData:!0,subtree:!0})}}}function Zt(e){return{id:e.id||e.dataset.fbId||null,cssPath:Oi(e),contentHash:$i(e),fbId:e.dataset.fbwEditId||null,tag:e.tagName.toLowerCase()}}function xa(e){return typeof CSS<"u"&&CSS.escape?CSS.escape(e):String(e).replace(/[^\w-]/g,o=>"\\"+o)}function Oi(e){let o=e.closest("[data-fbw-sec-id]")||document.body,t=[],n=e;for(;n&&n!==o&&n!==document.body;){let i=n.tagName.toLowerCase();if(n.id){t.unshift("#"+xa(n.id)),n=null;break}let s=[...n.classList].filter(f=>!f.startsWith("fbw-")).slice(0,2);s.length&&(i+="."+s.map(xa).join("."));let c=n.parentElement;if(c){let f=[...c.children].filter(d=>d.tagName===n.tagName);if(f.length>1){let d=f.indexOf(n)+1;i+=`:nth-of-type(${d})`}}t.unshift(i),n=c}return[o.dataset?.fbwSecId?`[data-fbw-sec-id="${o.dataset.fbwSecId}"]`:"",t.join(" > ")].filter(Boolean).join(" > ")}function $i(e){let o=(e.textContent||"").replace(/\s+/g," ").trim().slice(0,80),t=0;for(let n=0;n<o.length;n++)t=(t<<5)-t+o.charCodeAt(n),t|=0;return{sample:o.slice(0,40),hash:(t>>>0).toString(16).padStart(8,"0")}}var Jt="sessionsDir";function Ae(){return typeof window<"u"&&typeof window.showDirectoryPicker=="function"}async function zi(e,o="readwrite"){if(!e?.queryPermission)return!1;let t={mode:o};try{if(await e.queryPermission(t)==="granted"||await e.requestPermission(t)==="granted")return!0}catch{}return!1}async function va(){let e=await ut(Jt);return e&&await zi(e)?e:null}async function ka(){let e=await window.showDirectoryPicker({id:"redline-sessions",mode:"readwrite",startIn:"desktop"});return await mt(Jt,e),e}async function Sa(){await gt(Jt)}var Ri=(()=>{let e=new Uint32Array(256);for(let o=0;o<256;o++){let t=o;for(let n=0;n<8;n++)t=t&1?3988292384^t>>>1:t>>>1;e[o]=t>>>0}return e})();function Ii(e){let o=4294967295;for(let t=0;t<e.length;t++)o=Ri[(o^e[t])&255]^o>>>8;return(o^4294967295)>>>0}function Hi(e=new Date){let o=(e.getHours()&31)<<11|(e.getMinutes()&63)<<5|Math.floor(e.getSeconds()/2)&31,t=(e.getFullYear()-1980&127)<<9|(e.getMonth()+1&15)<<5|e.getDate()&31;return{time:o,date:t}}function C(e,o,t){e.setUint16(o,t,!0)}function q(e,o,t){e.setUint32(o,t,!0)}function Ea(e){let o=new TextEncoder,{time:t,date:n}=Hi(),a=[],i=[],s=0;for(let p of e){let g=o.encode(p.name),y=p.data,w=Ii(y),m=y.length,u=new ArrayBuffer(30+g.length),k=new DataView(u);q(k,0,67324752),C(k,4,20),C(k,6,2048),C(k,8,0),C(k,10,t),C(k,12,n),q(k,14,w),q(k,18,m),q(k,22,m),C(k,26,g.length),C(k,28,0),new Uint8Array(u,30).set(g),a.push(new Uint8Array(u),y);let F=new ArrayBuffer(46+g.length),x=new DataView(F);q(x,0,33639248),C(x,4,20),C(x,6,20),C(x,8,2048),C(x,10,0),C(x,12,t),C(x,14,n),q(x,16,w),q(x,20,m),q(x,24,m),C(x,28,g.length),C(x,30,0),C(x,32,0),C(x,34,0),C(x,36,0),q(x,38,0),q(x,42,s),new Uint8Array(F,46).set(g),i.push(new Uint8Array(F)),s+=30+g.length+m}let c=i.reduce((p,g)=>p+g.length,0),f=new ArrayBuffer(22),d=new DataView(f);return q(d,0,101010256),C(d,4,0),C(d,6,0),C(d,8,e.length),C(d,10,e.length),q(d,12,c),q(d,16,s),C(d,20,0),new Blob([...a,...i,new Uint8Array(f)],{type:"application/zip"})}var _i="1.0";function La(){let e=r.panel?.querySelector("[data-fbw-global]")?.value?.trim()||"",o=[];r.sectionFeedback.forEach((a,i)=>{o.push({secId:i,secLabel:a.label,note:a.note})});let t=[];E().forEach(a=>{let i=document.querySelector(`[data-fbw-edit-id="${a.id}"]`);i&&t.push({op:"text",selector:Zt(i),section:a.section,before:a.before,after:a.after})}),r.elementOps.forEach((a,i)=>{a.ops.forEach(s=>{t.push({op:s.op,selector:Zt(i),descriptor:a.descriptor,...s.args!==void 0?{args:s.args}:{},...s.proposed?{proposed:!0}:{}})})});let n=r.attachments.map(a=>({id:a.id,name:a.name,type:a.type,dataURL:a.dataURL}));return{schemaVersion:_i,widgetVersion:Ne,appMode:r.appMode||"deck",sessionId:"fbw-sess-"+Date.now()+"-"+Math.random().toString(36).slice(2,8),capturedAt:new Date().toISOString(),capturedAtMs:Date.now(),env:{userAgent:(navigator.userAgent||"").slice(0,200),locale:navigator.language||"",viewport:{w:window.innerWidth,h:window.innerHeight,dpr:window.devicePixelRatio||1},timezone:Intl.DateTimeFormat().resolvedOptions().timeZone},page:{url:location.href,title:document.title||null,pathname:location.pathname},source:{hint:location.pathname.replace(/^.*\//,""),matchBy:"pathname"},feedback:{global:e||null,perSection:o},edits:t,annotations:r.annotations.map(a=>{let i=a.type||"region",s={id:a.id,type:i,secId:a.secId,secLabel:a.secLabel,rectPct:a.rectPct};return i==="floating"?{...s,content:a.content||""}:{...s,content:a.content||"",note:a.note||a.text||"",image:a.image?{name:a.image.name,type:a.image.type,dataURL:a.image.dataURL}:null}}),attachments:n}}function Di(e){return(e||"session").replace(/[\\/:*?"<>|\s]+/g,"_").replace(/_+/g,"_").slice(0,80)}function qi(){let e=new Date,o=t=>String(t).padStart(2,"0");return`${e.getFullYear()}-${o(e.getMonth()+1)}-${o(e.getDate())}-${o(e.getHours())}${o(e.getMinutes())}${o(e.getSeconds())}`}function Ca(e){return Di(e||document.title)+"-"+qi()}async function Lt(e,o,t){let a=await(await e.getFileHandle(o,{create:!0})).createWritable();await a.write(t),await a.close()}async function Ct(e){return(await fetch(e)).blob()}function Mt(e){if(!e)return"png";let o=e.split("/")[1]||"png";return o==="jpeg"?"jpg":o.replace(/[^a-z0-9]/gi,"")}async function Ma(e,o){if(!Ae())return{ok:!1,fallback:"download",reason:"no-fs-access"};let t=await va(),n=!1;if(!t)try{t=await ka(),n=!0}catch(a){return{ok:!1,fallback:"download",reason:"picker-cancelled",error:a?.message}}try{let a=[];if(Array.isArray(e.annotations)){for(let c of e.annotations)if(c.image?.dataURL){let f=(c.id||"").split("-").pop().slice(0,8)||Math.random().toString(36).slice(2,10),d=`${o}-anno-${f}.${Mt(c.image.type)}`,p=await Ct(c.image.dataURL);await Lt(t,d,p),a.push(d),c.image={name:c.image.name,type:c.image.type,filename:d}}}if(Array.isArray(e.attachments))for(let c=0;c<e.attachments.length;c++){let f=e.attachments[c];if(f.dataURL){let d=`${o}-att-${String(c+1).padStart(2,"0")}.${Mt(f.type)}`,p=await Ct(f.dataURL);await Lt(t,d,p),a.push(d),e.attachments[c]={id:f.id,name:f.name,type:f.type,filename:d}}}let i=o+".json",s=o+".md";return await Lt(t,i,JSON.stringify(e,null,2)),await Lt(t,s,Ze()),{ok:!0,dirName:t.name,jsonName:i,mdName:s,firstPick:n,imageFiles:a}}catch(a){return{ok:!1,fallback:"download",reason:"write-failed",error:a?.message}}}function Ta(e,o){let t=new Blob([JSON.stringify(e,null,2)],{type:"application/json"});Fa(t,o+".json")}function Fa(e,o){let t=URL.createObjectURL(e),n=document.createElement("a");n.href=t,n.download=o,n.click(),URL.revokeObjectURL(t)}async function Qt(e,o){let t=new TextEncoder,n=[];if(Array.isArray(e.annotations)){for(let i of e.annotations)if(i.image?.dataURL){let s=(i.id||"").split("-").pop().slice(0,8)||Math.random().toString(36).slice(2,10),c=`${o}-anno-${s}.${Mt(i.image.type)}`,f=new Uint8Array(await(await Ct(i.image.dataURL)).arrayBuffer());n.push({name:c,data:f}),i.image={name:i.image.name,type:i.image.type,filename:c}}}if(Array.isArray(e.attachments))for(let i=0;i<e.attachments.length;i++){let s=e.attachments[i];if(s.dataURL){let c=`${o}-att-${String(i+1).padStart(2,"0")}.${Mt(s.type)}`,f=new Uint8Array(await(await Ct(s.dataURL)).arrayBuffer());n.push({name:c,data:f}),e.attachments[i]={id:s.id,name:s.name,type:s.type,filename:c}}}n.unshift({name:`${o}.json`,data:t.encode(JSON.stringify(e,null,2))},{name:`${o}.md`,data:t.encode(Ze())});let a=Ea(n);return Fa(a,o+".zip"),{ok:!0,fileCount:n.length}}async function Bi(){try{return typeof chrome>"u"||!chrome.storage?.sync?null:(await chrome.storage.sync.get({saveMode:"zip"})).saveMode}catch{return null}}function Pa(){let e=r.panel.querySelector('[data-fbw-action="save"]');e&&(e.addEventListener("click",async()=>{let o=La(),t=Ca();if(await Bi()!=="fs"||!Ae()){e.disabled=!0;try{await Qt(o,t),b(l("save.unsupported",{stem:t+".zip"}))}catch(i){Ta(o,t),b(l("save.failed",{reason:i?.message||"zip-failed"}))}finally{e.disabled=!1}return}e.disabled=!0;try{let i=await Ma(o,t);if(i.ok){let s=(i.imageFiles||[]).length,c=`/{json, md${s>0?` + ${s} imgs`:""}}`;b(l(i.firstPick?"save.first":"save.again",{dir:i.dirName,suffix:c}))}else i.reason==="picker-cancelled"?b(l("save.cancelled")):(await Qt(o,t),b(l("save.failed",{reason:i.reason||"unknown"})))}finally{e.disabled=!1}}),e.addEventListener("contextmenu",async o=>{o.preventDefault(),await Sa(),b(l("save.dirCleared"))}))}var eo="sourceDir";async function ji(e,o="readwrite"){if(!e?.queryPermission)return!1;let t={mode:o};try{if(await e.queryPermission(t)==="granted"||await e.requestPermission(t)==="granted")return!0}catch{}return!1}async function Ui(){let e=await ut(eo);return e&&await ji(e)?e:null}async function Wi(){let e=await window.showDirectoryPicker({id:"redline-source",mode:"readwrite",startIn:"desktop"});return await mt(eo,e),e}async function Aa(){await gt(eo)}async function Yi(e){let o=decodeURIComponent(location.pathname.split("/").pop()||"");if(o)try{return await e.getFileHandle(o)}catch{}let t=window.prompt(`\u5728\u9009\u5B9A\u76EE\u5F55\u4E0B\u627E\u4E0D\u5230 "${o}"
\u6E90 HTML \u6587\u4EF6\u540D\uFF08\u542B .html\uFF09`,o);if(!t)return null;try{return await e.getFileHandle(t)}catch{return null}}function Gi(e){let o=[];/\{\{[\s\S]+?\}\}|<%[\s\S]+?%>|<\?php|\{%[\s\S]+?%\}/.test(e)&&o.push("\u6A21\u677F\u8BED\u6CD5 (Mustache/EJS/PHP/Jinja)"),/__webpack_|window\.webpackChunk|window\.__NEXT_DATA__|window\.__remixContext/.test(e)&&o.push("build \u4EA7\u7269");let t=(e.match(/<link[^>]+rel=["']stylesheet/gi)||[]).length;return t>2&&o.push(`${t} \u4E2A\u5916\u90E8 stylesheet`),/<script[^>]+type=["']module["'][^>]*src=/i.test(e)&&o.push("JS module \u5F15\u7528"),o}function Xi(e){let o=0,t=0,n=[];return document.querySelectorAll("[data-fbw-edit-id]").forEach(a=>{let i=a.dataset.fbwEditId,s=r.originals.get(i),c=O(a);if(s===c)return;let f=Xe(a);if(!f){t++,n.push({kind:"text",desc:s.slice(0,30),reason:"no-path"});return}let d=Vt(e,f,W);if(!d.ok){t++,n.push({kind:"text",desc:s.slice(0,30),reason:d.reason});return}if(d.contentMismatch){t++,n.push({kind:"text",desc:s.slice(0,30),reason:"content-drift"});return}d.el.textContent=c,o++}),r.elementOps.forEach((a,i)=>{let s=Xe(i);if(!s){t+=a.ops.length,n.push({kind:"op",desc:a.descriptor,reason:"no-path"});return}let c=Vt(e,s,W);if(!c.ok){t+=a.ops.length,n.push({kind:"op",desc:a.descriptor,reason:c.reason});return}let f=c.el;a.ops.forEach(d=>{try{if(d.op==="note")return;if(d.op==="delete")f.remove();else if(d.op==="hide")f.style.visibility="hidden";else if(d.op==="move"){let p=(f.style.transform||"").replace(/translate\([^)]+\)/g,"").trim();f.style.transform=(p+` translate(${d.args.x}px, ${d.args.y}px)`).trim()}else if(d.op==="scale"){let p=(f.style.transform||"").replace(/scale\([^)]+\)/g,"").trim();f.style.transform=(p+` scale(${d.args.scale})`).trim()}else if(d.op==="rotate"){let p=(f.style.transform||"").replace(/rotate\([^)]+\)/g,"").trim();f.style.transform=(p+` rotate(${d.args.rotate}deg)`).trim()}else if(d.op==="font")f.style.fontFamily=d.args.family==="\u7CFB\u7EDF\u9ED8\u8BA4"?"":d.args.family;else if(d.op==="highlight")f.style.backgroundColor=d.args?.color||"";else{t++,n.push({kind:"op",desc:a.descriptor,op:d.op,reason:"unsupported"});return}o++}catch(p){t++,n.push({kind:"op",desc:a.descriptor,op:d.op,reason:p.message})}})}),["fbwEditId","fbwSecId","fbwSecLabel","fbwTx","fbwTy","fbwScale","fbwRotate","fbwOriginalSrc","fbwFontName","fbwHighlight","fbwOpDeleted","fbwOpHidden"].forEach(a=>{let i="[data-"+a.replace(/[A-Z]/g,s=>"-"+s.toLowerCase())+"]";e.querySelectorAll(i).forEach(s=>delete s.dataset[a])}),e.querySelectorAll(".fbw-changed, .fbw-selected").forEach(a=>{a.classList.remove("fbw-changed"),a.classList.remove("fbw-selected")}),{applied:o,failed:t,failures:n}}function Ki(){let e=new Date,o=t=>String(t).padStart(2,"0");return`${e.getFullYear()}${o(e.getMonth()+1)}${o(e.getDate())}-${o(e.getHours())}${o(e.getMinutes())}${o(e.getSeconds())}`}async function Vi(e,o,t){let a=`${o.replace(/\.html?$/i,"")}.bak.${Ki()}.html`,s=await(await e.getFileHandle(a,{create:!0})).createWritable();return await s.write(t),await s.close(),a}async function Na(){if(!Ae())return b(l("patch.unsupported")),{ok:!1,reason:"no-fs-access"};if(location.protocol!=="file:")return b(l("patch.notFile")),{ok:!1,reason:"not-file-protocol"};let e=await Ui();if(!e)try{e=await Wi()}catch{return b(l("patch.cancelled")),{ok:!1,reason:"picker-cancelled"}}let o=await Yi(e);if(!o)return b(l("patch.fileNotFound")),{ok:!1,reason:"file-not-found"};let t=await o.getFile(),n=await t.text(),a=Gi(n);if(a.length&&await At({title:l("warn.complex.title"),desc:l("warn.complex.desc",{flags:a.join(`
\xB7 `)}),choices:[{label:l("common.cancel"),value:"cancel"},{label:l("warn.complex.continue"),value:"continue",danger:!0}]})!=="continue")return b(l("patch.cancelled")),{ok:!1,reason:"user-cancelled-warning"};let i=new DOMParser().parseFromString(n,"text/html"),{applied:s,failed:c,failures:f}=Xi(i);if(s===0)return b(c===0?l("patch.noChanges"):l("patch.partialFail",{failed:c})),f.length&&console.warn("[fbw] failures:",f),{ok:!1,applied:s,failed:c,failures:f};let d="";try{d=await Vi(e,t.name,n)}catch(m){if(await At({title:l("patch.backupFail.title"),desc:l("patch.backupFail.desc",{reason:m.message}),choices:[{label:l("common.cancel"),value:"cancel"},{label:l("warn.complex.continue"),value:"continue",danger:!0}]})!=="continue")return b(l("patch.cancelled")),{ok:!1,reason:"backup-failed-user-cancelled"}}let p=`<!DOCTYPE html>
`+i.documentElement.outerHTML,g=await o.createWritable();await g.write(p),await g.close();let y=c>0?` / ${c} failed`:"",w=d?` \xB7 backup ${d}`:"";return b(l("patch.success",{file:t.name,applied:s,failedSuffix:y,backupSuffix:w})),f.length&&console.warn("[fbw] failures:",f),{ok:!0,applied:s,failed:c,failures:f,backupName:d,fileName:t.name}}function Tt(){let e=document.querySelector("deck-stage");if(!e||!e.shadowRoot){setTimeout(Tt,80);return}let o=e.shadowRoot.querySelector(".overlay");if(!o){setTimeout(Tt,80);return}if(o.querySelector("[data-fbw-btn]"))return;let t=o.querySelector(".reset"),n=document.createElement("span");n.className="divider";let a=document.createElement("button");a.className="btn",a.dataset.fbwBtn="edit",a.type="button",a.dataset.tooltip=l("overlay.edit"),a.setAttribute("aria-label",l("overlay.edit")),a.innerHTML=ot.replace('viewBox="0 0 24 24"','viewBox="0 0 24 24" width="14" height="14"'),a.addEventListener("click",u=>{u.stopPropagation(),Te()});let i=document.createElement("button");i.className="btn",i.dataset.fbwBtn="save-edit",i.type="button",i.dataset.tooltip=l("overlay.save"),i.setAttribute("aria-label",l("overlay.save")),i.innerHTML=co.replace('viewBox="0 0 24 24"','viewBox="0 0 24 24" width="14" height="14"')+'<span class="fbw-edit-count">0</span>',i.addEventListener("click",u=>{u.stopPropagation(),Na()}),i.addEventListener("contextmenu",async u=>{u.preventDefault(),u.stopPropagation(),await Aa(),b(l("patch.dirCleared"))}),r.saveEditBtn=i;let s=document.createElement("span");s.className="divider";let c=document.createElement("button");c.className="btn",c.dataset.fbwBtn="feedback",c.type="button",c.dataset.tooltip=l("overlay.feedback"),c.setAttribute("aria-label",l("overlay.feedback")),c.innerHTML=J.replace('viewBox="0 0 24 24"','viewBox="0 0 24 24" width="14" height="14"'),c.addEventListener("click",u=>{u.stopPropagation(),Je()});let f=document.createElement("span");f.className="divider";let d=document.createElement("button");d.className="btn",d.dataset.fbwBtn="marquee",d.type="button",d.dataset.tooltip=l("overlay.marquee"),d.setAttribute("aria-label",l("overlay.marquee")),d.innerHTML=at.replace('viewBox="0 0 24 24"','viewBox="0 0 24 24" width="14" height="14"'),d.addEventListener("click",u=>{u.stopPropagation(),Le()}),r.marqueeToggleBtn=d;let p=document.createElement("span");p.className="divider";let g=document.createElement("button");g.className="btn",g.dataset.fbwBtn="export",g.type="button",g.dataset.tooltip=l("overlay.export"),g.setAttribute("aria-label",l("overlay.export")),g.innerHTML=rt.replace('viewBox="0 0 24 24"','viewBox="0 0 24 24" width="14" height="14"'),g.addEventListener("click",u=>{if(u.stopPropagation(),u.shiftKey){se({image:!0},L);return}r.exportMenu?.classList.contains("fbw-on")?ve():Et()});let y=document.createElement("span");y.className="divider";let w=document.createElement("button");w.className="btn",w.dataset.fbwBtn="help",w.type="button",w.dataset.tooltip=l("overlay.help"),w.setAttribute("aria-label",l("overlay.help")),w.innerHTML=nt.replace('viewBox="0 0 24 24"','viewBox="0 0 24 24" width="14" height="14"'),w.addEventListener("click",u=>{u.stopPropagation(),He(w)}),r.helpToggleBtn=w,t?t.after(n,a,i,s,c,f,d,p,g,y,w):o.append(n,a,i,s,c,f,d,p,g,y,w),r.editToggleBtn=a,r.fbToggleBtn=c;let m=document.createElement("style");m.textContent=`
    .btn[data-fbw-btn].fbw-active {
      color: #dc3c3c !important;
    }
  `,e.shadowRoot.appendChild(m),document.body.classList.remove("fbw-no-overlay")}function Zi(){let e=document.createElement("style");e.id="fbw-styles",e.dataset.fbwInternal="1",e.textContent=io,document.head.appendChild(e)}function Ji(){let e=document.createElement("div");e.className="fbw-panel",e.id="fbwPanel",e.innerHTML=Jo(),r.panel=e;let o=document.createElement("div");o.className="fbw-confirm",o.innerHTML=Qo(),r.confirmDialog=o;let t=document.createElement("button");t.className="fbw-fab fbw-edit-fab",t.innerHTML=ot,t.dataset.tooltip=l("overlay.edit"),t.setAttribute("aria-label",l("overlay.edit")),r.editFab=t;let n=document.createElement("button");n.className="fbw-fab fbw-fb-fab",n.innerHTML=J,n.dataset.tooltip=l("overlay.feedback"),n.setAttribute("aria-label",l("overlay.feedback")),r.fbFab=n;let a=document.createElement("button");a.className="fbw-fab fbw-marquee-fab",a.innerHTML=at,a.dataset.tooltip=l("overlay.marquee"),a.setAttribute("aria-label",l("overlay.marquee")),r.marqueeFab=a;let i=document.createElement("button");i.className="fbw-fab fbw-undo-fab",i.innerHTML=Fo,i.dataset.tooltip=l("overlay.undo"),i.setAttribute("aria-label",l("overlay.undo")),i.style.display="none",r.undoFab=i;let s=document.createElement("button");s.className="fbw-fab fbw-redo-fab",s.innerHTML=Po,s.dataset.tooltip=l("overlay.redo"),s.setAttribute("aria-label",l("overlay.redo")),s.style.display="none",r.redoFab=s;let c=document.createElement("button");c.className="fbw-fab fbw-compare-fab",c.innerHTML=To,c.dataset.tooltip=l("overlay.compare"),c.setAttribute("aria-label",l("overlay.compare")),r.compareFab=c;let f=document.createElement("button");f.className="fbw-fab fbw-export-fab",f.innerHTML=rt,f.dataset.tooltip=l("overlay.export"),f.setAttribute("aria-label",l("overlay.export")),r.exportFab=f;let d=document.createElement("button");d.className="fbw-fab fbw-help-fab",d.innerHTML=nt,d.dataset.tooltip=l("overlay.help"),d.setAttribute("aria-label",l("overlay.help")),r.helpFab=d;let p=document.createElement("button");p.className="fbw-fab fbw-fold-fab",p.innerHTML=uo,p.dataset.tooltip=l("overlay.fold"),p.setAttribute("aria-label",l("overlay.fold")),r.foldFab=p;let g=document.createElement("div");g.className="fbw-help-popover",r.helpPopover=g;let y=document.createElement("div");y.className="fbw-elem-toolbar",y.innerHTML=en(),r.elemToolbar=y;let w=document.createElement("div");w.className="fbw-font-picker",r.fontPicker=w;let m=document.createElement("div");m.className="fbw-note-popover",m.innerHTML=tn(),r.notePopover=m;let u=document.createElement("div");u.className="fbw-marker-popover",r.markerPopover=u,r.resizeHandles=un();let k=Sn();r.tagPopover=k;let F=Mn();r.stylePanel=F;let x=ua();r.exportMenu=x;let h=document.createElement("div");h.className="fbw-fab-bar",h.appendChild(t),h.appendChild(n),h.appendChild(a),h.appendChild(f),h.appendChild(i),h.appendChild(s),h.appendChild(c);let B=document.createElement("span");B.className="fbw-fab-divider",h.appendChild(B),h.appendChild(d);let le=document.createElement("span");le.className="fbw-fab-divider fbw-fab-divider-2",h.appendChild(le),h.appendChild(p),r.fabBar=h,document.body.appendChild(e),document.body.appendChild(o),document.body.appendChild(h),document.body.appendChild(g),document.body.appendChild(y),document.body.appendChild(w),document.body.appendChild(m),document.body.appendChild(u),document.body.appendChild(k),document.body.appendChild(F),document.body.appendChild(x),document.body.appendChild(r.resizeHandles)}function Qi(){let e=!1,o=t=>t.target.dataset?.fbwEditId||t.target.matches&&t.target.matches("textarea, input")||t.target.closest&&t.target.closest(".fbw-panel, .fbw-confirm");document.addEventListener("keydown",t=>{if(!o(t)){if(t.key===" "){e=!0;return}if(e&&(t.key==="p"||t.key==="P")&&!t.shiftKey){t.preventDefault(),se({image:!1},L);return}if(t.shiftKey&&(t.key==="P"||t.key==="p")){t.preventDefault(),se({image:!0},L);return}if(e&&(t.key==="h"||t.key==="H")&&!t.shiftKey){t.preventDefault(),Fe({mode:"editable"});return}if(t.shiftKey&&(t.key==="H"||t.key==="h")){t.preventDefault(),Fe({mode:"readonly"});return}if((t.metaKey||t.ctrlKey)&&!t.shiftKey&&(t.key==="s"||t.key==="S")){t.preventDefault(),r.panel?.querySelector('[data-fbw-action="save"]')?.click();return}if((t.metaKey||t.ctrlKey)&&!t.shiftKey&&(t.key==="z"||t.key==="Z")){t.preventDefault(),_e();return}if((t.metaKey||t.ctrlKey)&&t.shiftKey&&(t.key==="z"||t.key==="Z")||(t.metaKey||t.ctrlKey)&&!t.shiftKey&&(t.key==="y"||t.key==="Y")){t.preventDefault(),_t();return}if((t.metaKey||t.ctrlKey)&&!t.shiftKey&&(t.key==="c"||t.key==="C")){if(window.getSelection?.()?.toString()||!r.selectedEl)return;t.preventDefault(),Qn();return}if((t.metaKey||t.ctrlKey)&&!t.shiftKey&&(t.key==="m"||t.key==="M")){t.preventDefault(),r.panel?.querySelector('[data-fbw-action="copy"]')?.click();return}t.ctrlKey||t.metaKey||t.altKey||e||(t.key==="e"||t.key==="E"?(t.preventDefault(),Te()):t.key==="f"||t.key==="F"?(t.preventDefault(),Je()):t.key==="m"||t.key==="M"?(t.preventDefault(),Le()):t.key==="a"||t.key==="A"?(t.preventDefault(),oa()):t.key==="o"||t.key==="O"?(t.preventDefault(),Gt()):t.key==="?"?(t.preventDefault(),He()):(t.key==="Delete"||t.key==="Backspace")&&r.selectedEl&&r.editMode&&(t.preventDefault(),r.elemToolbar?.querySelector('[data-op="delete"]')?.click()))}}),document.addEventListener("keyup",t=>{t.key===" "&&(e=!1),t.key==="Alt"&&(document.body.classList.remove("fbw-measuring"),ie())}),window.addEventListener("blur",()=>{e=!1,document.body.classList.remove("fbw-measuring"),ie()}),document.addEventListener("mousemove",t=>{if(!t.altKey||!r.selectedEl){document.body.classList.contains("fbw-measuring")&&(document.body.classList.remove("fbw-measuring"),ie());return}document.body.classList.add("fbw-measuring");let n=t.target;if(!n||n.closest(".fbw-panel, .fbw-fab, .fbw-fab-bar, .fbw-elem-toolbar, .fbw-confirm, .fbw-toast, .fbw-tooltip, .fbw-anno, .fbw-resize-handles, .fbw-measure-overlay, .fbw-help-popover, .fbw-note-popover, .fbw-marker-popover, .fbw-font-picker, .fbw-tag-popover")){ie();return}if(n===r.selectedEl||r.selectedEl.contains(n)){ie();return}aa(n)},!0)}function to(){r.undoFab&&(r.undoFab.style.display=sn()?"inline-flex":"none"),r.redoFab&&(r.redoFab.style.display=ln()?"inline-flex":"none")}function es(){r.editFab.addEventListener("click",()=>{if(document.body.classList.contains("fbw-fab-collapsed")){Oa(!1),r.editMode||Te();return}Te()}),r.exportFab.addEventListener("click",e=>{if(e.stopPropagation(),e.shiftKey){se({image:!0},L);return}r.exportMenu?.classList.contains("fbw-on")?ve():Et()}),r.marqueeFab.addEventListener("click",Le),r.undoFab.addEventListener("click",e=>{e.stopPropagation(),_e(),to()}),r.redoFab.addEventListener("click",e=>{e.stopPropagation(),_t(),to()}),r.compareFab.addEventListener("click",e=>{e.stopPropagation(),Gt()}),r.helpFab.addEventListener("click",e=>{e.stopPropagation(),He()}),r.foldFab.addEventListener("click",e=>{e.stopPropagation(),Oa(!0)})}var oo="fbw-fab-collapsed::"+(location.pathname||"/").slice(0,200);function Oa(e){document.body.classList.toggle("fbw-fab-collapsed",e);try{e?localStorage.setItem(oo,"1"):localStorage.removeItem(oo)}catch{}}function ts(){try{localStorage.getItem(oo)==="1"&&document.body.classList.add("fbw-fab-collapsed")}catch{}}function os(){let e=null;we(()=>{document.body.classList.add("fbw-scrolling"),e&&clearTimeout(e),e=setTimeout(()=>{document.body.classList.remove("fbw-scrolling")},800)});let o=220,t=260,n=-1,a=-1,i=0;window.addEventListener("mousemove",s=>{n=s.clientX,a=s.clientY,!i&&(i=requestAnimationFrame(()=>{i=0;let c=window.innerWidth-n<o&&window.innerHeight-a<t;document.body.classList.toggle("fbw-mouse-near-fab",c)}))},{passive:!0})}var $a=null;function za(){if(!r.fabBar)return;let e=r.fabBar.getBoundingClientRect(),o=e.left+e.width/2,t=e.top+e.height/2,n=r.fabBar.style.pointerEvents;r.fabBar.style.pointerEvents="none";let a=document.elementFromPoint(o,t)||document.body;r.fabBar.style.pointerEvents=n,a.closest&&a.closest(".fbw-panel, .fbw-tooltip, .fbw-toast, .fbw-confirm, .fbw-elem-toolbar, .fbw-resize-handles, .fbw-note-popover, .fbw-font-picker, .fbw-marker-popover, .fbw-help-popover, .fbw-anno")&&(a=document.body);let i=null,s=a;for(;s&&s!==document.documentElement;){let d=window.getComputedStyle(s).backgroundColor,p=d&&d.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)(?:,\s*([\d.]+))?\)/);if(p&&(p[4]!==void 0?parseFloat(p[4]):1)>.5){i={r:+p[1],g:+p[2],b:+p[3]};break}s=s.parentElement}if(!i){let p=window.getComputedStyle(document.documentElement).backgroundColor.match(/\d+/g);i=p?{r:+p[0],g:+p[1],b:+p[2]}:{r:255,g:255,b:255}}let f=.299*i.r+.587*i.g+.114*i.b<140;$a!==f&&($a=f,document.body.classList.toggle("fbw-dark-bg",f))}function ns(){let e=null,o=()=>{e&&clearTimeout(e),e=setTimeout(za,250)};setTimeout(za,80),we(o),de(o)}function Ra(){return document.querySelector("deck-stage")?"deck":document.querySelectorAll(W).length>0?"doc":"review"}function Ia(){let e=r.panel?.querySelector(".fbw-mode-chip");e&&(e.textContent=l("mode.chip."+(r.appMode||"doc")))}function as(){let e=()=>{let o=Ra();o!==r.appMode&&(document.body.classList.remove("fbw-mode-"+r.appMode),document.body.classList.add("fbw-mode-"+o),ce("appMode changed:",r.appMode,"\u2192",o),r.appMode=o,Ia())};window.addEventListener("popstate",e),["pushState","replaceState"].forEach(o=>{let t=history[o];t.__fbwPatched||(history[o]=function(...n){let a=t.apply(this,n);return setTimeout(e,0),a},history[o].__fbwPatched=!0)})}function no(){ce("init start"),Zi(),Ji(),r.appMode=Ra(),document.body.classList.add("fbw-mode-"+r.appMode),ce("appMode:",r.appMode),Ia(),as();let e=fa(),o=Ho();if(Zn(),sa(),jn(),Un(),hn(),Go(),fn(),vn(),Ln(),Nn(),ma(),Bn(),ha(),Pa(),ya(o),qn(),Qi(),r.onChangeHook=()=>{na(),to()},es(),os(),ns(),Ko(),Zo(),ts(),document.querySelector("deck-stage")?Tt():document.body.classList.add("fbw-no-overlay"),e||qo(),r.__rehydrateGlobalNote&&r.panel){let t=r.panel.querySelector("[data-fbw-global]");t&&(t.value=r.__rehydrateGlobalNote),delete r.__rehydrateGlobalNote}ne(),Rt(),P(E),Dn().catch(t=>ce("rehydrate failed:",t)),e&&pa(),ce("init done")}(function(){typeof window>"u"||window.__feedbackWidgetLoaded||(window.__feedbackWidgetLoaded=!0,window.__feedbackWidgetVersion=Ne,ce(`redline v${Ne} loaded \xB7 \u5173\u95ED\u65E5\u5FD7: window.__fbwDebug = false`),document.readyState==="loading"?document.addEventListener("DOMContentLoaded",no):no())})();})();
