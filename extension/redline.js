...
Direct source patching may break formatting or build artifacts. The skill workflow is recommended.`,"warn.complex.continue":"Continue anyway","clearAll.title":"Clear all feedback?","clearAll.desc":"All edits, per-page notes, global feedback, and screenshots will be removed. Local cache will also be cleared. This cannot be undone.","clearAll.confirm":"Clear all","common.cancel":"Cancel","pdf.vector.hint":'Vector PDF \xB7 Choose "Save as PDF" in the print dialog (Shift+P = long-image)',"pdf.loading":"Loading image library...","pdf.loadFailed":"Image library failed to load \xB7 Check your network","pdf.noSlides":"No slide elements found","pdf.progress":"Capturing {i} / {total}","pdf.saved":"Saved {file}","pdf.failed":"Export failed: {reason}","anno.action.note":"Feedback note (for agent only)","anno.action.image":"Add image","anno.action.delete":"Remove annotation","anno.placeholder.content":"Text to insert\u2026","anno.placeholder.note":"Note for agent\u2026","note.title":"Element feedback","note.placeholder":"Feedback for this element (delete / change / redraw / note for agent...)","tip.font":"Font (double-click element to edit text directly)","tip.tag":"Change tag (P / H1-H6)","tip.highlight":"Highlight (marker)","highlight.clear":"Clear highlight","op.highlight":"Highlighted","op.tag.done":"Tag changed to {tag}","op.tag.cleared":"Tag change cleared","toast.undo":"Undo","undo.done":"Undone","undo.empty":"Nothing to undo","undo.gone":"Element no longer in page","redo.done":"Redone","redo.empty":"Nothing to redo","redo.gone":"Element no longer in page","copy.descriptor.done":"Descriptor copied","copy.descriptor.empty":"No element selected","copy.descriptor.fail":"Copy failed","audit.on":"Audit \xB7 {n} change(s)","audit.empty":"Audit \xB7 nothing changed yet","audit.off":"Audit off","mode.chip.deck":"Deck","mode.chip.doc":"Doc","mode.chip.review":"Review","design.tag.spacing":"Spacing","design.tag.color":"Color","design.tag.typography":"Type","design.tag.layout":"Layout","design.tag.copy":"Copy","tip.replaceImg":"Replace image","tip.moveUp":"Move up 4px (Shift = 16px)","tip.moveDown":"Move down 4px (Shift = 16px)","tip.moveLeft":"Move left 4px (Shift = 16px)","tip.moveRight":"Move right 4px (Shift = 16px)","tip.zoomIn":"Zoom in 10%","tip.zoomOut":"Zoom out 10%","tip.note":"Write feedback for this element (no source change)","tip.link":"Edit hyperlink (href)","tip.hide":"Hide (placeholder kept)","tip.delete":"Delete (no placeholder)","tip.restore":"Restore all transforms","tip.close":"Deselect","tip.rotate":"Drag to rotate \xB7 Hold Shift to snap 15\xB0","tip.scale":"Drag to scale","overlay.edit":"Edit mode (E)","overlay.feedback":"Feedback panel (F)","overlay.export":"Export PDF \xB7 Shift+click = long-image","overlay.save":"Patch source HTML with all edits (auto-backup) \xB7 Right-click to reselect dir","overlay.marquee":"Marquee annotate: drag a box \u2192 text / image","overlay.help":"Shortcuts / Help","overlay.fold":"Collapse toolbar (click edit to expand + enter edit)","help.title":"Shortcuts","help.group.modes":"Modes","help.group.actions":"Actions","help.group.export":"Export","help.group.misc":"More","help.shortcut.edit":"Edit mode","help.shortcut.feedback":"Feedback panel","help.shortcut.marquee":"Marquee annotate","help.shortcut.cancel":"Cancel selection","help.shortcut.delete":"Delete selected element","help.shortcut.save":"Save feedback","help.shortcut.copy":"Copy feedback","help.shortcut.undo":"Undo","help.shortcut.redo":"Redo","help.shortcut.copyDescriptor":"Copy selected descriptor","help.shortcut.audit":"Audit \xB7 show all changes","help.shortcut.measure":"Measure \xB7 select + Alt + hover target","help.shortcut.pdfVector":"Vector PDF","help.shortcut.pdfImage":"Long-image PDF","help.shortcut.help":"Toggle help"}},Qt="fbw-locale",pt=null;function Bn(){try{let e=localStorage.getItem(Qt);return e&&le[e]?e:null}catch{return null}}function Hn(){if(typeof window<"u"&&window.__fbwLocale&&le[window.__fbwLocale])return window.__fbwLocale;let e=Bn();return e||((typeof navigator<"u"&&navigator.language||"en").toLowerCase().startsWith("zh")?"zh":"en")}function He(){return pt||(pt=Hn()),pt}function eo(){let o=He()==="zh"?"en":"zh";try{localStorage.setItem(Qt,o)}catch{}typeof location<"u"&&location.reload()}function l(e,o){let t=He(),a=(le[t]||le.en)[e];return a===void 0&&(a=le.en&&le.en[e]||e),o&&Object.keys(o).forEach(i=>{a=a.replace(new RegExp("\\{"+i+"\\}","g"),o[i])}),a}var jn={scroll:"window",resize:"window",mousemove:"document",mouseup:"document"},to=new Map;function Un(e){let o=to.get(e);if(o||(o={subs:new Set,attached:!1},to.set(e,o)),!o.attached){let t=jn[e]==="window"?window:document,a=e==="mousemove"||e==="mouseup"?{passive:!1,capture:!1}:{passive:!0,capture:!0};t.addEventListener(e,i=>{o.subs.forEach(s=>{try{s(i)}catch(c){console.warn("[fbw] event bus subscriber failed:",e,c)}})},a),o.attached=!0}return o}function je(e,o){let t=Un(e);return t.subs.add(o),()=>t.subs.delete(o)}var ne=e=>je("scroll",e),J=e=>je("resize",e),ae=e=>je("mousemove",e),re=e=>je("mouseup",e);var Q=null;function u(e,o){Q&&Q.parentNode&&Q.remove();let t=document.createElement("div");if(t.className="fbw-toast",o?.action){let n=document.createElement("span");n.textContent=e,t.appendChild(n);let a=document.createElement("button");a.className="fbw-toast-action",a.type="button",a.textContent=o.action.label,a.addEventListener("click",i=>{i.stopPropagation();try{o.action.onClick()}catch{}t.parentNode&&t.remove(),Q===t&&(Q=null)}),t.appendChild(a)}else t.textContent=e;Q=t,document.body.appendChild(t),setTimeout(()=>{t.parentNode&&t.remove(),Q===t&&(Q=null)},o?.duration??2400)}function Se(e,o){if(!e)return;e.textContent=o;let t=e.closest(".fbw-pill");t&&t.classList.toggle("fbw-has-count",Number(o)>0)}function T(e){if(!r.panel)return;let o=e?e().length:0;Se(r.panel.querySelector('[data-fbw-counter="edit"]'),o),Se(r.panel.querySelector('[data-fbw-counter="sec"]'),r.sectionFeedback.size),Se(r.panel.querySelector('[data-fbw-counter="att"]'),r.attachments.length);let t=r.panel.querySelector('[data-fbw-counter="ops"]');if(t&&Se(t,r.elementOps.size),r.saveEditBtn){let n=o+r.elementOps.size,a=r.saveEditBtn.querySelector(".fbw-edit-count");a&&(a.textContent=n),r.saveEditBtn.classList.toggle("fbw-has-changes",n>0)}if(r.panel){let n=r.panel.querySelector('[data-fbw-counter="sec"]');n&&Se(n,r.sectionFeedback.size+r.annotations.length)}if(typeof r.onChangeHook=="function")try{r.onChangeHook()}catch{}}function oo(e){return(e?e().length:0)+r.elementOps.size}function ft({title:e,desc:o,choices:t}){return new Promise(n=>{let a=document.createElement("div");a.className="fbw-confirm fbw-on",a.innerHTML=`
    ...
    `,a.querySelector("[data-fbw-c-title]").textContent=e,a.querySelector("[data-fbw-c-desc]").textContent=o;let i=a.querySelector("[data-fbw-c-actions]");t.forEach((d,f)=>{let g=document.createElement("button"),h="fbw-btn";d.primary&&(h+=" fbw-primary"),d.danger&&(h+=" fbw-danger"),(d.cancel||d.value==="cancel")&&(h+=" fbw-btn-cancel"),g.className=h,g.dataset.fbwChoiceIdx=String(f),g.textContent=d.label,i.appendChild(g)}),document.body.appendChild(a);let s=()=>t.find(d=>d.cancel||d.value==="cancel")?.value??null,c=d=>{a.classList.add("fbw-confirm-leave"),document.removeEventListener("keydown",p,!0),setTimeout(()=>{a.remove(),n(d)},140)};a.addEventListener("click",d=>{let f=d.target.closest("[data-fbw-choice-idx]");if(f){c(t[parseInt(f.dataset.fbwChoiceIdx,10)].value);return}d.target===a&&c(s())});let p=d=>{d.key==="Escape"&&(d.stopPropagation(),c(s()))};document.addEventListener("keydown",p,!0)})}var Wn=0,no=0;function Yn(e){return!(!e||e.closest(".fbw-panel, .fbw-fab, .fbw-toast, .fbw-confirm, script, style, button, [data-fbw-noedit]")||e.matches("button, br, img, svg, path, use, a[href]")||e.dataset.fbwEditId||!e.textContent.trim())}function z(e){return(e.textContent||"").replace(/^\s+|\s+$/g,"")}function ao(e){if(!Yn(e))return;let o="fbw-e-"+Wn++;e.dataset.fbwEditId=o,r.originals.set(o,z(e))}function ro(){let e=Array.from(document.querySelectorAll(R));return e.length===0&&(e=[document.querySelector('main, [role="main"], article')||document.body]),e.forEach(t=>{t.dataset.fbwSecId||(t.dataset.fbwSecId="fbw-sec-"+no++);let n=(t.dataset.screenLabel||t.dataset.fbwLabel||t.querySelector(".label")?.innerText||t.querySelector("h1, h2")?.innerText||(t===document.body||t.tagName==="MAIN"||t.tagName==="ARTICLE"?document.title||"Page":"Section "+no)).trim();t.dataset.fbwSecLabel=n.slice(0,80)}),document.querySelectorAll(Nt).forEach(ao),e.length===1&&e[0]===document.body||e.forEach(t=>{let n=document.createTreeWalker(t,NodeFilter.SHOW_ELEMENT,{acceptNode(i){return i.children.length>0||i.dataset&&i.dataset.fbwEditId?NodeFilter.FILTER_SKIP:NodeFilter.FILTER_ACCEPT}}),a;for(;a=n.nextNode();)ao(a)}),typeof window<"u"&&(window.__fbwOriginals=r.originals),e}function io(e){let t=e.closest("[data-fbw-sec-id]")?.dataset.fbwSecLabel||"?",n=e.tagName.toLowerCase(),a=[...e.classList].filter(s=>!s.startsWith("fbw-")).slice(0,2).join("."),i=(e.textContent||"").replace(/\s+/g," ").trim().slice(0,28);return`[${t}] \xB7 ${n}${a?"."+a:""}${i?` \xB7 "${i}"`:""}`}function Kn(){let e=0;return r.elementOps.forEach((o,t)=>{document.contains(t)||(r.elementOps.delete(t),e++)}),e}function M(e,o,t){r.elementOps.has(e)||r.elementOps.set(e,{ops:[],descriptor:io(e)});let n=r.elementOps.get(e);n.ops=n.ops.filter(i=>i.op!==o);let a={op:o};t!==void 0&&(a.args=t),r.appMode==="review"&&(a.proposed=!0),n.ops.push(a),T(k)}function Ue(e){r.elementOps.delete(e),T(k)}function so(e,o){let t=(o||"").trim();if(!r.elementOps.has(e)){if(!t)return;r.elementOps.set(e,{ops:[],descriptor:io(e)})}let n=r.elementOps.get(e);n.ops=n.ops.filter(a=>a.op!=="note"),t&&n.ops.push({op:"note",args:{text:t}}),n.ops.length===0&&r.elementOps.delete(e),T(k)}function Ee(e){let o=r.elementOps.get(e);return o&&o.ops.find(n=>n.op==="note")?.args?.text||""}function W(e){return{x:parseFloat(e.dataset.fbwTx||"0"),y:parseFloat(e.dataset.fbwTy||"0"),scale:parseFloat(e.dataset.fbwScale||"1"),rotate:parseFloat(e.dataset.fbwRotate||"0")}}function Y(e,o){e.dataset.fbwTx=o.x,e.dataset.fbwTy=o.y,e.dataset.fbwScale=o.scale,e.dataset.fbwRotate=o.rotate||0;let t=[];(o.x!==0||o.y!==0)&&t.push(`translate(${o.x}px, ${o.y}px)`),o.rotate&&t.push(`rotate(${o.rotate}deg)`),o.scale!==1&&t.push(`scale(${o.scale})`),e.style.transform=t.join(" ")}function k(){Kn();let e=[];return document.querySelectorAll("[data-fbw-edit-id][data-fbw-edited]").forEach(o=>{let t=o.dataset.fbwEditId,n=r.originals.get(t),a=z(o);if(n!==a){let i=o.closest("[data-fbw-sec-id]");e.push({id:t,before:n,after:a,section:i?.dataset.fbwSecLabel||"?"})}}),e}var bt=null;function lo(){try{let e=localStorage.getItem(ye);if(!e)return;let o=JSON.parse(e);o.globalNote&&r.panel&&(r.panel.querySelector("[data-fbw-global]").value=o.globalNote),o.sectionFeedback&&Object.entries(o.sectionFeedback).forEach(([a,i])=>r.sectionFeedback.set(a,i)),Array.isArray(o.attachments)&&o.attachments.forEach(a=>r.attachments.push(a)),Array.isArray(o.annotations)&&o.annotations.forEach(a=>r.annotations.push(a));let t={anno:r.annotations.length,sec:r.sectionFeedback.size,att:r.attachments.length,hasGlobal:!!(o.globalNote||"").trim()};if(t.anno+t.sec+t.att+(t.hasGlobal?1:0)>0&&o.savedAt&&Date.now()-o.savedAt>6e4){let s=[];t.anno&&s.push(l("restore.piece.anno",{count:t.anno})),t.sec&&s.push(l("restore.piece.sec",{count:t.sec})),t.att&&s.push(l("restore.piece.att",{count:t.att})),t.hasGlobal&&s.push(l("restore.piece.global")),setTimeout(()=>u(l("restore.hint",{pieces:s.join(" \xB7 ")})),600)}}catch{}}var ut=!1;function mt(){if(!r.panel)return;let e;try{let o={};document.querySelectorAll("[data-fbw-edit-id][data-fbw-edited]").forEach(a=>{let i=a.dataset.fbwEditId,s=z(a);r.originals.get(i)!==s&&(o[i]=s)});let t={};r.sectionFeedback.forEach((a,i)=>{t[i]=a});let n={globalNote:r.panel.querySelector("[data-fbw-global]").value,sectionFeedback:t,attachments:r.attachments.map(a=>({id:a.id,name:a.name,type:a.type})),annotations:r.annotations,edits:o,savedAt:Date.now()};e=JSON.stringify(n)}catch(o){console.warn("[fbw] saveState serialize failed:",o);return}try{localStorage.setItem(ye,e),ut=!1}catch(o){console.warn("[fbw] saveState quota exceeded, payload size:",e.length,o?.name),ut||(ut=!0,u(l("persist.quota")));try{let t=JSON.parse(e);t.annotations=(t.annotations||[]).map(n=>({...n,image:n.image?{...n.image,dataURL:""}:n.image})),localStorage.setItem(ye,JSON.stringify(t))}catch{}}}function L(){bt&&clearTimeout(bt),bt=setTimeout(mt,400)}function co(){try{localStorage.removeItem(ye)}catch{}}var We=[{key:"spacing",i18nKey:"design.tag.spacing"},{key:"color",i18nKey:"design.tag.color"},{key:"typography",i18nKey:"design.tag.typography"},{key:"layout",i18nKey:"design.tag.layout"},{key:"copy",i18nKey:"design.tag.copy"}];function Gn(e){let o=We.map(a=>({key:a.key,label:l(a.i18nKey)})),t=new Set,n=e;for(;;){let a=n.match(/^\s*\[([^\]]+)\]\s*/);if(!a)break;let i=a[1].trim(),s=o.find(c=>c.label===i);if(!s)break;t.add(s.key),n=n.slice(a[0].length)}return t}function ie(e,o){if(!e||!o)return;let t=Gn(o.value||"");e.querySelectorAll("[data-fbw-tag]").forEach(n=>{n.classList.toggle("fbw-on",t.has(n.dataset.fbwTag))})}function Xn(e,o){if(!e)return;let t=We.find(c=>c.key===o);if(!t)return;let n=l(t.i18nKey),a=`[${n}] `,i=e.value||"",s=new RegExp(`^\\s*\\[${n.replace(/[.*+?^${}()|[\\]\\\\]/g,"\\$&")}\\]\\s*`);s.test(i)?e.value=i.replace(s,""):e.value=a+i,e.dispatchEvent(new Event("input",{bubbles:!0})),e.focus()}function Ye(e,o){e&&e.addEventListener("click",t=>{let n=t.target.closest("[data-fbw-tag]");if(!n)return;t.preventDefault(),t.stopPropagation();let a=o();a&&(Xn(a,n.dataset.fbwTag),ie(e,a))})}function Vn(){return'<div class="fbw-design-tags" data-fbw-tags>'+We.map(e=>`<button class="fbw-design-tag" type="button" data-fbw-tag="${e.key}">${l(e.i18nKey)}</button>`).join("")+"</div>"}var I=null,q=null,ce=null,po=!1;function Zn(){po||(po=!0,ae(e=>{let o=ce;if(!o)return;let t=e.clientX-o.startX,n=e.clientY-o.startY,a=o.box;if(o.type==="move")a.style.left=o.origLeft+t+"px",a.style.top=o.origTop+n+"px";else if(o.type==="resize"){let{origLeft:s,origTop:c,origW:p,origH:d,corner:f}=o,g=s,h=c,w=p,b=d;if(f.includes("e")&&(w=Math.max(24,p+t)),f.includes("s")&&(b=Math.max(24,d+n)),f.includes("w")){let m=Math.max(24,p-t);g=s+(p-m),w=m}if(f.includes("n")){let m=Math.max(24,d-n);h=c+(d-m),b=m}a.style.left=g+"px",a.style.top=h+"px",a.style.width=w+"px",a.style.height=b+"px"}}),re(()=>{if(!ce)return;let e=ce.persist;if(ce=null,e)try{e()}catch{}}))}function Jn(){if(!r.editMode)return;r.editMode=!1,document.body.classList.remove("fbw-edit-mode"),document.querySelectorAll("[data-fbw-edit-id]").forEach(o=>{o.contentEditable="false",o.spellcheck=!1});let e=document.querySelector(".fbw-selected");e&&e.classList.remove("fbw-selected"),r.selectedEl=null,r.elemToolbar?.classList.remove("fbw-toolbar-open"),r.resizeHandles?.classList.remove("fbw-on"),r.fontPicker?.classList.remove("fbw-fp-open"),r.editToggleBtn&&r.editToggleBtn.classList.remove("fbw-active"),r.editFab?.classList.remove("fbw-active")}function de(){r.marqueeMode=!r.marqueeMode,r.marqueeMode&&r.editMode&&Jn(),document.body.classList.toggle("fbw-marquee-mode",r.marqueeMode),r.marqueeToggleBtn&&r.marqueeToggleBtn.classList.toggle("fbw-active",r.marqueeMode),r.marqueeFab&&r.marqueeFab.classList.toggle("fbw-active",r.marqueeMode),u(r.marqueeMode?l("marquee.on"):l("marquee.off"))}function bo(){r.marqueeMode&&(r.marqueeMode=!1,document.body.classList.remove("fbw-marquee-mode"),r.marqueeToggleBtn&&r.marqueeToggleBtn.classList.remove("fbw-active"))}function Qn(e){return e?!e.closest(".fbw-panel, .fbw-fab, .fbw-elem-toolbar, .fbw-confirm, .fbw-toast, .fbw-resize-handles, .fbw-anno, .fbw-marquee-drawing, .fbw-font-picker"):!1}function uo(e,o){let t=null;return document.querySelectorAll("[data-fbw-sec-id]").forEach(n=>{let a=n.getBoundingClientRect();e>=a.left&&e<=a.right&&o>=a.top&&o<=a.bottom&&(t=n)}),t||document.querySelector("[data-fbw-sec-id]")||document.querySelector(R)||document.body}function fo(e,o){if(!q||!I)return;let t=Math.min(I.startX,e),n=Math.min(I.startY,o),a=Math.abs(e-I.startX),i=Math.abs(o-I.startY);q.style.left=t+"px",q.style.top=n+"px",q.style.width=a+"px",q.style.height=i+"px"}function ea(e,o){let t=Math.min(I.startX,e),n=Math.min(I.startY,o),a=Math.abs(e-I.startX),i=Math.abs(o-I.startY);if(a<12||i<12)return;let s=uo(t+a/2,n+i/2),c=s?s.getBoundingClientRect():{left:0,top:0,width:1,height:1},p={id:"fbw-anno-"+Date.now()+"-"+Math.random().toString(36).slice(2,7),type:"region",secId:s?.dataset.fbwSecId||null,secLabel:s?.dataset.fbwSecLabel||null,rectPct:{x:(t-c.left)/c.width,y:(n-c.top)/c.height,w:a/c.width,h:i/c.height},content:"",note:"",image:null};p._autoEdit=!0,r.annotations.push(p),gt(p),L()}function ta(e,o){let t=uo(e,o);if(!t)return null;let n=t.getBoundingClientRect(),a={id:"fbw-anno-"+Date.now()+"-"+Math.random().toString(36).slice(2,7),type:"floating",secId:t.dataset.fbwSecId,secLabel:t.dataset.fbwSecLabel||null,rectPct:{x:(e-n.left)/n.width,y:(o-n.top)/n.height,w:0,h:0},content:"",_editing:!0};return r.annotations.push(a),gt(a),a}function Le(e){return String(e).replace(/[&<>"']/g,o=>({"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"})[o])}function gt(e){e.type||(e.type="region"),e.text&&!e.note&&(e.note=e.text,delete e.text);let o=document.querySelector(`[data-anno-id="${e.id}"]`);return o&&o.remove(),e.type==="floating"?oa(e):na(e)}function oa(e){let o=e.secId?document.querySelector(`[data-fbw-sec-id="${e.secId}"]`):null;if(!o)return;let t=o.getBoundingClientRect(),n=document.createElement("div");n.className="fbw-anno fbw-anno-floating",n.dataset.annoId=e.id,n.style.position="absolute",n.style.left=t.left+window.scrollX+e.rectPct.x*t.width+"px",n.style.top=t.top+window.scrollY+e.rectPct.y*t.height+"px",n.style.maxWidth=Math.max(180,t.width*.45)+"px";let a=()=>{r.annotations=r.annotations.filter(c=>c.id!==e.id),n.remove(),L()},i=()=>{if(e._editing=!1,!e.content||!e.content.trim()){a();return}n.innerHTML=`<div class="fbw-anno-floating-text">${Le(e.content).replace(/\n/g,"<br>")}</div><button class="fbw-anno-floating-x" data-action="delete" aria-label="delete">\xD7</button>`},s=()=>{e._editing=!0,n.innerHTML=`<textarea class="fbw-anno-floating-input" placeholder="${l("anno.placeholder.content")}"></textarea><button class="fbw-anno-floating-x" data-action="delete" aria-label="delete">\xD7</button>`;let c=n.querySelector("textarea");c.value=e.content||"",setTimeout(()=>{c.focus(),c.setSelectionRange(c.value.length,c.value.length)},0),["keydown","keyup","keypress","mousedown"].forEach(p=>c.addEventListener(p,d=>d.stopPropagation())),c.addEventListener("input",()=>{e.content=c.value,L()}),c.addEventListener("blur",i),c.addEventListener("keydown",p=>{p.key==="Escape"&&(p.preventDefault(),c.blur())})};n.addEventListener("click",c=>{c.target.closest('[data-action="delete"]')&&(c.stopPropagation(),a())}),n.addEventListener("dblclick",c=>{c.stopPropagation(),e._editing||s()}),document.body.appendChild(n),e._editing?s():i()}function na(e){let o=e.secId?document.querySelector(`[data-fbw-sec-id="${e.secId}"]`):null;if(!o)return;let t=o.getBoundingClientRect(),n=document.createElement("div");n.className="fbw-anno",n.dataset.annoId=e.id,n.style.position="absolute",n.style.left=t.left+window.scrollX+e.rectPct.x*t.width+"px",n.style.top=t.top+window.scrollY+e.rectPct.y*t.height+"px",n.style.width=e.rectPct.w*t.width+"px",n.style.height=e.rectPct.h*t.height+"px",n.innerHTML=`
  ...
  `,document.body.appendChild(n);let a=()=>{let p=e.secId?document.querySelector(`[data-fbw-sec-id="${e.secId}"]`):null;if(!p)return;let d=p.getBoundingClientRect(),f=d.left+window.scrollX,g=d.top+window.scrollY;e.rectPct.x=(parseFloat(n.style.left)-f)/d.width,e.rectPct.y=(parseFloat(n.style.top)-g)/d.height,e.rectPct.w=parseFloat(n.style.width)/d.width,e.rectPct.h=parseFloat(n.style.height)/d.height,L()};Zn(),n.addEventListener("mousedown",p=>{p.button===0&&(p.target.closest("[data-action], textarea, [data-handle]")||n.classList.contains("fbw-anno-editing")||(p.preventDefault(),ce={type:"move",box:n,persist:a,startX:p.clientX,startY:p.clientY,origLeft:parseFloat(n.style.left),origTop:parseFloat(n.style.top)}))}),n.querySelectorAll("[data-handle]").forEach(p=>{p.addEventListener("mousedown",d=>{d.button===0&&(d.preventDefault(),d.stopPropagation(),ce={type:"resize",box:n,persist:a,corner:p.dataset.handle,startX:d.clientX,startY:d.clientY,origLeft:parseFloat(n.style.left),origTop:parseFloat(n.style.top),origW:parseFloat(n.style.width),origH:parseFloat(n.style.height)})})});let i=()=>{let p=n.querySelector(".fbw-anno-content"),d="";e.image?.dataURL&&(d+=`<img class="fbw-anno-img" src="${e.image.dataURL}" alt="${Le(e.image.name||"")}">`),e.content&&(d+=`<div class="fbw-anno-text-content">${Le(e.content).replace(/\n/g,"<br>")}</div>`),e.note&&(d+=`<div class="fbw-anno-text-note">${Le(e.note).replace(/\n/g,"<br>")}</div>`),p.innerHTML=d;let f=!!e.image&&!e.content?.trim()&&!e.note?.trim();n.classList.toggle("fbw-anno-image-only",f)};i();let s=()=>{r.annotations=r.annotations.filter(p=>p.id!==e.id),n.remove(),L()},c=p=>{let d=p==="content"?"fbw-anno-textarea fbw-anno-textarea-content":"fbw-anno-textarea fbw-anno-textarea-note",f=p==="content"?l("anno.placeholder.content"):l("anno.placeholder.note"),g=n.querySelector(".fbw-anno-content"),h=p==="note"?Vn():"";g.innerHTML=`${h}<textarea class="${d}" placeholder="${f}">${Le(e[p]||"")}</textarea>`;let w=g.querySelector("textarea"),b=g.querySelector("[data-fbw-tags]");setTimeout(()=>{w.focus(),w.setSelectionRange(w.value.length,w.value.length)},0),["keydown","keyup","keypress","mousedown"].forEach(E=>w.addEventListener(E,j=>j.stopPropagation())),w.addEventListener("input",()=>{e[p]=w.value,L(),b&&ie(b,w)}),b&&(ie(b,w),Ye(b,()=>w)),n.classList.add("fbw-anno-editing");let m=!1,v=()=>{m||(m=!0,n.classList.remove("fbw-anno-editing"),i())},P=()=>{document.removeEventListener("mousedown",x,!0),v(),!e.content?.trim()&&!e.note?.trim()&&!e.image&&s()},x=E=>{n.contains(E.target)||P()};w.addEventListener("blur",v),w.addEventListener("keydown",E=>{E.key==="Escape"&&(E.preventDefault(),w.blur(),P())}),document.addEventListener("mousedown",x,!0)};n.addEventListener("dblclick",p=>{p.target.closest("[data-action]")||p.target.closest("textarea")||(p.stopPropagation(),p.preventDefault(),c("content"))}),n.addEventListener("click",p=>{let d=p.target.closest("[data-action]");if(!d)return;p.stopPropagation();let f=d.dataset.action;if(f==="content")c("content");else if(f==="note")c("note");else if(f==="image"){let g=document.createElement("input");g.type="file",g.accept="image/*",g.onchange=h=>{let w=h.target.files[0];if(!w)return;let b=new FileReader;b.onload=()=>{e.image={name:w.name,dataURL:b.result,type:w.type};let m=new Image;m.onload=()=>{let v=m.naturalWidth/m.naturalHeight,P=parseFloat(n.style.width),x=parseFloat(n.style.height),E=P/x,j=P,he=x;v>E?he=P/v:j=x*v,n.style.width=j+"px",n.style.height=he+"px",a(),i()},m.src=b.result,i(),L()},b.readAsDataURL(w)},g.click()}else f==="delete"&&s()}),e._autoEdit&&(delete e._autoEdit,setTimeout(()=>c("content"),0))}function wt(){document.querySelectorAll(".fbw-anno").forEach(e=>e.remove()),r.annotations.forEach(gt)}function mo(){document.addEventListener("mousedown",e=>{r.marqueeMode&&e.button===0&&Qn(e.target)&&(e.preventDefault(),e.stopPropagation(),I={startX:e.clientX,startY:e.clientY},q=document.createElement("div"),q.className="fbw-marquee-drawing",document.body.appendChild(q),fo(e.clientX,e.clientY))},!0),ae(e=>{I&&(e.preventDefault(),fo(e.clientX,e.clientY))}),re(e=>{I&&(ea(e.clientX,e.clientY),I=null,q&&(q.remove(),q=null))}),document.addEventListener("keydown",e=>{e.key==="Escape"&&r.marqueeMode&&!e.target.matches("textarea, input")&&(e.preventDefault(),de())}),J(()=>{wt()}),document.addEventListener("dblclick",e=>{r.editMode||r.marqueeMode||e.target.closest(".fbw-panel, .fbw-fab, .fbw-fab-bar, .fbw-elem-toolbar, .fbw-anno, .fbw-tooltip, .fbw-confirm, .fbw-help-popover, .fbw-note-popover, .fbw-marker-popover, .fbw-font-picker, .fbw-resize-handles, .fbw-marquee-drawing, .fbw-toast")||e.target.dataset?.fbwEditId||!(e.target.closest&&e.target.closest("[data-fbw-sec-id]"))||(e.preventDefault(),e.stopPropagation(),ta(e.clientX,e.clientY),L())})}var N=null,pe=null,Ke=null,aa=80;function ra(){return N||(N=document.createElement("div"),N.className="fbw-tooltip",document.body.appendChild(N),N)}function ia(e){let o=e.getBoundingClientRect(),t=N.getBoundingClientRect(),n=o.left+o.width/2-t.width/2,a=o.top-t.height-6;n<8&&(n=8),n+t.width>window.innerWidth-8&&(n=window.innerWidth-t.width-8),a<8&&(a=o.bottom+6),N.style.left=n+"px",N.style.top=a+"px"}function go(e,o){ra(),N.textContent=e,N.classList.add("fbw-on"),requestAnimationFrame(()=>ia(o))}function ht(){pe&&(clearTimeout(pe),pe=null),Ke=null,N&&N.classList.remove("fbw-on")}function wo(){document.addEventListener("mouseover",e=>{let o=e.target.closest&&e.target.closest("[data-tooltip]");if(!o||o===Ke)return;Ke=o;let t=o.dataset.tooltip;if(!t)return;pe&&clearTimeout(pe),N&&N.classList.contains("fbw-on")?go(t,o):pe=setTimeout(()=>go(t,o),aa)},!0),document.addEventListener("mouseout",e=>{let o=e.target.closest&&e.target.closest("[data-tooltip]");if(o&&o===Ke){if(e.relatedTarget&&o.contains(e.relatedTarget))return;ht()}},!0),document.addEventListener("mousedown",ht,!0),ne(ht)}function sa(){return typeof navigator<"u"&&/Mac|iPhone|iPad/.test(navigator.platform)?"\u2318":"Ctrl"}function O(e,o){return`<div class="fbw-help-row">${(Array.isArray(e)?e:[e]).map(a=>`<kbd>${a}</kbd>`).join("")} <span>${o}</span></div>`}function la(){let e=sa();return`
  ...
  `}function xo(){if(!r.helpPopover)return;let e=r.helpToggleBtn||r.helpFab;if(!e)return;let o=e.getBoundingClientRect(),t=r.helpPopover,n=t.getBoundingClientRect(),a=o.left+o.width/2-n.width/2,i=o.top-n.height-12;a<8&&(a=8),a+n.width>window.innerWidth-8&&(a=window.innerWidth-n.width-8),i<8&&(i=o.bottom+12),t.style.left=a+"px",t.style.top=i+"px"}function Ce(){let e=r.helpPopover;if(e){if(e.classList.contains("fbw-on")){e.classList.remove("fbw-on");return}e.innerHTML=la(),e.classList.add("fbw-on"),requestAnimationFrame(()=>xo())}}function ho(){r.helpPopover&&r.helpPopover.classList.remove("fbw-on")}function yo(){document.addEventListener("mousedown",e=>{let o=r.helpPopover;if(!o||!o.classList.contains("fbw-on")||e.target.closest('.fbw-help-popover, .fbw-help-fab, [data-fbw-btn="help"]'))return;let t=typeof e.composedPath=="function"?e.composedPath():[];t.some(n=>n&&n.dataset&&n.dataset.fbwBtn==="help")||t.some(n=>n&&n.classList&&n.classList.contains("fbw-help-popover"))||ho()},!0),document.addEventListener("keydown",e=>{e.key==="Escape"&&r.helpPopover?.classList.contains("fbw-on")&&ho()}),J(()=>{r.helpPopover?.classList.contains("fbw-on")&&xo()})}function vo(){let o=He()==="zh"?l("panel.localeName.en"):l("panel.localeName.zh");return`
    <div class="fbw-head">
      ...
      <span class="fbw-head-actions">
        ...
        <button class="fbw-icon-btn" data-fbw-pick data-tooltip="${l("panel.btn.pick.title")}">${Zt}</button>
        <button class="fbw-icon-btn" data-fbw-locale data-tooltip="${l("panel.btn.locale.title",{lang:o})}">${Dt}</button>
  ...
  `}function So(){return`
    ...
    <button data-op="tag" data-tooltip="${l("tip.tag")}" style="display:none;">${Vt}</button>
    <button data-op="highlight" data-tooltip="${l("tip.highlight")}">${_t}</button>
    <button data-op="replace-img" data-tooltip="${l("tip.replaceImg")}" style="display:none;">${Ht}</button>
    <span class="fbw-tb-divider"></span>
    <button data-op="move-up" data-tooltip="${l("tip.moveUp")}">${Ut}</button>
    <button data-op="move-down" data-tooltip="${l("tip.moveDown")}">${Wt}</button>
    <button data-op="move-left" data-tooltip="${l("tip.moveLeft")}">${Yt}</button>
    <button data-op="move-right" data-tooltip="${l("tip.moveRight")}">${Kt}</button>
    <span class="fbw-tb-divider"></span>
    <button data-op="zoom-in" data-tooltip="${l("tip.zoomIn")}">${Gt}</button>
    <button data-op="zoom-out" data-tooltip="${l("tip.zoomOut")}">${Xt}</button>
    <span class="fbw-tb-divider"></span>
    <button data-op="link" data-tooltip="${l("tip.link")}" style="display:none;">${Rt}</button>
    <button data-op="note" data-tooltip="${l("tip.note")}">${U}</button>
    <button data-op="hide" data-tooltip="${l("tip.hide")}" class="fbw-danger">${Bt}</button>
    <button data-op="delete" data-tooltip="${l("tip.delete")}" class="fbw-danger">${dt}</button>
    <button data-op="restore" data-tooltip="${l("tip.restore")}" class="fbw-restore">${jt}</button>
    <span class="fbw-tb-divider"></span>
  ...
  `}function ca(){return'<div class="fbw-design-tags" data-fbw-tags>'+[["spacing",l("design.tag.spacing")],["color",l("design.tag.color")],["typography",l("design.tag.typography")],["layout",l("design.tag.layout")],["copy",l("design.tag.copy")]].map(([e,o])=>`<button class="fbw-design-tag" type="button" data-fbw-tag="${e}">${o}</button>`).join("")+"</div>"}var fe=[],Ge=[],da=50;function xt(e){if(!e)return null;let o=r.elementOps.get(e);return{el:e,style:{transform:e.style.transform||"",fontFamily:e.style.fontFamily||"",backgroundColor:e.style.backgroundColor||"",backgroundImage:e.style.backgroundImage||"",visibility:e.style.visibility||""},dataset:{fbwTx:e.dataset.fbwTx??null,fbwTy:e.dataset.fbwTy??null,fbwScale:e.dataset.fbwScale??null,fbwRotate:e.dataset.fbwRotate??null,fbwOpHidden:e.dataset.fbwOpHidden??null,fbwOpDeleted:e.dataset.fbwOpDeleted??null,fbwHighlight:e.dataset.fbwHighlight??null,fbwOriginalSrc:e.dataset.fbwOriginalSrc??null},attrs:{tagAs:e.getAttribute("data-fbw-tag-as"),href:e.tagName==="A"?e.getAttribute("href"):void 0,src:e.tagName==="IMG"?e.getAttribute("src"):void 0},text:e.textContent,edited:e.dataset.fbwEdited??null,fbwChanged:e.classList.contains("fbw-changed"),opsClone:o?JSON.parse(JSON.stringify(o)):null}}function Lo(e){if(!e)return!1;let o=e.el;if(!o||!document.contains(o))return!1;for(let t of Object.keys(e.style))o.style[t]=e.style[t];for(let t of Object.keys(e.dataset))e.dataset[t]===null?delete o.dataset[t]:o.dataset[t]=e.dataset[t];return e.attrs.tagAs===null?o.removeAttribute("data-fbw-tag-as"):o.setAttribute("data-fbw-tag-as",e.attrs.tagAs),o.tagName==="A"&&e.attrs.href!==void 0&&(e.attrs.href===null?o.removeAttribute("href"):o.setAttribute("href",e.attrs.href)),o.tagName==="IMG"&&e.attrs.src!==void 0&&e.attrs.src!==null&&(o.src=e.attrs.src),typeof e.text=="string"&&o.textContent!==e.text&&(o.textContent=e.text),e.edited===null?delete o.dataset.fbwEdited:o.dataset.fbwEdited=e.edited,o.classList.toggle("fbw-changed",!!e.fbwChanged),e.opsClone?r.elementOps.set(o,e.opsClone):r.elementOps.delete(o),!0}function C(e){if(!e)return;let o=xt(e);o&&(fe.push(o),fe.length>da&&fe.shift(),Ge.length=0)}function Xe(){if(fe.length===0){u(l("undo.empty")||"\u6CA1\u6709\u53EF\u64A4\u9500\u7684\u64CD\u4F5C");return}let e=fe.pop(),o=xt(e.el);o&&Ge.push(o),Lo(e)?(T(k),L(),u(l("undo.done")||"\u5DF2\u64A4\u9500")):u(l("undo.gone")||"\u5143\u7D20\u5DF2\u4E0D\u5728\u9875\u9762")}function Co(){if(Ge.length===0){u(l("redo.empty")||"\u6CA1\u6709\u53EF\u91CD\u505A\u7684\u64CD\u4F5C");return}let e=Ge.pop(),o=xt(e.el);o&&fe.push(o),Lo(e)?(T(k),L(),u(l("redo.done")||"\u5DF2\u91CD\u505A")):u(l("redo.gone")||"\u5143\u7D20\u5DF2\u4E0D\u5728\u9875\u9762")}function $(e){u(e,{action:{label:l("toast.undo")||"\u64A4\u9500",onClick:Xe},duration:4e3})}var Te=null,se="unknown";async function pa(){if(se==="denied"||se==="unsupported")return[];if(typeof navigator>"u"||typeof navigator.queryLocalFonts!="function")return se="unsupported",[];try{let e=await navigator.queryLocalFonts();se="granted";let o=new Set,t=[];for(let n of e)o.has(n.family)||(o.add(n.family),t.push({name:n.family,family:`"${n.family.replace(/"/g,'\\"')}"`,source:"local"}));return t.sort((n,a)=>n.name.localeCompare(a.name)),t}catch(e){return se="denied",console.warn("[fbw] queryLocalFonts denied:",e?.name||"?","\xB7",e?.message||e),[]}}async function fa(){if(Te)return Te;let e={generic:[],document:[],local:[]};e.generic.push({name:"\u7CFB\u7EDF\u9ED8\u8BA4",family:"__inherit__",source:"inherit"}),e.generic.push({name:"system-ui",family:"system-ui, -apple-system, sans-serif",source:"generic"}),e.generic.push({name:"serif",family:"serif",source:"generic"}),e.generic.push({name:"sans-serif",family:"sans-serif",source:"generic"}),e.generic.push({name:"monospace",family:"ui-monospace, monospace",source:"generic"}),e.generic.push({name:"cursive",family:"cursive",source:"generic"});try{let t=new Set;document.fonts.forEach(n=>{let a=(n.family||"").replace(/^['"]|['"]$/g,"");a&&!t.has(a)&&(t.add(a),e.document.push({name:a,family:`"${a}"`,source:"document"}))})}catch{}e.local=await pa();let o=new Map;return[...e.generic,...e.document,...e.local].forEach(t=>{o.has(t.name)||o.set(t.name,t)}),Te=[...o.values()],Te}function To(e){return(e||"").replace(/^['"]|['"]$/g,"").trim().toLowerCase()}function ba(e){return e?window.getComputedStyle(e).fontFamily.split(",").map(To).filter(Boolean):[]}function ua(e){return e==="document"?l("font.group.document"):e==="local"?l("font.group.local"):l("font.group.generic")}async function ma(){let e=await fa(),o={inherit:0,generic:1,document:2,local:3},t=[...e].sort((s,c)=>(o[s.source]||0)-(o[c.source]||0)),n=null,a=t.map(s=>{let c="";return s.source!==n&&s.source!=="inherit"?(n=s.source,c=`<div class="fbw-fp-group">${ua(s.source)}</div>`):s.source==="inherit"&&(n="inherit"),c+`
    ...
    `}).join(""),i="";se==="denied"?i=`<div class="fbw-fp-hint">${l("font.localDenied")}</div>`:se==="unsupported"&&(i=`<div class="fbw-fp-hint">${l("font.localUnsupported")}</div>`),r.fontPicker.innerHTML=a+i}function Ve(){let e=r.elemToolbar.getBoundingClientRect(),o=e.bottom+6,t=e.left;t+240>window.innerWidth-8&&(t=window.innerWidth-248),t<8&&(t=8),o+360>window.innerHeight-8&&(o=Math.max(8,e.top-366)),r.fontPicker.style.top=o+"px",r.fontPicker.style.left=t+"px"}async function Mo(){r.fontPicker.classList.add("fbw-fp-open"),Ve(),!Te&&typeof navigator<"u"&&"queryLocalFonts"in navigator&&(r.fontPicker.innerHTML=`<div class="fbw-fp-loading">${l("font.loading")}</div>`),await ma(),Ve();let e=ba(window.__fbwSelEl);r.fontPicker.querySelectorAll(".fbw-fp-item").forEach(o=>{if(o.dataset.fpFamily==="__inherit__")return;let t=To(o.dataset.fpName);e.includes(t)&&o.classList.add("fbw-fp-active")})}function K(){r.fontPicker.classList.remove("fbw-fp-open")}function Po(){r.fontPicker.addEventListener("click",e=>{let o=e.target.closest(".fbw-fp-item");if(!o||!r.selectedEl)return;e.stopPropagation();let t=o.dataset.fpFamily.replace(/&quot;/g,'"'),n=o.dataset.fpName,a=r.selectedEl;C(a),t==="__inherit__"?(a.style.fontFamily="",delete a.dataset.fbwFontName,M(a,"font",{family:"\u7CFB\u7EDF\u9ED8\u8BA4"})):(a.style.fontFamily=t,a.dataset.fbwFontName=n,M(a,"font",{family:n})),$(l("op.font",{name:n})),K()}),document.addEventListener("mousedown",e=>{r.fontPicker.classList.contains("fbw-fp-open")&&(e.target.closest(".fbw-font-picker, .fbw-elem-toolbar")||K())},!0)}var Ao=["tl","tr","br","bl"];function No(){let e=document.createElement("div");return e.className="fbw-resize-handles",Ao.forEach(o=>{let t=document.createElement("div");t.className="fbw-rotate-zone",t.dataset.handle=o,t.title="\u62D6\u52A8\u65CB\u8F6C \xB7 \u6309\u4F4F Shift \u5438\u9644 15\xB0",e.appendChild(t)}),Ao.forEach(o=>{let t=document.createElement("div");t.className="fbw-resize-handle",t.dataset.handle=o,t.title="\u62D6\u52A8\u7F29\u653E",e.appendChild(t)}),e}function Oo(e){!r.resizeHandles||!e||(r.resizeHandles.classList.add("fbw-on"),Me(e))}function $o(){r.resizeHandles&&r.resizeHandles.classList.remove("fbw-on")}function Me(e){if(!r.resizeHandles||!e)return;let o=e.getBoundingClientRect();r.resizeHandles.style.top=o.top+"px",r.resizeHandles.style.left=o.left+"px",r.resizeHandles.style.width=o.width+"px",r.resizeHandles.style.height=o.height+"px"}var y=null,ee=null,zo=[.5,.75,1,1.25,1.5,2],Io=[0,45,90,135,180,-45,-90,-135];function ga(){return ee||(ee=document.createElement("div"),ee.className="fbw-drag-readout",document.body.appendChild(ee),ee)}function Fo(e,o,t){let n=ga();n.textContent=e,n.style.left=o+14+"px",n.style.top=t+14+"px",n.classList.add("fbw-on")}function wa(){ee&&ee.classList.remove("fbw-on")}function ha(e){let o=zo.find(t=>Math.abs(e-t)<.03);return o!==void 0?`${o.toFixed(2)}\xD7 \u2713`:`${e.toFixed(2)}\xD7`}function xa(e){let o=Math.round(e),t=Io.find(n=>Math.abs(o-n)<=2);return t!==void 0?`${t}\xB0 \u2713`:`${o}\xB0`}function ya(e){if(!r.elemToolbar)return;let o=e.getBoundingClientRect(),t=r.elemToolbar.getBoundingClientRect(),n=o.top-t.height-24,a=o.left;n<8&&(n=o.bottom+24),a+t.width>window.innerWidth-8&&(a=window.innerWidth-t.width-8),a<8&&(a=8),r.elemToolbar.style.top=n+"px",r.elemToolbar.style.left=a+"px"}function Do(){r.resizeHandles.addEventListener("mousedown",e=>{if(!r.editMode||!r.selectedEl||e.button!==0)return;let o=e.target.closest(".fbw-rotate-zone"),t=e.target.closest(".fbw-resize-handle");if(!o&&!t)return;e.preventDefault(),e.stopPropagation();let n=r.selectedEl,a=n.getBoundingClientRect(),i=a.left+a.width/2,s=a.top+a.height/2,c=W(n);if(C(n),t){let p=Math.hypot(e.clientX-i,e.clientY-s);y={mode:"scale",el:n,cx:i,cy:s,startDist:Math.max(p,1),baseScale:c.scale,baseX:c.x,baseY:c.y,baseRotate:c.rotate||0},document.body.style.cursor=window.getComputedStyle(t).cursor}else y={mode:"rotate",el:n,cx:i,cy:s,baseRotate:c.rotate||0,startAngle:Math.atan2(e.clientY-s,e.clientX-i)*180/Math.PI},document.body.style.cursor="grabbing"}),ae(e=>{if(y){if(e.preventDefault(),y.mode==="scale"){let t=Math.hypot(e.clientX-y.cx,e.clientY-y.cy)/y.startDist,n=Math.max(.2,Math.min(3,y.baseScale*t));Y(y.el,{x:y.baseX,y:y.baseY,scale:n,rotate:y.baseRotate}),Fo(ha(n),e.clientX,e.clientY)}else if(y.mode==="rotate"){let o=Math.atan2(e.clientY-y.cy,e.clientX-y.cx)*180/Math.PI,t=y.baseRotate+(o-y.startAngle);for(;t>180;)t-=360;for(;t<=-180;)t+=360;e.shiftKey&&(t=Math.round(t/15)*15);let n=W(y.el);Y(y.el,{...n,rotate:t}),Fo(xa(t),e.clientX,e.clientY)}Me(y.el),ya(y.el)}}),re(()=>{if(!y)return;let e=W(y.el);if(y.mode==="scale"){let o=zo.find(n=>Math.abs(e.scale-n)<.03),t=o!==void 0?o:e.scale;o!==void 0&&Y(y.el,{...e,scale:t}),M(y.el,"scale",{scale:parseFloat(t.toFixed(3))})}else if(y.mode==="rotate"){let o=Io.find(n=>Math.abs(e.rotate-n)<=2),t=o!==void 0?o:e.rotate;o!==void 0&&Y(y.el,{...e,rotate:t}),M(y.el,"rotate",{rotate:parseFloat(t.toFixed(2))})}wa(),Me(y.el),y=null,document.body.style.cursor=""})}var va=[{name:"yellow",value:"rgba(255, 235, 80, 0.55)",swatch:"#ffeb50",label:"\u9EC4"},{name:"green",value:"rgba(140, 220, 130, 0.55)",swatch:"#8cdc82",label:"\u7EFF"},{name:"blue",value:"rgba(150, 200, 255, 0.55)",swatch:"#96c8ff",label:"\u84DD"},{name:"pink",value:"rgba(255, 170, 200, 0.55)",swatch:"#ffaac8",label:"\u7C89"},{name:"orange",value:"rgba(255, 200, 130, 0.55)",swatch:"#ffc882",label:"\u6A59"}];function ka(){return`
  ...
  `}var Pe=null,yt=null;function Sa(e){let o=window.getSelection();if(!o||o.rangeCount===0)return null;let t=o.getRangeAt(0);return t.collapsed||!e.contains(t.commonAncestorContainer)?null:t.cloneRange()}function Ea(e,o,t){let n=document.createElement("span");n.className="fbw-hl",n.dataset.fbwHighlight=t||"1",n.style.background=o,n.style.borderRadius="2px",n.style.padding="0 1px";try{return e.surroundContents(n),n}catch{let a=e.extractContents();return n.appendChild(a),e.insertNode(n),n}}function La(){let e=r.elemToolbar?.querySelector('[data-op="highlight"]');if(!e||!r.markerPopover)return;let o=r.markerPopover;o.style.visibility="hidden",o.style.top="0px",o.style.left="0px";let t=o.offsetHeight||80,n=o.offsetWidth||200,a=e.getBoundingClientRect(),i=r.elemToolbar.getBoundingClientRect(),s=i.right+8,c=i.top;s+n>window.innerWidth-8&&(s=i.left-n-8),s<8&&(s=Math.max(8,Math.min(a.left,window.innerWidth-n-8)),c=i.top-t-8,c<8&&(c=i.bottom+8)),o.style.top=c+"px",o.style.left=s+"px",o.style.visibility=""}function qo(){r.markerPopover&&(Pe=r.selectedEl||null,yt=Pe?Sa(Pe):null,r.markerPopover.innerHTML=ka(),r.markerPopover.classList.add("fbw-on"),La())}function B(){r.markerPopover&&r.markerPopover.classList.remove("fbw-on"),Pe=null,yt=null}function Ca(e){e.querySelectorAll(".fbw-hl").forEach(o=>{let t=o.parentNode;for(;o.firstChild;)t.insertBefore(o.firstChild,o);t.removeChild(o),t.normalize?.()})}function Ro(e,o,t,n){e&&(C(e),o?(n?(Ea(n,o,t),window.getSelection()?.removeAllRanges()):(e.style.background=o,e.dataset.fbwHighlight=t||"1"),M(e,"highlight",{color:o,name:t,scope:n?"range":"element"}),$(l("op.highlight")+(t?": "+t:""))):(Ca(e),e.style.background="",delete e.dataset.fbwHighlight,M(e,"highlight",{color:null}),$(l("highlight.clear"))))}function _o(){let e=r.markerPopover;e&&(e.addEventListener("click",o=>{o.stopPropagation();let t=Pe||r.selectedEl;if(!t)return;let n=yt,a=o.target.closest("[data-color]");if(a){Ro(t,a.dataset.color,a.dataset.name,n),B();return}o.target.closest("[data-clear]")&&(Ro(t,"",null,null),B())}),document.addEventListener("mousedown",o=>{e.classList.contains("fbw-on")&&(o.target.closest('.fbw-marker-popover, [data-op="highlight"], .fbw-elem-toolbar')||B())},!0))}var Bo=["p","h1","h2","h3","h4","h5","h6"],A=null,H=null;function Ho(){return A=document.createElement("div"),A.className="fbw-tag-popover",A.innerHTML=Bo.map(e=>`<button data-fbw-tag="${e}">${e.toUpperCase()}</button>`).join(""),A}function Ta(e){return(e.getAttribute("data-fbw-tag-as")||e.tagName).toLowerCase()}function vt(e){if(!A)return;let o=Ta(e);A.querySelectorAll("[data-fbw-tag]").forEach(t=>{t.classList.toggle("fbw-active",t.dataset.fbwTag===o)})}function jo(){if(!A||!r.selectedEl)return;let e=r.elemToolbar.getBoundingClientRect();A.style.top=e.bottom+6+"px",A.style.left=e.left+24+"px",A.classList.add("fbw-on"),H=r.selectedEl.getAttribute("data-fbw-tag-as"),vt(r.selectedEl)}function _(){A&&(A.classList.remove("fbw-on"),r.selectedEl&&H!==void 0&&(H===null?r.selectedEl.removeAttribute("data-fbw-tag-as"):r.selectedEl.setAttribute("data-fbw-tag-as",H),H=null))}function Ma(e){r.selectedEl&&(e===r.selectedEl.tagName.toLowerCase()?r.selectedEl.removeAttribute("data-fbw-tag-as"):r.selectedEl.setAttribute("data-fbw-tag-as",e))}function Pa(e,o){if(!e||!Bo.includes(o))return;let t=e.tagName.toLowerCase(),n=H;if(H=null,o===t&&n==null){_();return}if(o===t){C(e),e.removeAttribute("data-fbw-tag-as");let a=r.elementOps.get(e);a&&(a.ops=a.ops.filter(i=>i.op!=="tag"),a.ops.length||Ue(e)),$(l("op.tag.cleared")||"\u5DF2\u64A4\u9500\u6807\u7B7E\u53D8\u66F4"),_();return}C(e),e.setAttribute("data-fbw-tag-as",o),M(e,"tag",{from:t,to:o}),$(l("op.tag.done",{tag:o.toUpperCase()})||`\u6807\u7B7E\u53D8\u66F4\u4E3A ${o.toUpperCase()}`),_()}function Uo(){A&&(A.addEventListener("click",e=>{let o=e.target.closest("[data-fbw-tag]");!o||!r.selectedEl||(e.stopPropagation(),Pa(r.selectedEl,o.dataset.fbwTag))}),A.addEventListener("mouseover",e=>{let o=e.target.closest("[data-fbw-tag]");o&&(Ma(o.dataset.fbwTag),vt(r.selectedEl))}),A.addEventListener("mouseleave",()=>{r.selectedEl&&(H===null?r.selectedEl.removeAttribute("data-fbw-tag-as"):H!==void 0&&r.selectedEl.setAttribute("data-fbw-tag-as",H),vt(r.selectedEl))}),document.addEventListener("mousedown",e=>{A.classList.contains("fbw-on")&&(e.target.closest('.fbw-tag-popover, [data-op="tag"]')||_())},!0))}var Aa="fbw",Ae="kv",Fe="blobs";var Ze=null;function kt(){return Ze||(Ze=new Promise((e,o)=>{let t=indexedDB.open(Aa,2);t.onupgradeneeded=n=>{let a=t.result;a.objectStoreNames.contains(Ae)||a.createObjectStore(Ae),a.objectStoreNames.contains(Fe)||a.createObjectStore(Fe)},t.onsuccess=()=>e(t.result),t.onerror=()=>o(t.error)}),Ze)}function Wo(e,o){return kt().then(t=>new Promise((n,a)=>{let s=t.transaction(e,"readonly").objectStore(e).get(o);s.onsuccess=()=>n(s.result),s.onerror=()=>a(s.error)}))}function Yo(e,o,t){return kt().then(n=>new Promise((a,i)=>{let s=n.transaction(e,"readwrite");s.objectStore(e).put(t,o),s.oncomplete=()=>a(),s.onerror=()=>i(s.error)}))}function Ko(e,o){return kt().then(t=>new Promise((n,a)=>{let i=t.transaction(e,"readwrite");i.objectStore(e).delete(o),i.oncomplete=()=>n(),i.onerror=()=>a(i.error)}))}var Je=e=>Wo(Ae,e),Qe=(e,o)=>Yo(Ae,e,o),et=e=>Ko(Ae,e),Go=e=>Wo(Fe,e),Xo=(e,o)=>Yo(Fe,e,o),Vo=e=>Ko(Fe,e);function Zo(e){return new Promise((o,t)=>{let n=new FileReader;n.onload=()=>o(n.result),n.onerror=t,n.readAsDataURL(e)})}function tt(e){if(!e||!e.type?.startsWith("image/"))return;let o="fbw-att-"+Date.now()+"-"+Math.random().toString(36).slice(2,7),t=e.name||"\u622A\u56FE-"+new Date().toISOString().slice(11,19).replace(/:/g,"")+".png";Zo(e).then(n=>{r.attachments.push({id:o,name:t,dataURL:n,type:e.type}),G(),L(),u(l("panel.attachment.added",{count:r.attachments.length})),Xo(o,e).catch(a=>console.warn("[fbw] idb put blob failed:",a))}).catch(n=>console.warn("[fbw] read blob failed:",n))}async function Jo(){let e=0;for(let o of r.attachments)if(!o.dataURL)try{let t=await Go(o.id);t&&(o.dataURL=await Zo(t),e++)}catch{}e>0&&G()}function G(){let e=r.panel.querySelector("[data-fbw-attachments]");e.innerHTML="",r.attachments.forEach((o,t)=>{let n=document.createElement("div");n.className="fbw-thumb";let a=document.createElement("img");a.src=o.dataURL;let i=document.createElement("button");i.className="fbw-thumb-x",i.innerHTML="\xD7",i.type="button",i.addEventListener("click",s=>{s.stopPropagation();let c=r.attachments.splice(t,1)[0];G(),T(k),L(),c?.id&&Vo(c.id).catch(()=>{})}),n.appendChild(a),n.appendChild(i),e.appendChild(n)}),T(k)}function Qo(){let e=t=>{let n=t.clipboardData?.items;if(!n)return;let a=!1;for(let i of n)if(i.type.startsWith("image/")){let s=i.getAsFile();s&&(tt(s),a=!0)}a&&t.preventDefault()},o=r.panel.querySelector("[data-fbw-global]");["keydown","keyup","keypress"].forEach(t=>o.addEventListener(t,n=>n.stopPropagation())),o.addEventListener("paste",e),r.panel.addEventListener("paste",e),r.panel.addEventListener("dragover",t=>{t.preventDefault(),t.dataTransfer?.types?.includes("Files")&&r.panel.classList.add("fbw-drag-over")}),r.panel.addEventListener("dragleave",t=>{(t.target===r.panel||!r.panel.contains(t.relatedTarget))&&r.panel.classList.remove("fbw-drag-over")}),r.panel.addEventListener("drop",t=>{t.preventDefault(),r.panel.classList.remove("fbw-drag-over"),Array.from(t.dataTransfer?.files||[]).filter(a=>a.type.startsWith("image/")).forEach(tt)})}function Fa(e){let o=r.elemToolbar?.querySelector('[data-op="note"]');o&&o.classList.toggle("fbw-has-note",!!Ee(e))}function Na(){if(!r.notePopover)return;let e=r.elemToolbar.querySelector('[data-op="note"]');if(!e)return;let o=e.getBoundingClientRect(),t=r.notePopover,n=o.bottom+6,a=o.left;a+300>window.innerWidth-8&&(a=window.innerWidth-308),a<8&&(a=8),n+180>window.innerHeight-8&&(n=Math.max(8,o.top-186)),t.style.top=n+"px",t.style.left=a+"px"}function Oa(e){let o=r.notePopover;if(!o)return;let t=o.querySelector("[data-fbw-note-text]");t.value=Ee(e),o.classList.add("fbw-on"),Na(),ie(o.querySelector("[data-fbw-tags]"),t),setTimeout(()=>t.focus(),0)}function oe(){r.notePopover&&r.notePopover.classList.remove("fbw-on")}function en(){let e=r.notePopover;if(!e)return;let o=e.querySelector("[data-fbw-note-text]");["keydown","keyup","keypress"].forEach(t=>o.addEventListener(t,n=>n.stopPropagation())),o.addEventListener("input",()=>{r.selectedEl&&(so(r.selectedEl,o.value),Fa(r.selectedEl),ie(e.querySelector("[data-fbw-tags]"),o))}),Ye(e.querySelector("[data-fbw-tags]"),()=>o),e.querySelector("[data-fbw-note-close]").addEventListener("click",t=>{t.stopPropagation(),oe()}),document.addEventListener("mousedown",t=>{e.classList.contains("fbw-on")&&(t.target.closest(".fbw-note-popover, .fbw-elem-toolbar")||oe())},!0)}function tn(){r.elemToolbar.addEventListener("click",e=>{let o=e.target.closest("[data-op]");if(!o||!r.selectedEl)return;e.stopPropagation();let t=o.dataset.op,n=r.selectedEl;if(t==="close"){F();return}if(t==="delete"){C(n),M(n,"delete"),n.dataset.fbwOpDeleted="1",$(l("op.delete"));return}if(t==="hide"){C(n),M(n,"hide"),n.dataset.fbwOpHidden="1",$(l("op.hide"));return}if(t==="link"){if(n.tagName!=="A")return;let a=n.getAttribute("href")||"",i=prompt(l("op.link.prompt")||"\u6539\u94FE\u63A5 (href)\uFF1A",a);if(i==null)return;let s=i.trim();if(s===a)return;C(n),n.setAttribute("href",s),M(n,"href",{before:a,after:s}),$(l("op.link.done")||`\u94FE\u63A5\u5DF2\u6539\uFF1A${s.slice(0,40)}${s.length>40?"\u2026":""}`);return}if(t==="restore"){C(n),delete n.dataset.fbwOpDeleted,delete n.dataset.fbwOpHidden,delete n.dataset.fbwTx,delete n.dataset.fbwTy,delete n.dataset.fbwScale,delete n.dataset.fbwRotate,delete n.dataset.fbwHighlight,n.removeAttribute("data-fbw-tag-as"),n.style.transform="",n.style.backgroundImage="",n.style.backgroundColor="",n.tagName==="IMG"&&n.dataset.fbwOriginalSrc&&(n.src=n.dataset.fbwOriginalSrc,delete n.dataset.fbwOriginalSrc),Ue(n),$(l("op.restore")),be(n);return}if(t.startsWith("move-")){C(n);let a=t.slice(5),i=W(n),s=e.shiftKey?16:4;a==="up"&&(i.y-=s),a==="down"&&(i.y+=s),a==="left"&&(i.x-=s),a==="right"&&(i.x+=s),Y(n,i),M(n,"move",{x:i.x,y:i.y}),be(n);return}if(t==="zoom-in"||t==="zoom-out"){C(n);let a=W(n),i=t==="zoom-in"?1.1:1/1.1;a.scale=Math.max(.2,Math.min(3,a.scale*i)),Y(n,a),M(n,"scale",{scale:parseFloat(a.scale.toFixed(3))}),be(n);return}if(t==="font"){window.__fbwSelEl=n,r.fontPicker.classList.contains("fbw-fp-open")?K():(B(),oe(),_(),Mo());return}if(t==="highlight"){r.markerPopover?.classList.contains("fbw-on")?B():(K(),oe(),_(),qo());return}if(t==="tag"){r.tagPopover?.classList.contains("fbw-on")?_():(K(),oe(),B(),jo());return}if(t==="note"){r.notePopover?.classList.contains("fbw-on")?oe():(K(),B(),_(),Oa(n));return}if(t==="replace-img"){let a=document.createElement("input");a.type="file",a.accept="image/*",a.onchange=i=>{let s=i.target.files[0];if(!s)return;let c=new FileReader;c.onload=()=>{C(n),n.tagName==="IMG"?(n.dataset.fbwOriginalSrc||(n.dataset.fbwOriginalSrc=n.src),n.src=c.result):n.style.backgroundImage=`url(${c.result})`,M(n,"replace-img",{name:s.name}),r.attachments.push({id:"fbw-att-"+Date.now()+"-"+Math.random().toString(36).slice(2,7),name:s.name||"\u66FF\u6362\u56FE-"+Date.now()+".png",dataURL:c.result,type:s.type}),G(),$(l("op.replaceImg"))},c.readAsDataURL(s)},a.click()}})}var $a=10,te=null;function on(){document.addEventListener("mousedown",e=>{if(!r.editMode||!r.selectedEl||e.button!==0||e.target.closest(".fbw-elem-toolbar, .fbw-panel, .fbw-fab, .fbw-resize-handle"))return;let o=e.target,t=ot(o);if(!(o===r.selectedEl||t===r.selectedEl||r.selectedEl.contains(o))||r.selectedEl.dataset.fbwEditing==="1")return;let a=W(r.selectedEl);te={el:r.selectedEl,startX:e.clientX,startY:e.clientY,baseX:a.x,baseY:a.y,baseScale:a.scale}},!0),ae(e=>{if(te&&!r.dragState){let a=e.clientX-te.startX,i=e.clientY-te.startY;if(Math.hypot(a,i)<$a)return;C(te.el),r.dragState={...te,moved:!0},te=null,document.body.style.cursor="move",e.preventDefault()}if(!r.dragState)return;let o=e.clientX-r.dragState.startX,t=e.clientY-r.dragState.startY,n={x:r.dragState.baseX+o,y:r.dragState.baseY+t,scale:r.dragState.baseScale};Y(r.dragState.el,n),nt()}),re(()=>{if(te=null,!r.dragState)return;let e=r.dragState.el;if(r.dragState.moved){let o=W(e);M(e,"move",{x:Math.round(o.x),y:Math.round(o.y)})}r.dragState=null,document.body.style.cursor=""})}function za(e){if(!e)return"";let o=e.getAttribute("data-screen-label")||e.getAttribute("aria-label");if(o)return o.trim();let t=e.querySelector("h1, h2, h3, h4, h5, h6");if(t&&t.textContent){let a=t.textContent.trim().replace(/\s+/g," ");if(a)return a.length>18?a.slice(0,18)+"\u2026":a}if(e.id)return"#"+e.id;let n=(e.className||"").toString().split(/\s+/).find(a=>a&&!a.startsWith("fbw-"));return n?"."+n:e.tagName.toLowerCase()}function Ia(e){if(!e)return"";let o=e.tagName.toLowerCase(),t=e.parentElement?e.parentElement.closest("section, article, [data-fbw-sec-id]"):null;!t&&e.matches("section, article, [data-fbw-sec-id]")&&(t=e);let n=t&&t!==e?za(t):"",a=e.parentElement,i="";if(a){let s=[...a.children].filter(c=>c.tagName===e.tagName);s.length>1&&(i=` (${s.indexOf(e)+1}/${s.length})`)}return[n,o+i].filter(Boolean).join(" \xB7 ")}function Da(e){if(!r.elemToolbar)return;let o=r.elemToolbar.querySelector("[data-fbw-path]"),t=r.elemToolbar.querySelector("[data-fbw-path-divider]");if(!o||!t)return;let n=Ia(e);n?(o.textContent=n,o.title=n,o.style.display="",t.style.display=""):(o.style.display="none",t.style.display="none")}function ot(e){if(!e)return e;let o=e.closest("svg");if(o&&!o.matches(".fbw-icon-btn svg, .fbw-elem-toolbar svg, .fbw-fab svg, .fbw-panel svg"))return o;if(!e.dataset?.fbwEditId&&e.closest){let t=e.closest("[data-fbw-edit-id]");if(t)return t}return e}var nn=24;function be(e){let o=e.getBoundingClientRect(),t=r.elemToolbar.getBoundingClientRect(),n=o.top-t.height-nn,a=o.left;n<8&&(n=o.bottom+nn),a+t.width>window.innerWidth-8&&(a=window.innerWidth-t.width-8),a<8&&(a=8),r.elemToolbar.style.top=n+"px",r.elemToolbar.style.left=a+"px"}function Ra(e){for(let o of e.childNodes)if(o.nodeType===3&&o.textContent.trim())return!0;return!1}function an(e){if(r.selectedEl===e)return;F(),r.selectedEl=e,e.classList.add("fbw-selected");let o=e.matches("img")||(getComputedStyle(e).backgroundImage||"none")!=="none";r.elemToolbar.querySelector('[data-op="replace-img"]').style.display=o?"inline-flex":"none";let t=Ra(e)&&!e.matches("img, svg, video, iframe"),n=r.elemToolbar.querySelector('[data-op="font"]');n&&(n.style.display=t?"inline-flex":"none");let a=r.elemToolbar.querySelector('[data-op="highlight"]');a&&(a.style.display=t?"inline-flex":"none");let i=/^(p|h[1-6])$/i.test(e.tagName),s=r.elemToolbar.querySelector('[data-op="tag"]');s&&(s.style.display=i?"inline-flex":"none");let c=r.elemToolbar.querySelectorAll(".fbw-tb-divider:not([data-fbw-path-divider])");c[0]&&(c[0].style.display=o||t||i?"":"none");let p=e.matches("a[href]"),d=r.elemToolbar.querySelector('[data-op="link"]');d&&(d.style.display=p?"inline-flex":"none");let f=r.elemToolbar.querySelector('[data-op="note"]');f&&f.classList.toggle("fbw-has-note",!!Ee(e)),Da(e),r.elemToolbar.classList.add("fbw-toolbar-open"),be(e),Oo(e)}function F(){r.selectedEl&&r.selectedEl.classList.remove("fbw-selected"),r.selectedEl=null,typeof window<"u"&&(window.__fbwSelEl=null),K(),oe(),B(),_(),r.elemToolbar.classList.remove("fbw-toolbar-open"),$o()}function qa(e){C(e),F(),e.contentEditable="true",e.spellcheck=!1,e.dataset.fbwEditing="1",e.dataset.fbwEdited="1",e.focus();try{let o=document.createRange();o.selectNodeContents(e);let t=window.getSelection();t.removeAllRanges(),t.addRange(o)}catch{}}var St=null;function nt(){r.selectedEl&&(St&&cancelAnimationFrame(St),St=requestAnimationFrame(()=>{be(r.selectedEl),Me(r.selectedEl),r.fontPicker.classList.contains("fbw-fp-open")&&Ve()}))}function rn(e){let o=e.target.dataset?.fbwEditId;o&&(e.target.classList.toggle("fbw-changed",r.originals.get(o)!==z(e.target)),T(k),L())}function sn(){document.body.classList.toggle("fbw-edit-mode",r.editMode),document.querySelectorAll("[data-fbw-edit-id]").forEach(e=>{e.contentEditable="false",e.spellcheck=!1}),r.editMode||F(),r.editToggleBtn&&r.editToggleBtn.classList.toggle("fbw-active",r.editMode),r.editFab&&r.editFab.classList.toggle("fbw-active",r.editMode),r.editMode&&r.marqueeMode&&(r.marqueeMode=!1,document.body.classList.remove("fbw-marquee-mode"),r.marqueeFab&&r.marqueeFab.classList.remove("fbw-active"),r.marqueeToggleBtn&&r.marqueeToggleBtn.classList.remove("fbw-active"))}function ue(){if(!r.editMode){r.marqueeMode&&bo(),r.editMode=!0,sn(),u(l("edit.on"));return}let e=oo(k);r.editMode=!1,sn(),u(e>0?l("edit.off.pending",{count:e}):l("edit.off"))}function ln(){let e="[data-fbw-sec-id]",o=".fbw-panel, .fbw-fab, .fbw-fab-bar, .fbw-elem-toolbar, .fbw-confirm, .fbw-toast, .fbw-marker-popover, .fbw-tag-popover, .fbw-font-picker, .fbw-note-popover, .fbw-help-popover, .fbw-tooltip, .fbw-anno, script, style";document.addEventListener("click",t=>{if(!r.editMode)return;let n=t.target;if(!n||n.closest(o))return;n.closest&&n.closest("a[href]")&&t.preventDefault();let a=n.closest(e);if(!a){r.selectedEl&&F();return}if(n===a){r.selectedEl&&F();return}n=ot(n),!(n.isContentEditable&&n===r.selectedEl)&&(t.preventDefault(),t.stopPropagation(),an(n))},!0),document.addEventListener("dblclick",t=>{if(!r.editMode)return;let n=t.target;if(!n||n.closest(o)||!n.closest(e))return;n=ot(n);let a=n.tagName.toLowerCase();if(!(a==="svg"||a==="img")){if(r.appMode==="review"){t.preventDefault(),t.stopPropagation(),an(n);return}t.preventDefault(),t.stopPropagation(),qa(n)}},!0),document.addEventListener("blur",t=>{let n=t.target;n&&n.dataset&&n.dataset.fbwEditing==="1"&&(n.contentEditable="false",delete n.dataset.fbwEditing)},!0),document.addEventListener("keydown",t=>{if(t.key==="Escape"){r.selectedEl&&(t.preventDefault(),F());let n=document.activeElement;n&&n.dataset&&n.dataset.fbwEditing==="1"&&(n.contentEditable="false",delete n.dataset.fbwEditing,n.blur())}}),["input","compositionend","paste","cut","drop"].forEach(t=>{document.addEventListener(t,rn,!0)}),document.addEventListener("blur",t=>{t.target.dataset?.fbwEditId&&rn(t)},!0),document.addEventListener("keydown",t=>{(t.target.dataset?.fbwEditId||t.target.closest(".fbw-panel, .fbw-confirm"))&&t.stopPropagation()},!0),ne(nt),J(nt),document.addEventListener("slidechange",()=>F())}function Ne(e){let o=e.closest("[data-fbw-sec-id]");if(!o)return null;let n=[...document.querySelectorAll(R)].indexOf(o);if(n<0)return null;let a=[],i=e;for(;i&&i!==o;){let s=i.tagName.toLowerCase(),c=i.parentElement;if(!c)break;let p=[...c.children].filter(d=>d.tagName===i.tagName);p.length>1&&(s+=`:nth-of-type(${p.indexOf(i)+1})`),a.unshift(s),i=c}return{secIndex:n,secLabel:o.dataset.fbwSecLabel||null,path:a.join(" > "),contentSample:(e.textContent||"").replace(/\s+/g," ").trim().slice(0,40),tag:e.tagName.toLowerCase()}}function Et(e,o,t){let a=e.querySelectorAll(t)[o.secIndex];if(!a)return{ok:!1,reason:"section-not-found"};let i=null;try{i=o.path?a.querySelector(o.path):a}catch{return{ok:!1,reason:"invalid-path"}}if(!i)return{ok:!1,reason:"element-not-found"};let s=(i.textContent||"").replace(/\s+/g," ").trim().slice(0,40);return{ok:!0,el:i,contentMismatch:s!==o.contentSample}}function _a(e){if(!e)return"";let o=e.getAttribute("data-screen-label")||e.dataset.fbwSecLabel||e.getAttribute("aria-label");if(o)return o.trim();let t=e.querySelector("h1, h2, h3, h4, h5, h6");return t&&t.textContent?t.textContent.trim().replace(/\s+/g," ").slice(0,24):e.id?"#"+e.id:e.tagName.toLowerCase()}function Ba(e){if(!e)return"";let o=e.closest("section, article, [data-fbw-sec-id]"),t=o?_a(o):"",n=e.tagName.toLowerCase(),a=(e.textContent||"").replace(/\s+/g," ").trim().slice(0,60),i=Ne(e),s=`[${t||"page"}] ${n}${a?` \xB7 "${a}${a.length>=60?"\u2026":""}"`:""}`;return i&&i.path?`${s}
selector: ${i.path}`:s}async function cn(){if(!r.selectedEl){u(l("copy.descriptor.empty")||"\u6CA1\u6709\u9009\u4E2D\u5143\u7D20");return}let e=Ba(r.selectedEl);try{await navigator.clipboard.writeText(e),u(l("copy.descriptor.done")||"\u5DF2\u590D\u5236\u5143\u7D20\u63CF\u8FF0\u7B26")}catch{let t=document.createElement("textarea");t.value=e,t.style.position="fixed",t.style.opacity="0",document.body.appendChild(t),t.select();try{document.execCommand("copy"),u(l("copy.descriptor.done")||"\u5DF2\u590D\u5236\u5143\u7D20\u63CF\u8FF0\u7B26")}catch{u(l("copy.descriptor.fail")||"\u590D\u5236\u5931\u8D25")}document.body.removeChild(t)}}var Ha=["delete","hide","replace-img","tag","font","highlight","scale","rotate","move","href"];function ja(e,o){for(let t of Ha)if(e.some(n=>n.op===t))return t;return o?"text":e[0]?.op||null}function dn(){let e=new Set;document.querySelectorAll("[data-fbw-edit-id]").forEach(t=>{let n=t.dataset.fbwEditId,a=r.originals.get(n);a!==void 0&&a!==z(t)&&e.add(t)});let o=new Set(e);r.elementOps.forEach((t,n)=>{document.contains(n)&&t.ops?.length&&o.add(n)}),o.forEach(t=>{let a=r.elementOps.get(t)?.ops||[],i=e.has(t),s=ja(a,i);t.classList.add("fbw-audit-changed"),s&&t.setAttribute("data-fbw-audit-op",s);let c=a.length+(i?1:0);c>0&&t.setAttribute("data-fbw-audit-count",String(c))})}function pn(){document.querySelectorAll(".fbw-audit-changed").forEach(e=>{e.classList.remove("fbw-audit-changed"),e.removeAttribute("data-fbw-audit-count"),e.removeAttribute("data-fbw-audit-op"),e.removeAttribute("data-fbw-audit-kind")})}function fn(){if(document.body.classList.toggle("fbw-audit-mode")){dn();let o=document.querySelectorAll(".fbw-audit-changed").length;u(o?l("audit.on",{n:o})||`\u5BA1\u8BA1\u6A21\u5F0F \xB7 ${o} \u5904\u6539\u52A8`:l("audit.empty")||"\u5BA1\u8BA1\u6A21\u5F0F \xB7 \u6CA1\u6709\u6539\u52A8")}else pn(),u(l("audit.off")||"\u5BA1\u8BA1\u6A21\u5F0F\u5173\u95ED")}function bn(){document.body.classList.contains("fbw-audit-mode")&&(pn(),dn())}var X=null;function Ua(){return X||(X=document.createElement("div"),X.className="fbw-measure-overlay",document.body.appendChild(X),X)}function at(e,o,t,n){let a=document.createElement("div");return a.className="fbw-measure-line fbw-measure-line-"+e,a.style.left=o+"px",a.style.top=t+"px",e==="h"?a.style.width=n+"px":a.style.height=n+"px",a}function rt(e,o,t,n){let a=document.createElement("div");return a.className="fbw-measure-label",a.textContent=e,a.style.left=o+"px",a.style.top=t+"px",a.style.transform=n==="h"?"translate(-50%, -130%)":"translate(8px, -50%)",a}function un(e){if(!r.selectedEl||!e||e===r.selectedEl)return V();let o=r.selectedEl.getBoundingClientRect(),t=e.getBoundingClientRect();if(!o.width||!t.width)return V();let n=Ua();n.innerHTML="",n.classList.add("fbw-on");let a=document.createElement("div");a.className="fbw-measure-target",a.style.left=t.left+"px",a.style.top=t.top+"px",a.style.width=t.width+"px",a.style.height=t.height+"px",n.appendChild(a);let i=o.left+o.width/2,s=o.top+o.height/2,c=o.top-t.top,p=t.bottom-o.bottom,d=o.left-t.left,f=t.right-o.right;if(Math.abs(c)>.5){let g=Math.min(o.top,t.top);n.appendChild(at("v",i,g,Math.abs(c))),n.appendChild(rt(Math.round(c)+"px",i,(o.top+t.top)/2,"v"))}if(Math.abs(p)>.5){let g=Math.min(o.bottom,t.bottom);n.appendChild(at("v",i,g,Math.abs(p))),n.appendChild(rt(Math.round(p)+"px",i,(o.bottom+t.bottom)/2,"v"))}if(Math.abs(d)>.5){let g=Math.min(o.left,t.left);n.appendChild(at("h",g,s,Math.abs(d))),n.appendChild(rt(Math.round(d)+"px",(o.left+t.left)/2,s,"h"))}if(Math.abs(f)>.5){let g=Math.min(o.right,t.right);n.appendChild(at("h",g,s,Math.abs(f))),n.appendChild(rt(Math.round(f)+"px",(o.right+t.right)/2,s,"h"))}}function V(){X&&(X.classList.remove("fbw-on"),X.innerHTML="")}function mn(e){return String(e||"").replace(/```/g,"`\u200B`\u200B`")}function me(e){return String(e||"").replace(/^(#{1,6}\s|[*\-+]\s|>\s|\d+\.\s)/gm,"\\$1")}function Oe(){let e=k(),o=r.panel.querySelector("[data-fbw-global]").value.trim(),t=new Date().toLocaleString("zh-CN",{hour12:!1}),a="# "+(document.title||"\u9875\u9762\u53CD\u9988")+` \xB7 \u53CD\u9988
...
`),a}function Wa(){return new Promise(e=>{if(window.html2canvas)return e(!0);let o=document.createElement("script");o.src="https://cdn.jsdelivr.net/npm/html2canvas@1.4.1/dist/html2canvas.min.js",o.integrity="sha384-ZZ1pncU3bQe8y31yfZdMFdSpttDoPmOZg2wguVK9almUodir1PghgT0eY7Mrty8H",o.crossOrigin="anonymous",o.referrerPolicy="no-referrer",o.onload=()=>e(!0),o.onerror=()=>e(!1),document.head.appendChild(o)})}async function gn(){if(u(l("shot.loading")),!await Wa()){u(l("shot.loadFailed"));return}document.body.classList.add("fbw-printing"),await new Promise(t=>requestAnimationFrame(t));let o;try{o=await window.html2canvas(document.body,{useCORS:!0,allowTaint:!0,logging:!1,x:window.scrollX,y:window.scrollY,width:window.innerWidth,height:window.innerHeight,windowWidth:document.documentElement.scrollWidth,windowHeight:document.documentElement.scrollHeight,scale:window.devicePixelRatio||1})}catch(t){console.error("[fbw] screenshot failed",t),u(l("shot.failed")),document.body.classList.remove("fbw-printing");return}document.body.classList.remove("fbw-printing"),o.toBlob(t=>{if(!t){u(l("shot.failed"));return}t.name="screenshot-"+new Date().toISOString().slice(0,19).replace(/[:T]/g,"-")+".jpg",tt(t)},"image/jpeg",.85)}function Ya(e,o){if(!e)return!1;let t=e.selectionStart??e.value.length,n=e.selectionEnd??e.value.length,a=e.value.slice(0,t),i=e.value.slice(n);e.value=a+o+i;let s=t+o.length;return e.selectionStart=e.selectionEnd=s,e.dispatchEvent(new Event("input",{bubbles:!0})),!0}async function wn(){if(typeof window.EyeDropper!="function"){u(l("eyedropper.unsupported")||"\u53D6\u8272\u5668\u4E0D\u652F\u6301\u5F53\u524D\u6D4F\u89C8\u5668 \xB7 \u9700\u8981 Chrome / Edge 95+");return}let e=r.panel?.classList.contains("fbw-open");e&&r.panel.classList.remove("fbw-open");let o;try{o=await new window.EyeDropper().open()}catch{e&&r.panel?.classList.add("fbw-open");return}e&&r.panel?.classList.add("fbw-open");let t=o.sRGBHex,n=document.activeElement,a=!1;n&&n.tagName==="TEXTAREA"&&n.closest(".fbw-panel, .fbw-anno, .fbw-note-popover")&&(a=Ya(n,t));try{await navigator.clipboard.writeText(t)}catch{}u(a?l("eyedropper.inserted",{hex:t})||`${t} \xB7 \u5DF2\u63D2\u5165\u53CD\u9988\u6846 + \u526A\u8D34\u677F`:l("eyedropper.copied",{hex:t})||`${t} \xB7 \u5DF2\u590D\u5236\u5230\u526A\u8D34\u677F`)}function $e(){r.panel.classList.toggle("fbw-open");let e=r.panel.classList.contains("fbw-open");if(r.fbToggleBtn&&r.fbToggleBtn.classList.toggle("fbw-active",e),r.fbFab.classList.toggle("fbw-active",e),e&&(document.querySelectorAll("[data-fbw-edit-id]").forEach(o=>{let t=o.dataset.fbwEditId;o.classList.toggle("fbw-changed",r.originals.get(t)!==z(o))}),T(k),L(),r.currentSec)){let o=r.currentSec.dataset.fbwSecId,t=r.sectionFeedback.get(o);r.panel.querySelector("[data-fbw-saved]").classList.toggle("fbw-on",!!t)}}function hn(){r.panel.querySelector("[data-fbw-close]").addEventListener("click",n=>{n.stopPropagation(),r.panel.classList.remove("fbw-open"),r.fbToggleBtn&&r.fbToggleBtn.classList.remove("fbw-active"),r.fbFab.classList.remove("fbw-active")}),r.fbFab.addEventListener("click",$e);let e=r.panel.querySelector("[data-fbw-locale]");e&&e.addEventListener("click",n=>{n.stopPropagation(),eo()});let o=r.panel.querySelector("[data-fbw-shot]");o&&o.addEventListener("click",n=>{n.stopPropagation();let a=r.panel.classList.contains("fbw-open");a&&r.panel.classList.remove("fbw-open"),gn().finally(()=>{a&&r.panel.classList.add("fbw-open")})});let t=r.panel.querySelector("[data-fbw-pick]");t&&t.addEventListener("click",n=>{n.stopPropagation(),wn()}),r.panel.querySelector('[data-fbw-action="copy"]').addEventListener("click",()=>{let n=Oe();navigator.clipboard.writeText(n).then(()=>u(l("panel.copy"))).catch(()=>{let a=document.createElement("textarea");a.value=n,document.body.appendChild(a),a.select(),document.execCommand("copy"),document.body.removeChild(a),u(l("panel.copy.fallback"))})}),r.panel.querySelector("[data-fbw-clear-all]").addEventListener("click",n=>{n.stopPropagation(),r.confirmDialog.classList.add("fbw-on")}),r.confirmDialog.querySelector("[data-fbw-confirm-cancel]").addEventListener("click",()=>{r.confirmDialog.classList.remove("fbw-on")}),r.confirmDialog.querySelector("[data-fbw-confirm-ok]").addEventListener("click",()=>{r.sectionFeedback.clear(),r.attachments.length=0,r.annotations.length=0,document.querySelectorAll(".fbw-anno").forEach(n=>n.remove()),G(),r.panel.querySelector("[data-fbw-global]").value="",r.panel.querySelector("[data-fbw-current-text]").value="",r.panel.querySelector("[data-fbw-saved]").classList.remove("fbw-on"),document.querySelectorAll("[data-fbw-edit-id]").forEach(n=>{let a=n.dataset.fbwEditId,i=r.originals.get(a);i!==void 0&&z(n)!==i&&(n.innerText=i,n.classList.remove("fbw-changed"))}),r.elementOps.forEach((n,a)=>{delete a.dataset.fbwOpDeleted,delete a.dataset.fbwOpHidden,delete a.dataset.fbwTx,delete a.dataset.fbwTy,delete a.dataset.fbwScale,delete a.dataset.fbwRotate,delete a.dataset.fbwHighlight,a.style.transform="",a.style.backgroundImage="",a.style.backgroundColor="",a.tagName==="IMG"&&a.dataset.fbwOriginalSrc&&(a.src=a.dataset.fbwOriginalSrc,delete a.dataset.fbwOriginalSrc)}),r.elementOps.clear(),F(),co(),T(k),r.confirmDialog.classList.remove("fbw-on"),u(l("panel.cleared"))}),window.addEventListener("beforeunload",mt)}function ze(e){r.currentSec=e;let o=r.panel.querySelector("[data-fbw-current-page]"),t=r.panel.querySelector("[data-fbw-current-text]"),n=r.panel.querySelector("[data-fbw-saved]");if(!e){o.textContent="\u2014",t.value="",t.disabled=!0,n.classList.remove("fbw-on");return}t.disabled=!1,o.textContent=e.dataset.fbwSecLabel||"Section";let a=e.dataset.fbwSecId,i=r.sectionFeedback.get(a);t.value=i?.note||"",n.classList.toggle("fbw-on",!!i)}function xn(e){let o=r.panel.querySelector("[data-fbw-current-text]");o.addEventListener("input",n=>{if(!r.currentSec)return;let a=r.currentSec.dataset.fbwSecId,i=r.currentSec.dataset.fbwSecLabel,s=n.target.value.trim();s?(r.sectionFeedback.set(a,{label:i,note:s}),r.panel.querySelector("[data-fbw-saved]").classList.add("fbw-on")):(r.sectionFeedback.delete(a),r.panel.querySelector("[data-fbw-saved]").classList.remove("fbw-on")),T(k),L()}),["keydown","keyup","keypress"].forEach(n=>o.addEventListener(n,a=>a.stopPropagation())),r.panel.querySelector("[data-fbw-global]").addEventListener("input",L);let t=document.querySelector("deck-stage");if(t){document.addEventListener("slidechange",a=>ze(a.detail?.slide||null));let n=t.querySelector("section.slide")||e[0];n&&ze(n)}else{if(document.body.classList.add("fbw-no-overlay"),e.length){let a=new IntersectionObserver(i=>{let s=i.filter(c=>c.isIntersecting).sort((c,p)=>p.intersectionRatio-c.intersectionRatio)[0];s&&ze(s.target)},{threshold:[.3,.5,.7]});e.forEach(i=>a.observe(i)),ze(e[0])}if(e.length===1&&(e[0]===document.body||e[0].tagName==="MAIN"||e[0].tagName==="ARTICLE")){let a=e[0],i=()=>{let c=(document.title||"Page").slice(0,80);a.dataset.fbwSecLabel!==c&&(a.dataset.fbwSecLabel=c,r.currentSec===a&&ze(a))};window.addEventListener("popstate",i),["pushState","replaceState"].forEach(c=>{let p=history[c];history[c]=function(...d){let f=p.apply(this,d);return setTimeout(i,0),f}});let s=document.querySelector("title");s&&new MutationObserver(i).observe(s,{childList:!0,characterData:!0,subtree:!0})}}}function Lt(e){return{id:e.id||e.dataset.fbId||null,cssPath:Ka(e),contentHash:Ga(e),fbId:e.dataset.fbwEditId||null,tag:e.tagName.toLowerCase()}}function yn(e){return typeof CSS<"u"&&CSS.escape?CSS.escape(e):String(e).replace(/[^\w-]/g,o=>"\\"+o)}function Ka(e){let o=e.closest("[data-fbw-sec-id]")||document.body,t=[],n=e;for(;n&&n!==o&&n!==document.body;){let i=n.tagName.toLowerCase();if(n.id){t.unshift("#"+yn(n.id)),n=null;break}let s=[...n.classList].filter(p=>!p.startsWith("fbw-")).slice(0,2);s.length&&(i+="."+s.map(yn).join("."));let c=n.parentElement;if(c){let p=[...c.children].filter(d=>d.tagName===n.tagName);if(p.length>1){let d=p.indexOf(n)+1;i+=`:nth-of-type(${d})`}}t.unshift(i),n=c}return[o.dataset?.fbwSecId?`[data-fbw-sec-id="${o.dataset.fbwSecId}"]`:"",t.join(" > ")].filter(Boolean).join(" > ")}function Ga(e){let o=(e.textContent||"").replace(/\s+/g," ").trim().slice(0,80),t=0;for(let n=0;n<o.length;n++)t=(t<<5)-t+o.charCodeAt(n),t|=0;return{sample:o.slice(0,40),hash:(t>>>0).toString(16).padStart(8,"0")}}var Ct="sessionsDir";function ge(){return typeof window<"u"&&typeof window.showDirectoryPicker=="function"}async function Xa(e,o="readwrite"){if(!e?.queryPermission)return!1;let t={mode:o};try{if(await e.queryPermission(t)==="granted"||await e.requestPermission(t)==="granted")return!0}catch{}return!1}async function vn(){let e=await Je(Ct);return e&&await Xa(e)?e:null}async function kn(){let e=await window.showDirectoryPicker({id:"redline-sessions",mode:"readwrite",startIn:"desktop"});return await Qe(Ct,e),e}async function Sn(){await et(Ct)}var Va=(()=>{let e=new Uint32Array(256);for(let o=0;o<256;o++){let t=o;for(let n=0;n<8;n++)t=t&1?3988292384^t>>>1:t>>>1;e[o]=t>>>0}return e})();function Za(e){let o=4294967295;for(let t=0;t<e.length;t++)o=Va[(o^e[t])&255]^o>>>8;return(o^4294967295)>>>0}function Ja(e=new Date){let o=(e.getHours()&31)<<11|(e.getMinutes()&63)<<5|Math.floor(e.getSeconds()/2)&31,t=(e.getFullYear()-1980&127)<<9|(e.getMonth()+1&15)<<5|e.getDate()&31;return{time:o,date:t}}function S(e,o,t){e.setUint16(o,t,!0)}function D(e,o,t){e.setUint32(o,t,!0)}function En(e){let o=new TextEncoder,{time:t,date:n}=Ja(),a=[],i=[],s=0;for(let f of e){let g=o.encode(f.name),h=f.data,w=Za(h),b=h.length,m=new ArrayBuffer(30+g.length),v=new DataView(m);D(v,0,67324752),S(v,4,20),S(v,6,2048),S(v,8,0),S(v,10,t),S(v,12,n),D(v,14,w),D(v,18,b),D(v,22,b),S(v,26,g.length),S(v,28,0),new Uint8Array(m,30).set(g),a.push(new Uint8Array(m),h);let P=new ArrayBuffer(46+g.length),x=new DataView(P);D(x,0,33639248),S(x,4,20),S(x,6,20),S(x,8,2048),S(x,10,0),S(x,12,t),S(x,14,n),D(x,16,w),D(x,20,b),D(x,24,b),S(x,28,g.length),S(x,30,0),S(x,32,0),S(x,34,0),S(x,36,0),D(x,38,0),D(x,42,s),new Uint8Array(P,46).set(g),i.push(new Uint8Array(P)),s+=30+g.length+b}let c=i.reduce((f,g)=>f+g.length,0),p=new ArrayBuffer(22),d=new DataView(p);return D(d,0,101010256),S(d,4,0),S(d,6,0),S(d,8,e.length),S(d,10,e.length),D(d,12,c),D(d,16,s),S(d,20,0),new Blob([...a,...i,new Uint8Array(p)],{type:"application/zip"})}var Qa="1.0";function Ln(){let e=r.panel?.querySelector("[data-fbw-global]")?.value?.trim()||"",o=[];r.sectionFeedback.forEach((a,i)=>{o.push({secId:i,secLabel:a.label,note:a.note})});let t=[];k().forEach(a=>{let i=document.querySelector(`[data-fbw-edit-id="${a.id}"]`);i&&t.push({op:"text",selector:Lt(i),section:a.section,before:a.before,after:a.after})}),r.elementOps.forEach((a,i)=>{a.ops.forEach(s=>{t.push({op:s.op,selector:Lt(i),descriptor:a.descriptor,...s.args!==void 0?{args:s.args}:{},...s.proposed?{proposed:!0}:{}})})});let n=r.attachments.map(a=>({id:a.id,name:a.name,type:a.type,dataURL:a.dataURL}));return{schemaVersion:Qa,widgetVersion:xe,appMode:r.appMode||"deck",sessionId:"fbw-sess-"+Date.now()+"-"+Math.random().toString(36).slice(2,8),capturedAt:new Date().toISOString(),capturedAtMs:Date.now(),env:{userAgent:(navigator.userAgent||"").slice(0,200),locale:navigator.language||"",viewport:{w:window.innerWidth,h:window.innerHeight,dpr:window.devicePixelRatio||1},timezone:Intl.DateTimeFormat().resolvedOptions().timeZone},page:{url:location.href,title:document.title||null,pathname:location.pathname},source:{hint:location.pathname.replace(/^.*\//,""),matchBy:"pathname"},feedback:{global:e||null,perSection:o},edits:t,annotations:r.annotations.map(a=>{let i=a.type||"region",s={id:a.id,type:i,secId:a.secId,secLabel:a.secLabel,rectPct:a.rectPct};return i==="floating"?{...s,content:a.content||""}:{...s,content:a.content||"",note:a.note||a.text||"",image:a.image?{name:a.image.name,type:a.image.type,dataURL:a.image.dataURL}:null}}),attachments:n}}function er(e){return(e||"session").replace(/[\\/:*?"<>|\s]+/g,"_").replace(/_+/g,"_").slice(0,80)}function tr(){let e=new Date,o=t=>String(t).padStart(2,"0");return`${e.getFullYear()}-${o(e.getMonth()+1)}-${o(e.getDate())}-${o(e.getHours())}${o(e.getMinutes())}${o(e.getSeconds())}`}function Cn(e){return er(e||document.title)+"-"+tr()}async function it(e,o,t){let a=await(await e.getFileHandle(o,{create:!0})).createWritable();await a.write(t),await a.close()}async function st(e){return(await fetch(e)).blob()}function lt(e){if(!e)return"png";let o=e.split("/")[1]||"png";return o==="jpeg"?"jpg":o.replace(/[^a-z0-9]/gi,"")}async function Tn(e,o){if(!ge())return{ok:!1,fallback:"download",reason:"no-fs-access"};let t=await vn(),n=!1;if(!t)try{t=await kn(),n=!0}catch(a){return{ok:!1,fallback:"download",reason:"picker-cancelled",error:a?.message}}try{let a=[];if(Array.isArray(e.annotations)){for(let c of e.annotations)if(c.image?.dataURL){let p=(c.id||"").split("-").pop().slice(0,8)||Math.random().toString(36).slice(2,10),d=`${o}-anno-${p}.${lt(c.image.type)}`,f=await st(c.image.dataURL);await it(t,d,f),a.push(d),c.image={name:c.image.name,type:c.image.type,filename:d}}}if(Array.isArray(e.attachments))for(let c=0;c<e.attachments.length;c++){let p=e.attachments[c];if(p.dataURL){let d=`${o}-att-${String(c+1).padStart(2,"0")}.${lt(p.type)}`,f=await st(p.dataURL);await it(t,d,f),a.push(d),e.attachments[c]={id:p.id,name:p.name,type:p.type,filename:d}}}let i=o+".json",s=o+".md";return await it(t,i,JSON.stringify(e,null,2)),await it(t,s,Oe()),{ok:!0,dirName:t.name,jsonName:i,mdName:s,firstPick:n,imageFiles:a}}catch(a){return{ok:!1,fallback:"download",reason:"write-failed",error:a?.message}}}function Mn(e,o){let t=new Blob([JSON.stringify(e,null,2)],{type:"application/json"});Pn(t,o+".json")}function Pn(e,o){let t=URL.createObjectURL(e),n=document.createElement("a");n.href=t,n.download=o,n.click(),URL.revokeObjectURL(t)}async function Tt(e,o){let t=new TextEncoder,n=[];if(Array.isArray(e.annotations)){for(let i of e.annotations)if(i.image?.dataURL){let s=(i.id||"").split("-").pop().slice(0,8)||Math.random().toString(36).slice(2,10),c=`${o}-anno-${s}.${lt(i.image.type)}`,p=new Uint8Array(await(await st(i.image.dataURL)).arrayBuffer());n.push({name:c,data:p}),i.image={name:i.image.name,type:i.image.type,filename:c}}}if(Array.isArray(e.attachments))for(let i=0;i<e.attachments.length;i++){let s=e.attachments[i];if(s.dataURL){let c=`${o}-att-${String(i+1).padStart(2,"0")}.${lt(s.type)}`,p=new Uint8Array(await(await st(s.dataURL)).arrayBuffer());n.push({name:c,data:p}),e.attachments[i]={id:s.id,name:s.name,type:s.type,filename:c}}}n.unshift({name:`${o}.json`,data:t.encode(JSON.stringify(e,null,2))},{name:`${o}.md`,data:t.encode(Oe())});let a=En(n);return Pn(a,o+".zip"),{ok:!0,fileCount:n.length}}async function or(){try{return typeof chrome>"u"||!chrome.storage?.sync?null:(await chrome.storage.sync.get({saveMode:"zip"})).saveMode}catch{return null}}function An(){let e=r.panel.querySelector('[data-fbw-action="save"]');e&&(e.addEventListener("click",async()=>{let o=Ln(),t=Cn();if(await or()!=="fs"||!ge()){e.disabled=!0;try{await Tt(o,t),u(l("save.unsupported",{stem:t+".zip"}))}catch(i){Mn(o,t),u(l("save.failed",{reason:i?.message||"zip-failed"}))}finally{e.disabled=!1}return}e.disabled=!0;try{let i=await Tn(o,t);if(i.ok){let s=(i.imageFiles||[]).length,c=`/{json, md${s>0?` + ${s} imgs`:""}}`;u(l(i.firstPick?"save.first":"save.again",{dir:i.dirName,suffix:c}))}else i.reason==="picker-cancelled"?u(l("save.cancelled")):(await Tt(o,t),u(l("save.failed",{reason:i.reason||"unknown"})))}finally{e.disabled=!1}}),e.addEventListener("contextmenu",async o=>{o.preventDefault(),await Sn(),u(l("save.dirCleared"))}))}var Fn={html2canvas:{src:"https://cdn.jsdelivr.net/npm/html2canvas@1.4.1/dist/html2canvas.min.js",integrity:"sha384-ZZ1pncU3bQe8y31yfZdMFdSpttDoPmOZg2wguVK9almUodir1PghgT0eY7Mrty8H"},jspdf:{src:"https://cdn.jsdelivr.net/npm/jspdf@2.5.1/dist/jspdf.umd.min.js",integrity:"sha384-JcnsjUPPylna1s1fvi1u12X5qjY5OL56iySh75FdtrwhO/SWXgMjoVqcKyIIWOLk"}};function Nn({src:e,integrity:o}){return new Promise(t=>{let n=document.createElement("script");n.src=e,n.integrity=o,n.crossOrigin="anonymous",n.referrerPolicy="no-referrer",n.onload=()=>t(!0),n.onerror=()=>t(!1),document.head.appendChild(n)})}function nr(){let e=[];return window.html2canvas||e.push(Nn(Fn.html2canvas)),window.jspdf||e.push(Nn(Fn.jspdf)),e.length?Promise.all(e).then(o=>o.every(Boolean)&&!!window.html2canvas&&!!window.jspdf):Promise.resolve(!0)}function we(e,o){if(e=e||{},r.panel.classList.remove("fbw-open"),r.fbToggleBtn&&r.fbToggleBtn.classList.remove("fbw-active"),r.fbFab.classList.remove("fbw-active"),o)try{o()}catch{}if(e.image)return ar();document.body.classList.add("fbw-printing"),u(l("pdf.vector.hint")),setTimeout(()=>{try{window.print()}catch(t){console.error(t)}setTimeout(()=>document.body.classList.remove("fbw-printing"),2e3)},250)}async function ar(){if(u(l("pdf.loading")),!await nr()){u(l("pdf.loadFailed"));return}let o=document.querySelector("deck-stage"),t=o&&parseInt(o.getAttribute("width"),10)||1920,n=o&&parseInt(o.getAttribute("height"),10)||1080,a=[...document.querySelectorAll("section.slide")];if(!a.length)return rr();let i=a.map(b=>b.hasAttribute("data-deck-active"));document.body.classList.add("fbw-printing");let s=null,c="";try{s=o&&o.shadowRoot&&o.shadowRoot.querySelector(".canvas")}catch{}s&&(c=s.style.transform||"",s.style.transform="none");let{jsPDF:p}=window.jspdf,d=t>n?"landscape":"portrait",f=new p({unit:"px",format:[t,n],orientation:d,hotfixes:["px_scaling"]}),g="http://www.w3.org/2000/svg",h=new Map;document.querySelectorAll("symbol[id]").forEach(b=>h.set(b.id,b));let w=[];a.forEach(b=>{b.querySelectorAll("use").forEach(m=>{let P=(m.getAttribute("href")||m.getAttribute("xlink:href")||"").replace(/^#/,""),x=h.get(P);if(!x)return;let E=m.ownerSVGElement,j=x.getAttribute("viewBox"),he=!1;E&&!E.getAttribute("viewBox")&&j&&(E.setAttribute("viewBox",j),he=!0);let Ie=document.createElementNS(g,"g");[...x.childNodes].forEach(De=>Ie.appendChild(De.cloneNode(!0))),["transform","fill","stroke","class","opacity","style"].forEach(De=>{let Ft=m.getAttribute(De);Ft&&Ie.setAttribute(De,Ft)});let _n=m;m.parentNode.insertBefore(Ie,m),m.parentNode.removeChild(m),w.push({g:Ie,original:_n,parentSvg:E,vbAdded:he})})}),u(l("pdf.progress",{i:0,total:a.length}));try{for(let m=0;m<a.length;m++){a.forEach((E,j)=>{j===m?E.setAttribute("data-deck-active",""):E.removeAttribute("data-deck-active")}),await new Promise(E=>requestAnimationFrame(()=>requestAnimationFrame(E)));try{await document.fonts.ready}catch{}u(l("pdf.progress",{i:m+1,total:a.length}));let v={width:t,height:n,windowWidth:t,windowHeight:n,scale:2,useCORS:!0,allowTaint:!0,backgroundColor:"#ffffff",logging:!1},P;try{P=await window.html2canvas(a[m],{...v,foreignObjectRendering:!0})}catch(E){console.warn("foreignObject mode failed, fallback to JS render:",E),P=await window.html2canvas(a[m],v)}let x=P.toDataURL("image/jpeg",.92);m>0&&f.addPage([t,n],d),f.addImage(x,"JPEG",0,0,t,n,void 0,"FAST")}let b=(document.title||"deck").replace(/[\\/:*?"<>|]/g,"_")+"-image.pdf";f.save(b),u(l("pdf.saved",{file:b}))}catch(b){console.error(b),u(l("pdf.failed",{reason:b.message||b}))}finally{w.forEach(b=>{try{b.g.parentNode.insertBefore(b.original,b.g),b.g.parentNode.removeChild(b.g),b.vbAdded&&b.parentSvg&&b.parentSvg.removeAttribute("viewBox")}catch{}}),s&&(s.style.transform=c),a.forEach((b,m)=>{i[m]?b.setAttribute("data-deck-active",""):b.removeAttribute("data-deck-active")}),document.body.classList.remove("fbw-printing")}}async function rr(){document.body.classList.add("fbw-printing"),await new Promise(a=>requestAnimationFrame(()=>requestAnimationFrame(a)));try{await document.fonts.ready}catch{}let e=document.documentElement,o=Math.max(e.scrollWidth,document.body.scrollWidth),t=Math.max(e.scrollHeight,document.body.scrollHeight);u(l("pdf.progress",{i:0,total:1}));let n;try{n=await window.html2canvas(document.body,{useCORS:!0,allowTaint:!0,logging:!1,backgroundColor:"#ffffff",scale:2,x:0,y:0,width:o,height:t,windowWidth:o,windowHeight:t})}catch(a){console.error(a),u(l("pdf.failed",{reason:a.message||a})),document.body.classList.remove("fbw-printing");return}try{let{jsPDF:a}=window.jspdf,i=14400,s=(document.title||"page").replace(/[\\/:*?"<>|]/g,"_")+"-long.pdf";if(t<=i){let c=new a({unit:"px",format:[o,t],orientation:"portrait",hotfixes:["px_scaling"]}),p=n.toDataURL("image/jpeg",.9);c.addImage(p,"JPEG",0,0,o,t,void 0,"FAST"),c.save(s)}else{let c=i,p=n.width/o,d=Math.floor(c*p),f=Math.ceil(n.height/d),g=new a({unit:"px",format:[o,c],orientation:"portrait",hotfixes:["px_scaling"]});for(let h=0;h<f;h++){u(l("pdf.progress",{i:h+1,total:f}));let w=h*d,b=Math.min(d,n.height-w),m=document.createElement("canvas");m.width=n.width,m.height=b;let v=m.getContext("2d");v.fillStyle="#ffffff",v.fillRect(0,0,m.width,m.height),v.drawImage(n,0,w,n.width,b,0,0,n.width,b);let P=m.toDataURL("image/jpeg",.9);h>0&&g.addPage([o,c],"portrait"),g.addImage(P,"JPEG",0,0,o,b/p,void 0,"FAST"),await new Promise(x=>setTimeout(x,0))}g.save(s)}u(l("pdf.saved",{file:s}))}catch(a){console.error(a),u(l("pdf.failed",{reason:a.message||a}))}finally{document.body.classList.remove("fbw-printing")}}var Mt="sourceDir";async function ir(e,o="readwrite"){if(!e?.queryPermission)return!1;let t={mode:o};try{if(await e.queryPermission(t)==="granted"||await e.requestPermission(t)==="granted")return!0}catch{}return!1}async function sr(){let e=await Je(Mt);return e&&await ir(e)?e:null}async function lr(){let e=await window.showDirectoryPicker({id:"redline-source",mode:"readwrite",startIn:"desktop"});return await Qe(Mt,e),e}async function On(){await et(Mt)}async function cr(e){let o=decodeURIComponent(location.pathname.split("/").pop()||"");if(o)try{return await e.getFileHandle(o)}catch{}let t=window.prompt(`\u5728\u9009\u5B9A\u76EE\u5F55\u4E0B\u627E\u4E0D\u5230 "${o}"
\u6E90 HTML \u6587\u4EF6\u540D\uFF08\u542B .html\uFF09`,o);if(!t)return null;try{return await e.getFileHandle(t)}catch{return null}}function dr(e){let o=[];/\{\{[\s\S]+?\}\}|<%[\s\S]+?%>|<\?php|\{%[\s\S]+?%\}/.test(e)&&o.push("\u6A21\u677F\u8BED\u6CD5 (Mustache/EJS/PHP/Jinja)"),/__webpack_|window\.webpackChunk|window\.__NEXT_DATA__|window\.__remixContext/.test(e)&&o.push("build \u4EA7\u7269");let t=(e.match(/<link[^>]+rel=["']stylesheet/gi)||[]).length;return t>2&&o.push(`${t} \u4E2A\u5916\u90E8 stylesheet`),/<script[^>]+type=["']module["'][^>]*src=/i.test(e)&&o.push("JS module \u5F15\u7528"),o}function pr(e){let o=0,t=0,n=[];return document.querySelectorAll("[data-fbw-edit-id]").forEach(a=>{let i=a.dataset.fbwEditId,s=r.originals.get(i),c=z(a);if(s===c)return;let p=Ne(a);if(!p){t++,n.push({kind:"text",desc:s.slice(0,30),reason:"no-path"});return}let d=Et(e,p,R);if(!d.ok){t++,n.push({kind:"text",desc:s.slice(0,30),reason:d.reason});return}if(d.contentMismatch){t++,n.push({kind:"text",desc:s.slice(0,30),reason:"content-drift"});return}d.el.textContent=c,o++}),r.elementOps.forEach((a,i)=>{let s=Ne(i);if(!s){t+=a.ops.length,n.push({kind:"op",desc:a.descriptor,reason:"no-path"});return}let c=Et(e,s,R);if(!c.ok){t+=a.ops.length,n.push({kind:"op",desc:a.descriptor,reason:c.reason});return}let p=c.el;a.ops.forEach(d=>{try{if(d.op==="note")return;if(d.op==="delete")p.remove();else if(d.op==="hide")p.style.visibility="hidden";else if(d.op==="move"){let f=(p.style.transform||"").replace(/translate\([^)]+\)/g,"").trim();p.style.transform=(f+` translate(${d.args.x}px, ${d.args.y}px)`).trim()}else if(d.op==="scale"){let f=(p.style.transform||"").replace(/scale\([^)]+\)/g,"").trim();p.style.transform=(f+` scale(${d.args.scale})`).trim()}else if(d.op==="rotate"){let f=(p.style.transform||"").replace(/rotate\([^)]+\)/g,"").trim();p.style.transform=(f+` rotate(${d.args.rotate}deg)`).trim()}else if(d.op==="font")p.style.fontFamily=d.args.family==="\u7CFB\u7EDF\u9ED8\u8BA4"?"":d.args.family;else if(d.op==="highlight")p.style.backgroundColor=d.args?.color||"";else{t++,n.push({kind:"op",desc:a.descriptor,op:d.op,reason:"unsupported"});return}o++}catch(f){t++,n.push({kind:"op",desc:a.descriptor,op:d.op,reason:f.message})}})}),["fbwEditId","fbwSecId","fbwSecLabel","fbwTx","fbwTy","fbwScale","fbwRotate","fbwOriginalSrc","fbwFontName","fbwHighlight","fbwOpDeleted","fbwOpHidden"].forEach(a=>{let i="[data-"+a.replace(/[A-Z]/g,s=>"-"+s.toLowerCase())+"]";e.querySelectorAll(i).forEach(s=>delete s.dataset[a])}),e.querySelectorAll(".fbw-changed, .fbw-selected").forEach(a=>{a.classList.remove("fbw-changed"),a.classList.remove("fbw-selected")}),{applied:o,failed:t,failures:n}}function fr(){let e=new Date,o=t=>String(t).padStart(2,"0");return`${e.getFullYear()}${o(e.getMonth()+1)}${o(e.getDate())}-${o(e.getHours())}${o(e.getMinutes())}${o(e.getSeconds())}`}async function br(e,o,t){let a=`${o.replace(/\.html?$/i,"")}.bak.${fr()}.html`,s=await(await e.getFileHandle(a,{create:!0})).createWritable();return await s.write(t),await s.close(),a}async function $n(){if(!ge())return u(l("patch.unsupported")),{ok:!1,reason:"no-fs-access"};if(location.protocol!=="file:")return u(l("patch.notFile")),{ok:!1,reason:"not-file-protocol"};let e=await sr();if(!e)try{e=await lr()}catch{return u(l("patch.cancelled")),{ok:!1,reason:"picker-cancelled"}}let o=await cr(e);if(!o)return u(l("patch.fileNotFound")),{ok:!1,reason:"file-not-found"};let t=await o.getFile(),n=await t.text(),a=dr(n);if(a.length&&await ft({title:l("warn.complex.title"),desc:l("warn.complex.desc",{flags:a.join(`
\xB7 `)}),choices:[{label:l("common.cancel"),value:"cancel"},{label:l("warn.complex.continue"),value:"continue",danger:!0}]})!=="continue")return u(l("patch.cancelled")),{ok:!1,reason:"user-cancelled-warning"};let i=new DOMParser().parseFromString(n,"text/html"),{applied:s,failed:c,failures:p}=pr(i);if(s===0)return u(c===0?l("patch.noChanges"):l("patch.partialFail",{failed:c})),p.length&&console.warn("[fbw] failures:",p),{ok:!1,applied:s,failed:c,failures:p};let d="";try{d=await br(e,t.name,n)}catch(b){if(await ft({title:l("patch.backupFail.title"),desc:l("patch.backupFail.desc",{reason:b.message}),choices:[{label:l("common.cancel"),value:"cancel"},{label:l("warn.complex.continue"),value:"continue",danger:!0}]})!=="continue")return u(l("patch.cancelled")),{ok:!1,reason:"backup-failed-user-cancelled"}}let f=`<!DOCTYPE html>
`+i.documentElement.outerHTML,g=await o.createWritable();await g.write(f),await g.close();let h=c>0?` / ${c} failed`:"",w=d?` \xB7 backup ${d}`:"";return u(l("patch.success",{file:t.name,applied:s,failedSuffix:h,backupSuffix:w})),p.length&&console.warn("[fbw] failures:",p),{ok:!0,applied:s,failed:c,failures:p,backupName:d,fileName:t.name}}function ct(){let e=document.querySelector("deck-stage");if(!e||!e.shadowRoot){setTimeout(ct,80);return}let o=e.shadowRoot.querySelector(".overlay");if(!o){setTimeout(ct,80);return}if(o.querySelector("[data-fbw-btn]"))return;let t=o.querySelector(".reset"),n=document.createElement("span");n.className="divider";let a=document.createElement("button");a.className="btn",a.dataset.fbwBtn="edit",a.type="button",a.dataset.tooltip=l("overlay.edit"),a.setAttribute("aria-label",l("overlay.edit")),a.innerHTML=Re.replace('viewBox="0 0 24 24"','viewBox="0 0 24 24" width="14" height="14"'),a.addEventListener("click",m=>{m.stopPropagation(),ue()});let i=document.createElement("button");i.className="btn",i.dataset.fbwBtn="save-edit",i.type="button",i.dataset.tooltip=l("overlay.save"),i.setAttribute("aria-label",l("overlay.save")),i.innerHTML=It.replace('viewBox="0 0 24 24"','viewBox="0 0 24 24" width="14" height="14"')+'<span class="fbw-edit-count">0</span>',i.addEventListener("click",m=>{m.stopPropagation(),$n()}),i.addEventListener("contextmenu",async m=>{m.preventDefault(),m.stopPropagation(),await On(),u(l("patch.dirCleared"))}),r.saveEditBtn=i;let s=document.createElement("span");s.className="divider";let c=document.createElement("button");c.className="btn",c.dataset.fbwBtn="feedback",c.type="button",c.dataset.tooltip=l("overlay.feedback"),c.setAttribute("aria-label",l("overlay.feedback")),c.innerHTML=U.replace('viewBox="0 0 24 24"','viewBox="0 0 24 24" width="14" height="14"'),c.addEventListener("click",m=>{m.stopPropagation(),$e()});let p=document.createElement("span");p.className="divider";let d=document.createElement("button");d.className="btn",d.dataset.fbwBtn="marquee",d.type="button",d.dataset.tooltip=l("overlay.marquee"),d.setAttribute("aria-label",l("overlay.marquee")),d.innerHTML=_e.replace('viewBox="0 0 24 24"','viewBox="0 0 24 24" width="14" height="14"'),d.addEventListener("click",m=>{m.stopPropagation(),de()}),r.marqueeToggleBtn=d;let f=document.createElement("span");f.className="divider";let g=document.createElement("button");g.className="btn",g.dataset.fbwBtn="export",g.type="button",g.dataset.tooltip=l("overlay.export"),g.setAttribute("aria-label",l("overlay.export")),g.innerHTML=Be.replace('viewBox="0 0 24 24"','viewBox="0 0 24 24" width="14" height="14"'),g.addEventListener("click",m=>{m.stopPropagation(),we({image:m.shiftKey},F)});let h=document.createElement("span");h.className="divider";let w=document.createElement("button");w.className="btn",w.dataset.fbwBtn="help",w.type="button",w.dataset.tooltip=l("overlay.help"),w.setAttribute("aria-label",l("overlay.help")),w.innerHTML=qe.replace('viewBox="0 0 24 24"','viewBox="0 0 24 24" width="14" height="14"'),w.addEventListener("click",m=>{m.stopPropagation(),Ce(w)}),r.helpToggleBtn=w,t?t.after(n,a,i,s,c,p,d,f,g,h,w):o.append(n,a,i,s,c,p,d,f,g,h,w),r.editToggleBtn=a,r.fbToggleBtn=c;let b=document.createElement("style");b.textContent=`
    .btn[data-fbw-btn].fbw-active {
      color: #dc3c3c !important;
    }
  `,e.shadowRoot.appendChild(b),document.body.classList.remove("fbw-no-overlay")}function ur(){let e=document.createElement("style");e.id="fbw-styles",e.dataset.fbwInternal="1",e.textContent=Ot,document.head.appendChild(e)}function mr(){let e=document.createElement("div");e.className="fbw-panel",e.id="fbwPanel",e.innerHTML=vo(),r.panel=e;let o=document.createElement("div");o.className="fbw-confirm",o.innerHTML=ko(),r.confirmDialog=o;let t=document.createElement("button");t.className="fbw-fab fbw-edit-fab",t.innerHTML=Re,t.dataset.tooltip=l("overlay.edit"),t.setAttribute("aria-label",l("overlay.edit")),r.editFab=t;let n=document.createElement("button");n.className="fbw-fab fbw-fb-fab",n.innerHTML=U,n.dataset.tooltip=l("overlay.feedback"),n.setAttribute("aria-label",l("overlay.feedback")),r.fbFab=n;let a=document.createElement("button");a.className="fbw-fab fbw-marquee-fab",a.innerHTML=_e,a.dataset.tooltip=l("overlay.marquee"),a.setAttribute("aria-label",l("overlay.marquee")),r.marqueeFab=a;let i=document.createElement("button");i.className="fbw-fab fbw-export-fab",i.innerHTML=Be,i.dataset.tooltip=l("overlay.export"),i.setAttribute("aria-label",l("overlay.export")),r.exportFab=i;let s=document.createElement("button");s.className="fbw-fab fbw-help-fab",s.innerHTML=qe,s.dataset.tooltip=l("overlay.help"),s.setAttribute("aria-label",l("overlay.help")),r.helpFab=s;let c=document.createElement("button");c.className="fbw-fab fbw-fold-fab",c.innerHTML=qt,c.dataset.tooltip=l("overlay.fold"),c.setAttribute("aria-label",l("overlay.fold")),r.foldFab=c;let p=document.createElement("div");p.className="fbw-help-popover",r.helpPopover=p;let d=document.createElement("div");d.className="fbw-elem-toolbar",d.innerHTML=So(),r.elemToolbar=d;let f=document.createElement("div");f.className="fbw-font-picker",r.fontPicker=f;let g=document.createElement("div");g.className="fbw-note-popover",g.innerHTML=Eo(),r.notePopover=g;let h=document.createElement("div");h.className="fbw-marker-popover",r.markerPopover=h,r.resizeHandles=No();let w=Ho();r.tagPopover=w;let b=document.createElement("div");b.className="fbw-fab-bar",b.appendChild(t),b.appendChild(n),b.appendChild(a),b.appendChild(i);let m=document.createElement("span");m.className="fbw-fab-divider",b.appendChild(m),b.appendChild(s);let v=document.createElement("span");v.className="fbw-fab-divider fbw-fab-divider-2",b.appendChild(v),b.appendChild(c),r.fabBar=b,document.body.appendChild(e),document.body.appendChild(o),document.body.appendChild(b),document.body.appendChild(p),document.body.appendChild(d),document.body.appendChild(f),document.body.appendChild(g),document.body.appendChild(h),document.body.appendChild(w),document.body.appendChild(r.resizeHandles)}function gr(){let e=!1,o=t=>t.target.dataset?.fbwEditId||t.target.matches&&t.target.matches("textarea, input")||t.target.closest&&t.target.closest(".fbw-panel, .fbw-confirm");document.addEventListener("keydown",t=>{if(!o(t)){if(t.key===" "){e=!0;return}if(e&&(t.key==="p"||t.key==="P")&&!t.shiftKey){t.preventDefault(),we({image:!1},F);return}if(t.shiftKey&&(t.key==="P"||t.key==="p")){t.preventDefault(),we({image:!0},F);return}if((t.metaKey||t.ctrlKey)&&!t.shiftKey&&(t.key==="s"||t.key==="S")){t.preventDefault(),r.panel?.querySelector('[data-fbw-action="save"]')?.click();return}if((t.metaKey||t.ctrlKey)&&!t.shiftKey&&(t.key==="z"||t.key==="Z")){t.preventDefault(),Xe();return}if((t.metaKey||t.ctrlKey)&&t.shiftKey&&(t.key==="z"||t.key==="Z")||(t.metaKey||t.ctrlKey)&&!t.shiftKey&&(t.key==="y"||t.key==="Y")){t.preventDefault(),Co();return}if((t.metaKey||t.ctrlKey)&&!t.shiftKey&&(t.key==="c"||t.key==="C")){if(window.getSelection?.()?.toString()||!r.selectedEl)return;t.preventDefault(),cn();return}if((t.metaKey||t.ctrlKey)&&!t.shiftKey&&(t.key==="m"||t.key==="M")){t.preventDefault(),r.panel?.querySelector('[data-fbw-action="copy"]')?.click();return}t.ctrlKey||t.metaKey||t.altKey||e||(t.key==="e"||t.key==="E"?(t.preventDefault(),ue()):t.key==="f"||t.key==="F"?(t.preventDefault(),$e()):t.key==="m"||t.key==="M"?(t.preventDefault(),de()):t.key==="a"||t.key==="A"?(t.preventDefault(),fn()):t.key==="?"?(t.preventDefault(),Ce()):(t.key==="Delete"||t.key==="Backspace")&&r.selectedEl&&r.editMode&&(t.preventDefault(),r.elemToolbar?.querySelector('[data-op="delete"]')?.click()))}}),document.addEventListener("keyup",t=>{t.key===" "&&(e=!1),t.key==="Alt"&&(document.body.classList.remove("fbw-measuring"),V())}),window.addEventListener("blur",()=>{e=!1,document.body.classList.remove("fbw-measuring"),V()}),document.addEventListener("mousemove",t=>{if(!t.altKey||!r.selectedEl){document.body.classList.contains("fbw-measuring")&&(document.body.classList.remove("fbw-measuring"),V());return}document.body.classList.add("fbw-measuring");let n=t.target;if(!n||n.closest(".fbw-panel, .fbw-fab, .fbw-fab-bar, .fbw-elem-toolbar, .fbw-confirm, .fbw-toast, .fbw-tooltip, .fbw-anno, .fbw-resize-handles, .fbw-measure-overlay, .fbw-help-popover, .fbw-note-popover, .fbw-marker-popover, .fbw-font-picker, .fbw-tag-popover")){V();return}if(n===r.selectedEl||r.selectedEl.contains(n)){V();return}un(n)},!0)}function wr(){r.editFab.addEventListener("click",()=>{if(document.body.classList.contains("fbw-fab-collapsed")){zn(!1),r.editMode||ue();return}ue()}),r.exportFab.addEventListener("click",e=>we({image:e.shiftKey},F)),r.marqueeFab.addEventListener("click",de),r.helpFab.addEventListener("click",e=>{e.stopPropagation(),Ce()}),r.foldFab.addEventListener("click",e=>{e.stopPropagation(),zn(!0)})}var Pt="fbw-fab-collapsed::"+(location.pathname||"/").slice(0,200);function zn(e){document.body.classList.toggle("fbw-fab-collapsed",e);try{e?localStorage.setItem(Pt,"1"):localStorage.removeItem(Pt)}catch{}}function hr(){try{localStorage.getItem(Pt)==="1"&&document.body.classList.add("fbw-fab-collapsed")}catch{}}function xr(){let e=null;ne(()=>{document.body.classList.add("fbw-scrolling"),e&&clearTimeout(e),e=setTimeout(()=>{document.body.classList.remove("fbw-scrolling")},800)});let o=220,t=260,n=-1,a=-1,i=0;window.addEventListener("mousemove",s=>{n=s.clientX,a=s.clientY,!i&&(i=requestAnimationFrame(()=>{i=0;let c=window.innerWidth-n<o&&window.innerHeight-a<t;document.body.classList.toggle("fbw-mouse-near-fab",c)}))},{passive:!0})}var In=null;function Dn(){if(!r.fabBar)return;let e=r.fabBar.getBoundingClientRect(),o=e.left+e.width/2,t=e.top+e.height/2,n=r.fabBar.style.pointerEvents;r.fabBar.style.pointerEvents="none";let a=document.elementFromPoint(o,t)||document.body;r.fabBar.style.pointerEvents=n,a.closest&&a.closest(".fbw-panel, .fbw-tooltip, .fbw-toast, .fbw-confirm, .fbw-elem-toolbar, .fbw-resize-handles, .fbw-note-popover, .fbw-font-picker, .fbw-marker-popover, .fbw-help-popover, .fbw-anno")&&(a=document.body);let i=null,s=a;for(;s&&s!==document.documentElement;){let d=window.getComputedStyle(s).backgroundColor,f=d&&d.match(/rgba?\((\d+),\s*(\d+),\s*(\d+)(?:,\s*([\d.]+))?\)/);if(f&&(f[4]!==void 0?parseFloat(f[4]):1)>.5){i={r:+f[1],g:+f[2],b:+f[3]};break}s=s.parentElement}if(!i){let f=window.getComputedStyle(document.documentElement).backgroundColor.match(/\d+/g);i=f?{r:+f[0],g:+f[1],b:+f[2]}:{r:255,g:255,b:255}}let p=.299*i.r+.587*i.g+.114*i.b<140;In!==p&&(In=p,document.body.classList.toggle("fbw-dark-bg",p))}function yr(){let e=null,o=()=>{e&&clearTimeout(e),e=setTimeout(Dn,250)};setTimeout(Dn,80),ne(o),J(o)}function Rn(){return document.querySelector("deck-stage")?"deck":document.querySelectorAll(R).length>0?"doc":"review"}function qn(){let e=r.panel?.querySelector(".fbw-mode-chip");e&&(e.textContent=l("mode.chip."+(r.appMode||"doc")))}function vr(){let e=()=>{let o=Rn();o!==r.appMode&&(document.body.classList.remove("fbw-mode-"+r.appMode),document.body.classList.add("fbw-mode-"+o),Z("appMode changed:",r.appMode,"\u2192",o),r.appMode=o,qn())};window.addEventListener("popstate",e),["pushState","replaceState"].forEach(o=>{let t=history[o];t.__fbwPatched||(history[o]=function(...n){let a=t.apply(this,n);return setTimeout(e,0),a},history[o].__fbwPatched=!0)})}function At(){Z("init start"),ur(),mr(),r.appMode=Rn(),document.body.classList.add("fbw-mode-"+r.appMode),Z("appMode:",r.appMode),qn(),vr();let e=ro();ln(),tn(),on(),Do(),mo(),Po(),_o(),Uo(),en(),hn(),An(),xn(e),Qo(),gr(),r.onChangeHook=bn,wr(),xr(),yr(),wo(),yo(),hr(),document.querySelector("deck-stage")?ct():document.body.classList.add("fbw-no-overlay"),lo(),G(),wt(),T(k),Jo().catch(o=>Z("rehydrate failed:",o)),Z("init done")}(function(){typeof window>"u"||window.__feedbackWidgetLoaded||(window.__feedbackWidgetLoaded=!0,window.__feedbackWidgetVersion=xe,Z(`redline v${xe} loaded \xB7 \u5173\u95ED\u65E5\u5FD7: window.__fbwDebug = false`),document.readyState==="loading"?document.addEventListener("DOMContentLoaded",At):At())})();})();
